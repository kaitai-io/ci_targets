...
valid_fail_contents_t::valid_fail_contents_t(kaitai::kstream* p__io, std::unique_ptr<kaitai::kstruct> p__parent, valid_fail_contents_t* p__root) : kaitai::kstruct(p__io) {
    m__parent = p__parent;
    m__root = this;
    _read();
}

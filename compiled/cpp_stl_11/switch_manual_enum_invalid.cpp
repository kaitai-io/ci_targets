...
const std::set<std::underlying_type<switch_manual_enum_invalid_t::opcode_t::code_enum_t>::type> switch_manual_enum_invalid_t::opcode_t::_values_code_enum_t{73, 83};

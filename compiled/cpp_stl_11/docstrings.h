...
public:
    ...
    class complexSubtype_t : public kaitai::kstruct {

    public:

        complexSubtype_t(kaitai::kstream* p__io, kaitai::kstruct* p__parent = nullptr, docstrings_t* p__root = nullptr);

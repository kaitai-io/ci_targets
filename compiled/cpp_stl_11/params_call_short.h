...
public:
    ...
    paramsCallShort_t(kaitai::kstream* p__io, kaitai::kstruct* p__parent = nullptr, paramsCallShort_t* p__root = nullptr);
...
public:
    ...
    public:
        ...
        myStr1_t(uint32_t p_len, kaitai::kstream* p__io, paramsCallShort_t* p__parent = nullptr, paramsCallShort_t* p__root = nullptr);
    ...
    public:
        ...
        myStr2_t(uint32_t p_len, bool p_has_trailer, kaitai::kstream* p__io, paramsCallShort_t* p__parent = nullptr, paramsCallShort_t* p__root = nullptr);
...
private:
    ...
    std::unique_ptr<myStr2_t> m_buf2;
    paramsCallShort_t* m__root;
    kaitai::kstruct* m__parent;

public:
    myStr1_t* buf1() const { return m_buf1.get(); }
    myStr2_t* buf2() const { return m_buf2.get(); }
    paramsCallShort_t* _root() const { return m__root; }

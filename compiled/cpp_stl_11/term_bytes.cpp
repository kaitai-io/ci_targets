...
termBytes_t::termBytes_t(kaitai::kstream* p__io, kaitai::kstruct* p__parent, termBytes_t* p__root) : kaitai::kstruct(p__io) {
    m__parent = p__parent;
    m__root = this;
    _read();
}

void termBytes_t::_read() {

...
params_pass_struct_t::params_pass_struct_t(kaitai::kstream* p__io, std::unique_ptr<kaitai::kstruct> p__parent, params_pass_struct_t* p__root) : kaitai::kstruct(p__io) {
    m__parent = p__parent;
    m__root = this;
    m_first = nullptr;
    m_one = nullptr;

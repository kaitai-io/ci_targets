...
void term_struct2_t::_read() {
    ...
    m__raw_s2 = m__io->read_bytes_term(124, true, true, true);
    ...
    m__raw_s3 = m__io->read_bytes_term(64, false, false, true);
...
void term_struct2_t::bytes_wrapper_t::_read() {

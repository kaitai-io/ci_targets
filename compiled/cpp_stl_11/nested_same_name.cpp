...
nested_same_name_t::nested_same_name_t(kaitai::kstream* p__io, std::unique_ptr<kaitai::kstruct> p__parent, nested_same_name_t* p__root) : kaitai::kstruct(p__io) {
    m__parent = p__parent;
    m__root = this;
    m_main_data = nullptr;
    m_dummy = nullptr;
...
nested_same_name_t::dummy_obj_t::foo_t::foo_t(kaitai::kstream* p__io, std::unique_ptr<kaitai::kstruct> p__parent, nested_same_name_t* p__root) : kaitai::kstruct(p__io) {
    m__parent = p__parent;
    m__root = p__root;
    _read();
}

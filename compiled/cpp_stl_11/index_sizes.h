...
public:
    ...
    indexSizes_t(kaitai::kstream* p__io, kaitai::kstruct* p__parent = nullptr, indexSizes_t* p__root = nullptr);
...
public:
    ...
    indexSizes_t* _root() const { return m__root; }

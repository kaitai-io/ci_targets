...
public:
    ...
    switch_manual_enum_invalid_else_t(kaitai::kstream* p__io, std::unique_ptr<kaitai::kstruct> p__parent = nullptr, switch_manual_enum_invalid_else_t* p__root = nullptr);

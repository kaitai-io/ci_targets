...
void bcd_user_type_le_t::_cleanUp() {
}
...
void bcd_user_type_le_t::ltr_obj_t::_read() {
    m_b1 = m__io->read_u1();
    m_b2 = m__io->read_u1();
    m_b3 = m__io->read_u1();
    m_b4 = m__io->read_u1();
...
void bcd_user_type_le_t::ltr_obj_t::_cleanUp() {
}
...
void bcd_user_type_le_t::rtl_obj_t::_read() {
    m_b1 = m__io->read_u1();
    m_b2 = m__io->read_u1();
    m_b3 = m__io->read_u1();
    m_b4 = m__io->read_u1();
...
void bcd_user_type_le_t::rtl_obj_t::_cleanUp() {
}
...
void bcd_user_type_le_t::leading_zero_ltr_obj_t::_read() {
    m_b1 = m__io->read_u1();
    m_b2 = m__io->read_u1();
    m_b3 = m__io->read_u1();
    m_b4 = m__io->read_u1();
...
void bcd_user_type_le_t::leading_zero_ltr_obj_t::_cleanUp() {
}

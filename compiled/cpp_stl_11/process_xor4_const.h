...
public:
    ...
    processXor4Const_t(kaitai::kstream* p__io, kaitai::kstruct* p__parent = nullptr, processXor4Const_t* p__root = nullptr);
...
public:
    ...
    processXor4Const_t* _root() const { return m__root; }

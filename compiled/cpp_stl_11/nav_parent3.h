...
public:
    ...
    navParent3_t(kaitai::kstream* p__io, kaitai::kstruct* p__parent = nullptr, navParent3_t* p__root = nullptr);
...
public:
    ...
    public:
        ...
        tag_t(kaitai::kstream* p__io, navParent3_t* p__parent = nullptr, navParent3_t* p__root = nullptr);
    ...
    public:
        ...
        public:
            ...
            tagChar_t(kaitai::kstream* p__io, navParent3_t::tag_t* p__parent = nullptr, navParent3_t* p__root = nullptr);
        ...
        private:
            ...
            navParent3_t* m__root;
            navParent3_t::tag_t* m__parent;

        public:
            std::string content() const { return m_content; }
            navParent3_t* _root() const { return m__root; }
            navParent3_t::tag_t* _parent() const { return m__parent; }
        };
    ...
    public:
        ...
        navParent3_t* _root() const { return m__root; }
        navParent3_t* _parent() const { return m__parent; }
    };

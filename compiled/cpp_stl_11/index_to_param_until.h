...
public:
    ...
    public:
        ...
        block_t(int32_t p_idx, kaitai::kstream* p__io, index_to_param_until_t* p__parent = nullptr, index_to_param_until_t* p__root = nullptr);

...
eos_exception_bytes_t::eos_exception_bytes_t(kaitai::kstream* p__io, std::unique_ptr<kaitai::kstruct> p__parent, eos_exception_bytes_t* p__root) : kaitai::kstruct(p__io) {
    m__parent = p__parent;
    m__root = this;
    m_envelope = nullptr;

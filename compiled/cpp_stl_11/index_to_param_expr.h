...
class index_to_param_expr_t : public kaitai::kstruct {

public:
    class block_t;

    index_to_param_expr_t(kaitai::kstream* p__io, std::unique_ptr<kaitai::kstruct> p__parent = nullptr, index_to_param_expr_t* p__root = nullptr);

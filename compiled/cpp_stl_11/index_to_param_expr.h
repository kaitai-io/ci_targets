...
public:
    ...
    indexToParamExpr_t(kaitai::kstream* p__io, kaitai::kstruct* p__parent = nullptr, indexToParamExpr_t* p__root = nullptr);
...
public:
    ...
    public:
        ...
        block_t(int32_t p_idx, kaitai::kstream* p__io, indexToParamExpr_t* p__parent = nullptr, indexToParamExpr_t* p__root = nullptr);

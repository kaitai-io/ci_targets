...
std::unique_ptr<std::vector<double>> expr_calc_array_ops_t::double_array() {
    if (f_double_array)
...
std::unique_ptr<std::vector<std::string>> expr_calc_array_ops_t::str_array() {
    if (f_str_array)
        return m_str_array;
...
std::unique_ptr<std::vector<int32_t>> expr_calc_array_ops_t::int_array() {
    if (f_int_array)
        return m_int_array;

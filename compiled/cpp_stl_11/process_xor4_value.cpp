...
process_xor4_value_t::process_xor4_value_t(kaitai::kstream* p__io, std::unique_ptr<kaitai::kstruct> p__parent, process_xor4_value_t* p__root) : kaitai::kstruct(p__io) {
    m__parent = p__parent;
    m__root = this;
    m__io_buf = nullptr;
    _read();

...
default_endian_expr_is_le_t::default_endian_expr_is_le_t(kaitai::kstream* p__io, std::unique_ptr<kaitai::kstruct> p__parent, default_endian_expr_is_le_t* p__root) : kaitai::kstruct(p__io) {
    m__parent = p__parent;
    m__root = this;
    m_docs = nullptr;
    _read();

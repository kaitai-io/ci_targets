...
strEncodingsDefault_t::strEncodingsDefault_t(kaitai::kstream* p__io, kaitai::kstruct* p__parent, strEncodingsDefault_t* p__root) : kaitai::kstruct(p__io) {
    m__parent = p__parent;
    m__root = this;
    m_rest = nullptr;
    _read();
...
void strEncodingsDefault_t::_read() {
...
strEncodingsDefault_t::~strEncodingsDefault_t() {
}

strEncodingsDefault_t::subtype_t::subtype_t(kaitai::kstream* p__io, strEncodingsDefault_t* p__parent, strEncodingsDefault_t* p__root) : kaitai::kstruct(p__io) {
    m__parent = p__parent;
    m__root = p__root;
    _read();
}

void strEncodingsDefault_t::subtype_t::_read() {
...
strEncodingsDefault_t::subtype_t::~subtype_t() {
}

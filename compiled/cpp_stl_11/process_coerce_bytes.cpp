...
process_coerce_bytes_t::process_coerce_bytes_t(kaitai::kstream* p__io, std::unique_ptr<kaitai::kstruct> p__parent, process_coerce_bytes_t* p__root) : kaitai::kstruct(p__io) {
    m__parent = p__parent;
    m__root = this;
    m_records = nullptr;
    _read();

...
enum_for_unknown_id_t::enum_for_unknown_id_t(kaitai::kstream* p__io, std::unique_ptr<kaitai::kstruct> p__parent, enum_for_unknown_id_t* p__root) : kaitai::kstruct(p__io) {
    m__parent = p__parent;
    m__root = this;
    _read();
}

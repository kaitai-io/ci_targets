...
public:
    ...
    ifStruct_t(kaitai::kstream* p__io, kaitai::kstruct* p__parent = nullptr, ifStruct_t* p__root = nullptr);
...
public:
    ...
    public:
        ...
        operation_t(kaitai::kstream* p__io, ifStruct_t* p__parent = nullptr, ifStruct_t* p__root = nullptr);
    ...
    private:
        uint8_t m_opcode;
        std::unique_ptr<argTuple_t> m_arg_tuple;
        bool n_arg_tuple;
    ...
    private:
        std::unique_ptr<argStr_t> m_arg_str;
        bool n_arg_str;
    ...
    public:
        ...
        argTuple_t* arg_tuple() const { return m_arg_tuple.get(); }
        argStr_t* arg_str() const { return m_arg_str.get(); }
    ...
    public:
        ...
        argTuple_t(kaitai::kstream* p__io, ifStruct_t::operation_t* p__parent = nullptr, ifStruct_t* p__root = nullptr);
    ...
    public:
        ...
        argStr_t(kaitai::kstream* p__io, ifStruct_t::operation_t* p__parent = nullptr, ifStruct_t* p__root = nullptr);

...
public:
    ...
    optionalId_t(kaitai::kstream* p__io, kaitai::kstruct* p__parent = nullptr, optionalId_t* p__root = nullptr);
...
public:
    ...
    optionalId_t* _root() const { return m__root; }

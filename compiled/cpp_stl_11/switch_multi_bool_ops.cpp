...
switch_multi_bool_ops_t::switch_multi_bool_ops_t(kaitai::kstream* p__io, std::unique_ptr<kaitai::kstruct> p__parent, switch_multi_bool_ops_t* p__root) : kaitai::kstruct(p__io) {
    m__parent = p__parent;
    m__root = this;
    m_opcodes = nullptr;
    _read();

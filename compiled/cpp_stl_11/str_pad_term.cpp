...
strPadTerm_t::strPadTerm_t(kaitai::kstream* p__io, kaitai::kstruct* p__parent, strPadTerm_t* p__root) : kaitai::kstruct(p__io) {
    m__parent = p__parent;
    m__root = this;
    _read();
}

void strPadTerm_t::_read() {

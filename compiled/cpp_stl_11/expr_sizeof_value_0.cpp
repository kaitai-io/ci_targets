...
expr_sizeof_value_0_t::expr_sizeof_value_0_t(kaitai::kstream* p__io, std::unique_ptr<kaitai::kstruct> p__parent, expr_sizeof_value_0_t* p__root) : kaitai::kstruct(p__io) {
    m__parent = p__parent;
    m__root = this;
    m_block1 = nullptr;
    f_self_sizeof = false;

...
void switch_manual_enum_t::_cleanUp() {
}
...
void switch_manual_enum_t::opcode_t::_cleanUp() {
    if (!n_body) {
    }
}
...
void switch_manual_enum_t::opcode_t::intval_t::_cleanUp() {
}
...
void switch_manual_enum_t::opcode_t::strval_t::_cleanUp() {
}

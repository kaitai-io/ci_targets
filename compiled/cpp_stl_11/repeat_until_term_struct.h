...
public:
    ...
    repeat_until_term_struct_t(kaitai::kstream* p__io, kaitai::kstruct* p__parent = nullptr, repeat_until_term_struct_t* p__root = nullptr);
...
public:
    ...
    public:
        ...
        bytes_wrapper_t(kaitai::kstream* p__io, repeat_until_term_struct_t* p__parent = nullptr, repeat_until_term_struct_t* p__root = nullptr);

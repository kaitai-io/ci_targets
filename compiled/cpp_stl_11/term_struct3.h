...
public:
    ...
    term_struct3_t(kaitai::kstream* p__io, kaitai::kstruct* p__parent = nullptr, term_struct3_t* p__root = nullptr);
...
public:
    ...
    public:
        ...
        bytes_wrapper_t(kaitai::kstream* p__io, term_struct3_t* p__parent = nullptr, term_struct3_t* p__root = nullptr);

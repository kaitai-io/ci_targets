...
class repeatUntilCalcArrayType_t : public kaitai::kstruct {

public:
    class record_t;

    repeatUntilCalcArrayType_t(kaitai::kstream* p__io, kaitai::kstruct* p__parent = nullptr, repeatUntilCalcArrayType_t* p__root = nullptr);

private:
    void _read();

public:
    ~repeatUntilCalcArrayType_t();

    class record_t : public kaitai::kstruct {

    public:

        record_t(kaitai::kstream* p__io, repeatUntilCalcArrayType_t* p__parent = nullptr, repeatUntilCalcArrayType_t* p__root = nullptr);
    ...
    private:
        uint8_t m_marker;
        uint32_t m_body;
        repeatUntilCalcArrayType_t* m__root;
        repeatUntilCalcArrayType_t* m__parent;

    public:
        uint8_t marker() const { return m_marker; }
        uint32_t body() const { return m_body; }
        repeatUntilCalcArrayType_t* _root() const { return m__root; }
        repeatUntilCalcArrayType_t* _parent() const { return m__parent; }
    };

...
public:
    ...
    exprSizeofValueSized_t(kaitai::kstream* p__io, kaitai::kstruct* p__parent = nullptr, exprSizeofValueSized_t* p__root = nullptr);
...
public:
    ...
    public:
        ...
        block_t(kaitai::kstream* p__io, exprSizeofValueSized_t* p__parent = nullptr, exprSizeofValueSized_t* p__root = nullptr);

...
imports_circular_b_t::imports_circular_b_t(kaitai::kstream* p__io, std::unique_ptr<kaitai::kstruct> p__parent, imports_circular_b_t* p__root) : kaitai::kstruct(p__io) {
    m__parent = p__parent;
    m__root = this;
    m_back_ref = nullptr;
    _read();

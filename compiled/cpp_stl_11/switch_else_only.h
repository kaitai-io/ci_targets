...
public:
    ...
    switchElseOnly_t(kaitai::kstream* p__io, kaitai::kstruct* p__parent = nullptr, switchElseOnly_t* p__root = nullptr);
...
public:
    ...
    public:
        ...
        data_t(kaitai::kstream* p__io, switchElseOnly_t* p__parent = nullptr, switchElseOnly_t* p__root = nullptr);

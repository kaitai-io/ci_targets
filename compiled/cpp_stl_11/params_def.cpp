...
params_def_t::params_def_t(uint32_t p_len, bool p_has_trailer, kaitai::kstream* p__io, std::unique_ptr<kaitai::kstruct> p__parent, params_def_t* p__root) : kaitai::kstruct(p__io) {
    m__parent = p__parent;
    m__root = this;
    m_len = p_len;

...
public:
    ...
    processToUser_t(kaitai::kstream* p__io, kaitai::kstruct* p__parent = nullptr, processToUser_t* p__root = nullptr);
...
public:
    ...
    public:
        ...
        justStr_t(kaitai::kstream* p__io, processToUser_t* p__parent = nullptr, processToUser_t* p__root = nullptr);
...
private:
    std::unique_ptr<justStr_t> m_buf1;
    processToUser_t* m__root;
...
public:
    justStr_t* buf1() const { return m_buf1.get(); }
    processToUser_t* _root() const { return m__root; }

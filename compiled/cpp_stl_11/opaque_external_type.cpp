...
opaque_external_type_t::opaque_external_type_t(kaitai::kstream* p__io, std::unique_ptr<kaitai::kstruct> p__parent, opaque_external_type_t* p__root) : kaitai::kstruct(p__io) {
    m__parent = p__parent;
    m__root = this;
    m_one = nullptr;
    _read();

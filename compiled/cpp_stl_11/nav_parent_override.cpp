...
nav_parent_override_t::nav_parent_override_t(kaitai::kstream* p__io, std::unique_ptr<kaitai::kstruct> p__parent, nav_parent_override_t* p__root) : kaitai::kstruct(p__io) {
    m__parent = p__parent;
    m__root = this;
    m_child_1 = nullptr;

...
repeat_until_complex_t::repeat_until_complex_t(kaitai::kstream* p__io, std::unique_ptr<kaitai::kstruct> p__parent, repeat_until_complex_t* p__root) : kaitai::kstruct(p__io) {
    m__parent = p__parent;
    m__root = this;
    m_first = nullptr;
    m_second = nullptr;

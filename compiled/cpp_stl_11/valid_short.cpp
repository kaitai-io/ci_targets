...
void valid_short_t::_read() {
    ...
    m_magic_uint = kaitai::kstream::bytes_to_str(m__io->read_bytes(kaitai::to_signed(10)), std::string("utf-8"));
    ...
    m_magic_sint = kaitai::kstream::bytes_to_str(m__io->read_bytes(kaitai::to_signed(10)), std::string("utf-8"));

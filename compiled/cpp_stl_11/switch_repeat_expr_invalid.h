...
class switch_repeat_expr_invalid_t;
...
public:
    ...
    switch_repeat_expr_invalid_t(kaitai::kstream* p__io, kaitai::kstruct* p__parent = nullptr, switch_repeat_expr_invalid_t* p__root = nullptr);
...
public:
    ...
    public:
        ...
        one_t(kaitai::kstream* p__io, switch_repeat_expr_invalid_t* p__parent = nullptr, switch_repeat_expr_invalid_t* p__root = nullptr);
    ...
    public:
        ...
        two_t(kaitai::kstream* p__io, switch_repeat_expr_invalid_t* p__parent = nullptr, switch_repeat_expr_invalid_t* p__root = nullptr);
...
public:
    std::vector<uint8_t>* codes() const { return m_codes.get(); }
...
private:
    std::unique_ptr<std::vector<uint8_t>> m_codes;

...
process_repeat_usertype_t::process_repeat_usertype_t(kaitai::kstream* p__io, std::unique_ptr<kaitai::kstruct> p__parent, process_repeat_usertype_t* p__root) : kaitai::kstruct(p__io) {
    m__parent = p__parent;
    m__root = this;
    m_blocks = nullptr;

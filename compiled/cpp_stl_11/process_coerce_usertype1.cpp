...
processCoerceUsertype1_t::processCoerceUsertype1_t(kaitai::kstream* p__io, kaitai::kstruct* p__parent, processCoerceUsertype1_t* p__root) : kaitai::kstruct(p__io) {
    m__parent = p__parent;
    m__root = this;
    m_records = nullptr;
    _read();
...
void processCoerceUsertype1_t::_read() {
    int l_records = 2;
...
processCoerceUsertype1_t::~processCoerceUsertype1_t() {
}

processCoerceUsertype1_t::record_t::record_t(kaitai::kstream* p__io, processCoerceUsertype1_t* p__parent, processCoerceUsertype1_t* p__root) : kaitai::kstruct(p__io) {
    m__parent = p__parent;
    m__root = p__root;
    m_buf_unproc = nullptr;
    m__io__raw_buf_unproc = nullptr;
    m_buf_proc = nullptr;
...
void processCoerceUsertype1_t::record_t::_read() {
...
processCoerceUsertype1_t::record_t::~record_t() {
    if (!n_buf_unproc) {
...
processCoerceUsertype1_t::foo_t* processCoerceUsertype1_t::record_t::buf() {
    if (f_buf)
        return m_buf;
...
processCoerceUsertype1_t::foo_t::foo_t(kaitai::kstream* p__io, processCoerceUsertype1_t::record_t* p__parent, processCoerceUsertype1_t* p__root) : kaitai::kstruct(p__io) {
    m__parent = p__parent;
    m__root = p__root;
    _read();
}

void processCoerceUsertype1_t::foo_t::_read() {
    m_value = m__io->read_u4le();
}

processCoerceUsertype1_t::foo_t::~foo_t() {
}

...
void integers_t::_read() {
    m_magic1 = m__io->read_bytes(kaitai::to_signed(6));
    ...
    m_magic_uint = m__io->read_bytes(kaitai::to_signed(10));
    if (!(magic_uint() == std::string("\x50\x41\x43\x4B\x2D\x55\x2D\x44\x45\x46", 10))) {
        throw kaitai::validation_not_equal_error<std::string>(std::string("\x50\x41\x43\x4B\x2D\x55\x2D\x44\x45\x46", 10), magic_uint(), _io(), std::string("/seq/3"));
    }
    m_uint16 = m__io->read_u2le();
    m_uint32 = m__io->read_u4le();
    m_uint64 = m__io->read_u8le();
    m_magic_sint = m__io->read_bytes(kaitai::to_signed(10));
    if (!(magic_sint() == std::string("\x50\x41\x43\x4B\x2D\x53\x2D\x44\x45\x46", 10))) {
        throw kaitai::validation_not_equal_error<std::string>(std::string("\x50\x41\x43\x4B\x2D\x53\x2D\x44\x45\x46", 10), magic_sint(), _io(), std::string("/seq/7"));
    }
    m_sint16 = m__io->read_s2le();
    m_sint32 = m__io->read_s4le();
    m_sint64 = m__io->read_s8le();
    m_magic_uint_le = m__io->read_bytes(kaitai::to_signed(9));
    if (!(magic_uint_le() == std::string("\x50\x41\x43\x4B\x2D\x55\x2D\x4C\x45", 9))) {
        throw kaitai::validation_not_equal_error<std::string>(std::string("\x50\x41\x43\x4B\x2D\x55\x2D\x4C\x45", 9), magic_uint_le(), _io(), std::string("/seq/11"));
    }
    m_uint16le = m__io->read_u2le();
    m_uint32le = m__io->read_u4le();
    m_uint64le = m__io->read_u8le();
    m_magic_sint_le = m__io->read_bytes(kaitai::to_signed(9));
    if (!(magic_sint_le() == std::string("\x50\x41\x43\x4B\x2D\x53\x2D\x4C\x45", 9))) {
        throw kaitai::validation_not_equal_error<std::string>(std::string("\x50\x41\x43\x4B\x2D\x53\x2D\x4C\x45", 9), magic_sint_le(), _io(), std::string("/seq/15"));
    }
    m_sint16le = m__io->read_s2le();
    m_sint32le = m__io->read_s4le();
    m_sint64le = m__io->read_s8le();
    m_magic_uint_be = m__io->read_bytes(kaitai::to_signed(9));
    if (!(magic_uint_be() == std::string("\x50\x41\x43\x4B\x2D\x55\x2D\x42\x45", 9))) {
        throw kaitai::validation_not_equal_error<std::string>(std::string("\x50\x41\x43\x4B\x2D\x55\x2D\x42\x45", 9), magic_uint_be(), _io(), std::string("/seq/19"));
    }
    m_uint16be = m__io->read_u2be();
    m_uint32be = m__io->read_u4be();
    m_uint64be = m__io->read_u8be();
    m_magic_sint_be = m__io->read_bytes(kaitai::to_signed(9));
    if (!(magic_sint_be() == std::string("\x50\x41\x43\x4B\x2D\x53\x2D\x42\x45", 9))) {
        throw kaitai::validation_not_equal_error<std::string>(std::string("\x50\x41\x43\x4B\x2D\x53\x2D\x42\x45", 9), magic_sint_be(), _io(), std::string("/seq/23"));
    }

...
public:
    ...
    opaque_external_type_02_parent_t(kaitai::kstream* p__io, std::unique_ptr<kaitai::kstruct> p__parent = nullptr, opaque_external_type_02_parent_t* p__root = nullptr);

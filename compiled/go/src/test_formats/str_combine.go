...
func (this *StrCombine) Read(io *kaitai.Stream, parent interface{}, root *StrCombine) (err error) {
	this._io = io
	this._parent = parent
	this._root = root
...
func (this *StrCombine) LimitOrCalcBytes() (v string, err error) {
...
func (this *StrCombine) LimitOrCalc() (v string, err error) {
...
func (this *StrCombine) TermOrLimit() (v string, err error) {
...
func (this *StrCombine) LimitOrEos() (v string, err error) {
...
func (this *StrCombine) CalcOrCalcBytes() (v string, err error) {
...
func (this *StrCombine) StrCalcBytes() (v string, err error) {
...
func (this *StrCombine) EosOrCalc() (v string, err error) {
...
func (this *StrCombine) TermOrCalc() (v string, err error) {
...
func (this *StrCombine) TermOrCalcBytes() (v string, err error) {
...
func (this *StrCombine) TermOrEos() (v string, err error) {
...
func (this *StrCombine) StrCalc() (v string, err error) {
	if (this._f_strCalc) {
...
func (this *StrCombine) EosOrCalcBytes() (v string, err error) {
...
func (this *StrCombine) CalcBytes() (v []byte, err error) {

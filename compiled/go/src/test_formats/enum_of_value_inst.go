...
var values_EnumOfValueInst_Animal = map[EnumOfValueInst_Animal]struct{}{4: {}, 7: {}, 12: {}}
func (v EnumOfValueInst_Animal) isDefined() bool {
	_, ok := values_EnumOfValueInst_Animal[v]
	return ok
}

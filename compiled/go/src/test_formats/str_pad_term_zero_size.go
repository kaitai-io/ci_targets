...
type StrPadTermZeroSize struct {
	StrPad string
	StrTerm string
...
func NewStrPadTermZeroSize() *StrPadTermZeroSize {
	return &StrPadTermZeroSize{
	}
}

func (this StrPadTermZeroSize) IO_() *kaitai.Stream {
	return this._io
}

func (this *StrPadTermZeroSize) Read(io *kaitai.Stream, parent kaitai.Struct, root *StrPadTermZeroSize) (err error) {
	this._io = io
	this._parent = parent
	this._root = root

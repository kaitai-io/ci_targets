...
func (this EnumToIClassBorder1) IO_() *kaitai.Stream {
	return this._io
}

func (this *EnumToIClassBorder1) Read(io *kaitai.Stream, parent kaitai.Struct, root *EnumToIClassBorder1) (err error) {
	this._io = io
	this._parent = parent
	this._root = root

...
func (this BitsUnalignedB32Be) IO_() *kaitai.Stream {
	return this._io
}

func (this *BitsUnalignedB32Be) Read(io *kaitai.Stream, parent kaitai.Struct, root *BitsUnalignedB32Be) (err error) {
	this._io = io
	this._parent = parent
	this._root = root

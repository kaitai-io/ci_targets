...
proc read*(_: typedesc[ParamsPassArrayUsertype_ParamType], io: KaitaiStream, root: KaitaiStruct, parent: ParamsPassArrayUsertype): ParamsPassArrayUsertype_ParamType

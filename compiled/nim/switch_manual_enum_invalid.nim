...
proc read*(_: typedesc[SwitchManualEnumInvalid_Opcode], io: KaitaiStream, root: SwitchManualEnumInvalid, parent: SwitchManualEnumInvalid): SwitchManualEnumInvalid_Opcode =
  ...
  let code = SwitchManualEnumInvalid_Opcode_CodeEnum(this.io.readU1())
  this.code = code
  let body = SwitchManualEnumInvalid_Opcode_Intval.read(this.io, this.root, this)
  this.body = body
  let body = SwitchManualEnumInvalid_Opcode_Strval.read(this.io, this.root, this)
  this.body = body
  result = this

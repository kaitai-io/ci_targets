...
class TermStruct4 < Kaitai::Struct::Struct
  ...
  class S1Type < Kaitai::Struct::Struct
    ...
    def _read
      @_raw_value = @_io.read_bytes_term(124, false, true, false)
      _io__raw_value = Kaitai::Struct::Stream.new(@_raw_value)
      @value = BytesWrapper.new(_io__raw_value, self, @_root)
      self
    end
    attr_reader :value
  ...
  class S2Type < Kaitai::Struct::Struct
    ...
    def _read
      @_raw_value = @_io.read_bytes_term(124, false, false, false)
      _io__raw_value = Kaitai::Struct::Stream.new(@_raw_value)
      @value = BytesWrapper.new(_io__raw_value, self, @_root)
      self
    end
  ...
  class S3Type < Kaitai::Struct::Struct
    ...
    def _read
      @_raw_value = @_io.read_bytes_term(64, true, true, false)
      _io__raw_value = Kaitai::Struct::Stream.new(@_raw_value)
      @value = BytesWrapper.new(_io__raw_value, self, @_root)
      self
    end

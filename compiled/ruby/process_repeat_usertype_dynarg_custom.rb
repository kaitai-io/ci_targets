...
class ProcessRepeatUsertypeDynargCustom < Kaitai::Struct::Struct
  ...
  def _read
    ...
    (2).times { |i|
      ...
      _process = MyCustomFx.new(_io.pos + 13 * i, _io.pos % 2 == 0, (i == 1 ? [32, 48].pack('C*') : [64].pack('C*')))
      @_raw_blocks << _process.decode(@_raw__raw_blocks[i])

...
class TermStrz4 < Kaitai::Struct::Struct
  ...
  class S1Type < Kaitai::Struct::Struct
    ...
    def _read
      @value = (@_io.read_bytes_term(124, false, true, false)).force_encoding("UTF-8")
      self
    end
    attr_reader :value
  end
  class S2Type < Kaitai::Struct::Struct
    ...
    def _read
      @value = (@_io.read_bytes_term(124, false, false, false)).force_encoding("UTF-8")
      self
    end
    attr_reader :value
  end
  class S3Type < Kaitai::Struct::Struct
    ...
    def _read
      @value = (@_io.read_bytes_term(64, true, true, false)).force_encoding("UTF-8")
      self
    end
    attr_reader :value
  end

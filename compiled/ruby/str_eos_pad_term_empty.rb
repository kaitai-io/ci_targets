...
class StrEosPadTermEmpty < Kaitai::Struct::Struct
  ...
  class StrPadType < Kaitai::Struct::Struct
    ...
    def _read
      @value = (Kaitai::Struct::Stream::bytes_strip_right(@_io.read_bytes_full, 64)).force_encoding("UTF-8")
      self
    end
    attr_reader :value
  end
  class StrTermAndPadType < Kaitai::Struct::Struct
    ...
    def _read
      @value = (Kaitai::Struct::Stream::bytes_terminate(Kaitai::Struct::Stream::bytes_strip_right(@_io.read_bytes_full, 43), 64, false)).force_encoding("UTF-8")
      self
    end
    attr_reader :value
  end
  class StrTermIncludeType < Kaitai::Struct::Struct
    ...
    def _read
      @value = (Kaitai::Struct::Stream::bytes_terminate(@_io.read_bytes_full, 64, true)).force_encoding("UTF-8")
      self
    end
    attr_reader :value
  end
  class StrTermType < Kaitai::Struct::Struct
    ...
    def _read
      @value = (Kaitai::Struct::Stream::bytes_terminate(@_io.read_bytes_full, 64, false)).force_encoding("UTF-8")
      self
    end
    attr_reader :value
  end

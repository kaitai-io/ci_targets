...
function ExprOpsParens.property.f_sum_to_int:get()
  ...
  self._m_f_sum_to_int = ((self.f_pi + self.f_e) > 0) and math.floor((self.f_pi + self.f_e)) or math.ceil((self.f_pi + self.f_e))
  return self._m_f_sum_to_int
end
...
ExprOpsParens.property.f_pi = {}
function ExprOpsParens.property.f_pi:get()
  if self._m_f_pi ~= nil then
    return self._m_f_pi
  end

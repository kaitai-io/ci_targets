...
pub const EnumInvalid = struct {
    ...
    pub fn create(_arena: *std.heap.ArenaAllocator, _io: *kaitai_struct.KaitaiStream, _parent: ?*anyopaque, _root: ?*EnumInvalid) !*EnumInvalid {
    ...
    fn _allocator(self: *const EnumInvalid) std.mem.Allocator {

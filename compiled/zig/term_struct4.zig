...
pub const TermStruct4 = struct {
    pub fn create(_arena: *std.heap.ArenaAllocator, _io: *kaitai_struct.KaitaiStream, _parent: ?*anyopaque, _root: ?*TermStruct4) !*TermStruct4 {
    ...
    fn _allocator(self: *const TermStruct4) std.mem.Allocator {
    ...
    pub const BytesWrapper = struct {
        pub fn create(_arena: *std.heap.ArenaAllocator, _io: *kaitai_struct.KaitaiStream, _parent: ?*anyopaque, _root: ?*TermStruct4) !*BytesWrapper {
    ...
    pub const S1Type = struct {
        pub fn create(_arena: *std.heap.ArenaAllocator, _io: *kaitai_struct.KaitaiStream, _parent: ?*TermStruct4, _root: ?*TermStruct4) !*S1Type {
        ...
        fn _read(self: *S1Type) !void {
            self._raw_value = try self._io.readBytesTerm(self._allocator(), 124, false, true, false);
            const _io__raw_value = try self._allocator().create(kaitai_struct.KaitaiStream);
            _io__raw_value.* = kaitai_struct.KaitaiStream.fromBytes(self._raw_value);
            self.value = try BytesWrapper.create(self._arena, _io__raw_value, self, self._root);
        }
        value: *BytesWrapper = undefined,
        _root: ?*TermStruct4,
        _parent: ?*TermStruct4,
        _raw_value: []u8 = undefined,
        _arena: *std.heap.ArenaAllocator,
        _io: *kaitai_struct.KaitaiStream,
    };
    pub const S2Type = struct {
        pub fn create(_arena: *std.heap.ArenaAllocator, _io: *kaitai_struct.KaitaiStream, _parent: ?*TermStruct4, _root: ?*TermStruct4) !*S2Type {
        ...
        fn _read(self: *S2Type) !void {
            self._raw_value = try self._io.readBytesTerm(self._allocator(), 124, false, false, false);
            const _io__raw_value = try self._allocator().create(kaitai_struct.KaitaiStream);
            _io__raw_value.* = kaitai_struct.KaitaiStream.fromBytes(self._raw_value);
            self.value = try BytesWrapper.create(self._arena, _io__raw_value, self, self._root);
        }
    ...
    pub const S3Type = struct {
        pub fn create(_arena: *std.heap.ArenaAllocator, _io: *kaitai_struct.KaitaiStream, _parent: ?*TermStruct4, _root: ?*TermStruct4) !*S3Type {
        ...
        fn _read(self: *S3Type) !void {
            self._raw_value = try self._io.readBytesTerm(self._allocator(), 64, true, true, false);
            const _io__raw_value = try self._allocator().create(kaitai_struct.KaitaiStream);
            _io__raw_value.* = kaitai_struct.KaitaiStream.fromBytes(self._raw_value);
            self.value = try BytesWrapper.create(self._arena, _io__raw_value, self, self._root);
        }

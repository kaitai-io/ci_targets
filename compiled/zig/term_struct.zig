...
pub const TermStruct = struct {
    pub fn create(_arena: *std.heap.ArenaAllocator, _io: *kaitai_struct.KaitaiStream, _parent: ?*anyopaque, _root: ?*TermStruct) !*TermStruct {
    ...
    fn _allocator(self: *const TermStruct) std.mem.Allocator {
    ...
    fn _read(self: *TermStruct) !void {
        ...
        self._raw_s2 = try self._io.readBytesTerm(self._allocator(), 124, false, false, true);
        ...
        self._raw_s3 = try self._io.readBytesTerm(self._allocator(), 64, true, true, true);
    ...
    pub const BytesWrapper = struct {
        pub fn create(_arena: *std.heap.ArenaAllocator, _io: *kaitai_struct.KaitaiStream, _parent: ?*TermStruct, _root: ?*TermStruct) !*BytesWrapper {

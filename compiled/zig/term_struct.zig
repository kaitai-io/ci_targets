...
pub const TermStruct = struct {
    pub fn create(_arena: *_imp_std.heap.ArenaAllocator, _io: *_imp_kaitai_struct.KaitaiStream, _parent: ?*anyopaque, _root: ?*TermStruct) !*TermStruct {
        const self = try _arena.allocator().create(TermStruct);
        self.* = .{
            ._arena = _arena,
            ._io = _io,
            ._parent = _parent,
    ...
    fn _allocator(self: *const TermStruct) _imp_std.mem.Allocator {
        return self._arena.allocator();
    }
    fn _read(self: *TermStruct) !void {
        ...
        const _raw_s2 = try self._io.readBytesTerm(self._allocator(), 124, false, false, true);
        ...
        const _raw_s3 = try self._io.readBytesTerm(self._allocator(), 64, true, true, true);
    ...
    pub const BytesWrapper = struct {
        pub fn create(_arena: *_imp_std.heap.ArenaAllocator, _io: *_imp_kaitai_struct.KaitaiStream, _parent: ?*TermStruct, _root: ?*TermStruct) !*BytesWrapper {

...
pub const ExprIfIntEq = struct {
    pub fn create(_arena: *std.heap.ArenaAllocator, _io: *kaitai_struct.KaitaiStream, _parent: ?*anyopaque, _root: ?*ExprIfIntEq) !*ExprIfIntEq {
    ...
    fn _allocator(self: *const ExprIfIntEq) std.mem.Allocator {

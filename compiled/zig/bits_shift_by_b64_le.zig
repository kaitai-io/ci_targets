...
pub const BitsShiftByB64Le = struct {
    pub fn create(_arena: *_imp_std.heap.ArenaAllocator, _io: *_imp_kaitai_struct.KaitaiStream, _parent: ?*anyopaque, _root: ?*BitsShiftByB64Le) !*BitsShiftByB64Le {
    ...
    fn _allocator(self: *const BitsShiftByB64Le) _imp_std.mem.Allocator {

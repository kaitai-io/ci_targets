...
pub const EofExceptionU4 = struct {
    pub fn create(_arena: *_imp_std.heap.ArenaAllocator, _io: *_imp_kaitai_struct.KaitaiStream, _parent: ?*anyopaque, _root: ?*EofExceptionU4) !*EofExceptionU4 {
    ...
    fn _allocator(self: *const EofExceptionU4) _imp_std.mem.Allocator {

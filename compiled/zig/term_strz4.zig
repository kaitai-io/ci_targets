...
pub const TermStrz4 = struct {
    pub fn create(_arena: *_imp_std.heap.ArenaAllocator, _io: *_imp_kaitai_struct.KaitaiStream, _parent: ?*anyopaque, _root: ?*TermStrz4) !*TermStrz4 {
    ...
    fn _allocator(self: *const TermStrz4) _imp_std.mem.Allocator {
    ...
    pub const S1Type = struct {
        pub fn create(_arena: *_imp_std.heap.ArenaAllocator, _io: *_imp_kaitai_struct.KaitaiStream, _parent: ?*TermStrz4, _root: ?*TermStrz4) !*S1Type {
        ...
        fn _read(self: *S1Type) !void {
            self.value = (try _imp_kaitai_struct.KaitaiStream.bytesToStr(self._allocator(), try self._io.readBytesTerm(self._allocator(), 124, false, true, false), "UTF-8"));
        }
    ...
    pub const S2Type = struct {
        pub fn create(_arena: *_imp_std.heap.ArenaAllocator, _io: *_imp_kaitai_struct.KaitaiStream, _parent: ?*TermStrz4, _root: ?*TermStrz4) !*S2Type {
        ...
        fn _read(self: *S2Type) !void {
            self.value = (try _imp_kaitai_struct.KaitaiStream.bytesToStr(self._allocator(), try self._io.readBytesTerm(self._allocator(), 124, false, false, false), "UTF-8"));
        }
        value: []const u8 = undefined,
        _root: ?*TermStrz4,
        _parent: ?*TermStrz4,
    ...
    pub const S3Type = struct {
        pub fn create(_arena: *_imp_std.heap.ArenaAllocator, _io: *_imp_kaitai_struct.KaitaiStream, _parent: ?*TermStrz4, _root: ?*TermStrz4) !*S3Type {
        ...
        fn _read(self: *S3Type) !void {
            self.value = (try _imp_kaitai_struct.KaitaiStream.bytesToStr(self._allocator(), try self._io.readBytesTerm(self._allocator(), 64, true, true, false), "UTF-8"));
        }
        value: []const u8 = undefined,
        _root: ?*TermStrz4,
        _parent: ?*TermStrz4,

...
pub const BcdUserTypeBe = struct {
    pub fn create(_arena: *std.heap.ArenaAllocator, _io: *kaitai_struct.KaitaiStream, _parent: ?*anyopaque, _root: ?*BcdUserTypeBe) !*BcdUserTypeBe {
    ...
    fn _allocator(self: *const BcdUserTypeBe) std.mem.Allocator {
    ...
    pub const LeadingZeroLtrObj = struct {
        pub fn create(_arena: *std.heap.ArenaAllocator, _io: *kaitai_struct.KaitaiStream, _parent: ?*BcdUserTypeBe, _root: ?*BcdUserTypeBe) !*LeadingZeroLtrObj {
    ...
    pub const LtrObj = struct {
        pub fn create(_arena: *std.heap.ArenaAllocator, _io: *kaitai_struct.KaitaiStream, _parent: ?*BcdUserTypeBe, _root: ?*BcdUserTypeBe) !*LtrObj {
    ...
    pub const RtlObj = struct {
        pub fn create(_arena: *std.heap.ArenaAllocator, _io: *kaitai_struct.KaitaiStream, _parent: ?*BcdUserTypeBe, _root: ?*BcdUserTypeBe) !*RtlObj {

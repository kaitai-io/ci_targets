...
pub const Integers = struct {
    pub fn create(_arena: *std.heap.ArenaAllocator, _io: *kaitai_struct.KaitaiStream, _parent: ?*anyopaque, _root: ?*Integers) !*Integers {
        const self = try _arena.allocator().create(Integers);
        self.* = .{
            ._arena = _arena,
            ._io = _io,
            ._parent = _parent,
    ...
    fn _allocator(self: *const Integers) std.mem.Allocator {
        return self._arena.allocator();
    }
    fn _read(self: *Integers) !void {

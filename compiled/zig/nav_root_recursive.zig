...
pub const NavRootRecursive = struct {
    pub fn create(_arena: *_imp_std.heap.ArenaAllocator, _io: *_imp_kaitai_struct.KaitaiStream, _parent: ?*anyopaque, _root: ?*NavRootRecursive) !*NavRootRecursive {
    ...
    fn _allocator(self: *const NavRootRecursive) _imp_std.mem.Allocator {

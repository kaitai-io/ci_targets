...
pub const RepeatEosTermBytes = struct {
    pub fn create(_arena: *_imp_std.heap.ArenaAllocator, _io: *_imp_kaitai_struct.KaitaiStream, _parent: ?*anyopaque, _root: ?*RepeatEosTermBytes) !*RepeatEosTermBytes {
    ...
    fn _allocator(self: *const RepeatEosTermBytes) _imp_std.mem.Allocator {

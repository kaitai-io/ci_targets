...
pub const Expr0 = struct {
    pub fn create(_arena: *std.heap.ArenaAllocator, _io: *kaitai_struct.KaitaiStream, _parent: ?*anyopaque, _root: ?*Expr0) !*Expr0 {
    ...
    fn _allocator(self: *const Expr0) std.mem.Allocator {
        return self._arena.allocator();
    }
    fn _read(self: *Expr0) !void {
        self.len_of_1 = try self._io.readU2le();
    }
    pub fn mustBeAbc123(self: *Expr0) ![]u8 {
        if (self._m_must_be_abc123) |_v|
            return _v;
        var _v: []u8 = undefined;
        _v = (try std.mem.concat(self._allocator(), u8, &[_][]const u8{ "abc", "123" }));

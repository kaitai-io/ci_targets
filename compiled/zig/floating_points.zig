...
pub const FloatingPoints = struct {
    pub fn create(_arena: *_imp_std.heap.ArenaAllocator, _io: *_imp_kaitai_struct.KaitaiStream, _parent: ?*anyopaque, _root: ?*FloatingPoints) !*FloatingPoints {
    ...
    fn _allocator(self: *const FloatingPoints) _imp_std.mem.Allocator {

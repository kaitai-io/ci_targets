...
pub const TermBytes2 = struct {
    pub fn create(_arena: *std.heap.ArenaAllocator, _io: *kaitai_struct.KaitaiStream, _parent: ?*anyopaque, _root: ?*TermBytes2) !*TermBytes2 {
    ...
    fn _allocator(self: *const TermBytes2) std.mem.Allocator {

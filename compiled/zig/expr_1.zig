...
pub const Expr1 = struct {
    pub fn create(_arena: *_imp_std.heap.ArenaAllocator, _io: *_imp_kaitai_struct.KaitaiStream, _parent: ?*anyopaque, _root: ?*Expr1) !*Expr1 {
    ...
    fn _allocator(self: *const Expr1) _imp_std.mem.Allocator {
        return self._arena.allocator();
    }
    fn _read(self: *Expr1) !void {
        self.len_of_1 = try self._io.readU2le();
        self.str1 = (try _imp_kaitai_struct.KaitaiStream.bytesToStr(self._allocator(), try self._io.readBytes(self._allocator(), (try self.lenOf1Mod())), "ASCII"));
    }

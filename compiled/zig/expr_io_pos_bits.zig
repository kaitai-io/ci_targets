...
pub const ExprIoPosBits = struct {
    pub fn create(_arena: *_imp_std.heap.ArenaAllocator, _io: *_imp_kaitai_struct.KaitaiStream, _parent: ?*anyopaque, _root: ?*ExprIoPosBits) !*ExprIoPosBits {
    ...
    fn _allocator(self: *const ExprIoPosBits) _imp_std.mem.Allocator {

...
pub const SwitchManualIntElse = struct {
    pub fn create(_arena: *std.heap.ArenaAllocator, _io: *kaitai_struct.KaitaiStream, _parent: ?*anyopaque, _root: ?*SwitchManualIntElse) !*SwitchManualIntElse {
    ...
    fn _allocator(self: *const SwitchManualIntElse) std.mem.Allocator {
    ...
    pub const Opcode = struct {
        pub fn create(_arena: *std.heap.ArenaAllocator, _io: *kaitai_struct.KaitaiStream, _parent: ?*SwitchManualIntElse, _root: ?*SwitchManualIntElse) !*Opcode {
        ...
        pub const Intval = struct {
            pub fn create(_arena: *std.heap.ArenaAllocator, _io: *kaitai_struct.KaitaiStream, _parent: ?*SwitchManualIntElse.Opcode, _root: ?*SwitchManualIntElse) !*Intval {
        ...
        pub const Noneval = struct {
            pub fn create(_arena: *std.heap.ArenaAllocator, _io: *kaitai_struct.KaitaiStream, _parent: ?*SwitchManualIntElse.Opcode, _root: ?*SwitchManualIntElse) !*Noneval {
        ...
        pub const Strval = struct {
            pub fn create(_arena: *std.heap.ArenaAllocator, _io: *kaitai_struct.KaitaiStream, _parent: ?*SwitchManualIntElse.Opcode, _root: ?*SwitchManualIntElse) !*Strval {

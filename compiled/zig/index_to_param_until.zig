...
pub const IndexToParamUntil = struct {
    pub fn create(_arena: *std.heap.ArenaAllocator, _io: *kaitai_struct.KaitaiStream, _parent: ?*anyopaque, _root: ?*IndexToParamUntil) !*IndexToParamUntil {
    ...
    fn _allocator(self: *const IndexToParamUntil) std.mem.Allocator {
    ...
    pub const Block = struct {
        pub fn create(_arena: *std.heap.ArenaAllocator, _io: *kaitai_struct.KaitaiStream, _parent: ?*IndexToParamUntil, _root: ?*IndexToParamUntil, idx: i32) !*Block {

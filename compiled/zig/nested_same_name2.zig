...
pub const NestedSameName2 = struct {
    pub fn create(_arena: *_imp_std.heap.ArenaAllocator, _io: *_imp_kaitai_struct.KaitaiStream, _parent: ?*anyopaque, _root: ?*NestedSameName2) !*NestedSameName2 {
    ...
    fn _allocator(self: *const NestedSameName2) _imp_std.mem.Allocator {
    ...
    pub const DummyObj = struct {
        pub fn create(_arena: *_imp_std.heap.ArenaAllocator, _io: *_imp_kaitai_struct.KaitaiStream, _parent: ?*NestedSameName2, _root: ?*NestedSameName2) !*DummyObj {
        ...
        pub const FooObj = struct {
            pub fn create(_arena: *_imp_std.heap.ArenaAllocator, _io: *_imp_kaitai_struct.KaitaiStream, _parent: ?*NestedSameName2.DummyObj, _root: ?*NestedSameName2) !*FooObj {
    ...
    pub const Main = struct {
        pub fn create(_arena: *_imp_std.heap.ArenaAllocator, _io: *_imp_kaitai_struct.KaitaiStream, _parent: ?*NestedSameName2, _root: ?*NestedSameName2) !*Main {
        ...
        pub const FooObj = struct {
            pub fn create(_arena: *_imp_std.heap.ArenaAllocator, _io: *_imp_kaitai_struct.KaitaiStream, _parent: ?*NestedSameName2.Main, _root: ?*NestedSameName2) !*FooObj {
                const self = try _arena.allocator().create(FooObj);
                self.* = .{
                    ._arena = _arena,
                    ._io = _io,

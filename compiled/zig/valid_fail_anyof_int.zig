...
pub const ValidFailAnyofInt = struct {
    pub fn create(_arena: *_imp_std.heap.ArenaAllocator, _io: *_imp_kaitai_struct.KaitaiStream, _parent: ?*anyopaque, _root: ?*ValidFailAnyofInt) !*ValidFailAnyofInt {
    ...
    fn _allocator(self: *const ValidFailAnyofInt) _imp_std.mem.Allocator {

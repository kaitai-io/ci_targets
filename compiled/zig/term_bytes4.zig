...
pub const TermBytes4 = struct {
    pub fn create(_arena: *_imp_std.heap.ArenaAllocator, _io: *_imp_kaitai_struct.KaitaiStream, _parent: ?*anyopaque, _root: ?*TermBytes4) !*TermBytes4 {
        const self = try _arena.allocator().create(TermBytes4);
        self.* = .{
            ._arena = _arena,
            ._io = _io,
            ._parent = _parent,
    ...
    fn _allocator(self: *const TermBytes4) _imp_std.mem.Allocator {
        return self._arena.allocator();
    }
    fn _read(self: *TermBytes4) !void {
    ...
    pub const S1Type = struct {
        pub fn create(_arena: *_imp_std.heap.ArenaAllocator, _io: *_imp_kaitai_struct.KaitaiStream, _parent: ?*TermBytes4, _root: ?*TermBytes4) !*S1Type {
        ...
        fn _read(self: *S1Type) !void {
            self.value = try self._io.readBytesTerm(self._allocator(), 124, false, true, false);
        }
    ...
    pub const S2Type = struct {
        pub fn create(_arena: *_imp_std.heap.ArenaAllocator, _io: *_imp_kaitai_struct.KaitaiStream, _parent: ?*TermBytes4, _root: ?*TermBytes4) !*S2Type {
        ...
        fn _read(self: *S2Type) !void {
            self.value = try self._io.readBytesTerm(self._allocator(), 124, false, false, false);
        }
        value: []const u8 = undefined,
        _root: ?*TermBytes4,
        _parent: ?*TermBytes4,
    ...
    pub const S3Type = struct {
        pub fn create(_arena: *_imp_std.heap.ArenaAllocator, _io: *_imp_kaitai_struct.KaitaiStream, _parent: ?*TermBytes4, _root: ?*TermBytes4) !*S3Type {
        ...
        fn _read(self: *S3Type) !void {
            self.value = try self._io.readBytesTerm(self._allocator(), 64, true, true, false);
        }
        value: []const u8 = undefined,
        _root: ?*TermBytes4,
        _parent: ?*TermBytes4,

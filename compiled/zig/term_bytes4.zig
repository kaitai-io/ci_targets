...
pub const TermBytes4 = struct {
    pub fn create(_arena: *std.heap.ArenaAllocator, _io: *kaitai_struct.KaitaiStream, _parent: ?*anyopaque, _root: ?*TermBytes4) !*TermBytes4 {
    ...
    fn _allocator(self: *const TermBytes4) std.mem.Allocator {
    ...
    pub const S1Type = struct {
        pub fn create(_arena: *std.heap.ArenaAllocator, _io: *kaitai_struct.KaitaiStream, _parent: ?*TermBytes4, _root: ?*TermBytes4) !*S1Type {
    ...
    pub const S2Type = struct {
        pub fn create(_arena: *std.heap.ArenaAllocator, _io: *kaitai_struct.KaitaiStream, _parent: ?*TermBytes4, _root: ?*TermBytes4) !*S2Type {
    ...
    pub const S3Type = struct {
        pub fn create(_arena: *std.heap.ArenaAllocator, _io: *kaitai_struct.KaitaiStream, _parent: ?*TermBytes4, _root: ?*TermBytes4) !*S3Type {

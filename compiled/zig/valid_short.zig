...
pub const ValidShort = struct {
    pub fn create(_arena: *std.heap.ArenaAllocator, _io: *kaitai_struct.KaitaiStream, _parent: ?*anyopaque, _root: ?*ValidShort) !*ValidShort {
    ...
    fn _allocator(self: *const ValidShort) std.mem.Allocator {

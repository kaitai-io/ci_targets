...
pub const StrEosPadTermEmpty = struct {
    pub fn create(_arena: *std.heap.ArenaAllocator, _io: *kaitai_struct.KaitaiStream, _parent: ?*anyopaque, _root: ?*StrEosPadTermEmpty) !*StrEosPadTermEmpty {
    ...
    fn _allocator(self: *const StrEosPadTermEmpty) std.mem.Allocator {
    ...
    pub const StrPadType = struct {
        pub fn create(_arena: *std.heap.ArenaAllocator, _io: *kaitai_struct.KaitaiStream, _parent: ?*StrEosPadTermEmpty, _root: ?*StrEosPadTermEmpty) !*StrPadType {
    ...
    pub const StrTermAndPadType = struct {
        pub fn create(_arena: *std.heap.ArenaAllocator, _io: *kaitai_struct.KaitaiStream, _parent: ?*StrEosPadTermEmpty, _root: ?*StrEosPadTermEmpty) !*StrTermAndPadType {
    ...
    pub const StrTermIncludeType = struct {
        pub fn create(_arena: *std.heap.ArenaAllocator, _io: *kaitai_struct.KaitaiStream, _parent: ?*StrEosPadTermEmpty, _root: ?*StrEosPadTermEmpty) !*StrTermIncludeType {
    ...
    pub const StrTermType = struct {
        pub fn create(_arena: *std.heap.ArenaAllocator, _io: *kaitai_struct.KaitaiStream, _parent: ?*StrEosPadTermEmpty, _root: ?*StrEosPadTermEmpty) !*StrTermType {

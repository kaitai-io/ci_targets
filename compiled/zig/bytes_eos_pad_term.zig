...
pub const BytesEosPadTerm = struct {
    pub fn create(_arena: *_imp_std.heap.ArenaAllocator, _io: *_imp_kaitai_struct.KaitaiStream, _parent: ?*anyopaque, _root: ?*BytesEosPadTerm) !*BytesEosPadTerm {
    ...
    fn _allocator(self: *const BytesEosPadTerm) _imp_std.mem.Allocator {
    ...
    pub const StrPadType = struct {
        pub fn create(_arena: *_imp_std.heap.ArenaAllocator, _io: *_imp_kaitai_struct.KaitaiStream, _parent: ?*BytesEosPadTerm, _root: ?*BytesEosPadTerm) !*StrPadType {
        ...
        fn _read(self: *StrPadType) !void {
            self.value = _imp_kaitai_struct.KaitaiStream.bytesStripRight(try self._io.readBytesFull(self._allocator()), 64);
        }
    ...
    pub const StrTermAndPadType = struct {
        pub fn create(_arena: *_imp_std.heap.ArenaAllocator, _io: *_imp_kaitai_struct.KaitaiStream, _parent: ?*BytesEosPadTerm, _root: ?*BytesEosPadTerm) !*StrTermAndPadType {
        ...
        fn _read(self: *StrTermAndPadType) !void {
            self.value = _imp_kaitai_struct.KaitaiStream.bytesTerminate(_imp_kaitai_struct.KaitaiStream.bytesStripRight(try self._io.readBytesFull(self._allocator()), 43), 64, false);
        }
        value: []const u8 = undefined,
        _root: ?*BytesEosPadTerm,
        _parent: ?*BytesEosPadTerm,
    ...
    pub const StrTermIncludeType = struct {
        pub fn create(_arena: *_imp_std.heap.ArenaAllocator, _io: *_imp_kaitai_struct.KaitaiStream, _parent: ?*BytesEosPadTerm, _root: ?*BytesEosPadTerm) !*StrTermIncludeType {
        ...
        fn _read(self: *StrTermIncludeType) !void {
            self.value = _imp_kaitai_struct.KaitaiStream.bytesTerminate(try self._io.readBytesFull(self._allocator()), 64, true);
        }
        value: []const u8 = undefined,
        _root: ?*BytesEosPadTerm,
        _parent: ?*BytesEosPadTerm,
    ...
    pub const StrTermType = struct {
        pub fn create(_arena: *_imp_std.heap.ArenaAllocator, _io: *_imp_kaitai_struct.KaitaiStream, _parent: ?*BytesEosPadTerm, _root: ?*BytesEosPadTerm) !*StrTermType {
        ...
        fn _read(self: *StrTermType) !void {
            self.value = _imp_kaitai_struct.KaitaiStream.bytesTerminate(try self._io.readBytesFull(self._allocator()), 64, false);
        }
        value: []const u8 = undefined,
        _root: ?*BytesEosPadTerm,
        _parent: ?*BytesEosPadTerm,

...
pub const StrEosPadTermEqual = struct {
    pub fn create(_arena: *std.heap.ArenaAllocator, _io: *kaitai_struct.KaitaiStream, _parent: ?*anyopaque, _root: ?*StrEosPadTermEqual) !*StrEosPadTermEqual {
    ...
    fn _allocator(self: *const StrEosPadTermEqual) std.mem.Allocator {
        return self._arena.allocator();
    }
    fn _read(self: *StrEosPadTermEqual) !void {
        self._raw_s1 = try self._io.readBytes(self._allocator(), 20);
        ...
        self._raw_s2 = try self._io.readBytes(self._allocator(), 20);
        ...
        self._raw_s3 = try self._io.readBytes(self._allocator(), 20);
        ...
        self._raw_s4 = try self._io.readBytes(self._allocator(), 20);
    ...
    pub const S1Type = struct {
        pub fn create(_arena: *std.heap.ArenaAllocator, _io: *kaitai_struct.KaitaiStream, _parent: ?*StrEosPadTermEqual, _root: ?*StrEosPadTermEqual) !*S1Type {
    ...
    pub const S2Type = struct {
        pub fn create(_arena: *std.heap.ArenaAllocator, _io: *kaitai_struct.KaitaiStream, _parent: ?*StrEosPadTermEqual, _root: ?*StrEosPadTermEqual) !*S2Type {
        ...
        fn _read(self: *S2Type) !void {
            self.value = kaitai_struct.KaitaiStream.bytesToStr(kaitai_struct.KaitaiStream.bytesTerminate(kaitai_struct.KaitaiStream.bytesStripRight(try self._io.readBytesFull(self._allocator()), 43), 64, true), "UTF-8");
        }
        value: []u8 = undefined,
        _root: ?*StrEosPadTermEqual,
        _parent: ?*StrEosPadTermEqual,
    ...
    pub const S3Type = struct {
        pub fn create(_arena: *std.heap.ArenaAllocator, _io: *kaitai_struct.KaitaiStream, _parent: ?*StrEosPadTermEqual, _root: ?*StrEosPadTermEqual) !*S3Type {
        ...
        fn _read(self: *S3Type) !void {
            self.value = kaitai_struct.KaitaiStream.bytesToStr(kaitai_struct.KaitaiStream.bytesTerminate(try self._io.readBytesFull(self._allocator()), 43, false), "UTF-8");
        }
        value: []u8 = undefined,
        _root: ?*StrEosPadTermEqual,
        _parent: ?*StrEosPadTermEqual,
    ...
    pub const S4Type = struct {
        pub fn create(_arena: *std.heap.ArenaAllocator, _io: *kaitai_struct.KaitaiStream, _parent: ?*StrEosPadTermEqual, _root: ?*StrEosPadTermEqual) !*S4Type {
        ...
        fn _allocator(self: *const S4Type) std.mem.Allocator {
            return self._arena.allocator();
        }
        fn _read(self: *S4Type) !void {
            self.value = kaitai_struct.KaitaiStream.bytesToStr(kaitai_struct.KaitaiStream.bytesTerminate(try self._io.readBytesFull(self._allocator()), 46, true), "UTF-8");
        }
        value: []u8 = undefined,
        _root: ?*StrEosPadTermEqual,
        _parent: ?*StrEosPadTermEqual,

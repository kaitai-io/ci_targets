...
pub const DebugArrayUserEofException = struct {
    pub fn create(_arena: *std.heap.ArenaAllocator, _io: *kaitai_struct.KaitaiStream, _parent: ?*anyopaque, _root: ?*DebugArrayUserEofException) !*DebugArrayUserEofException {
    ...
    fn _allocator(self: *const DebugArrayUserEofException) std.mem.Allocator {
    ...
    pub const Cat = struct {
        pub fn create(_arena: *std.heap.ArenaAllocator, _io: *kaitai_struct.KaitaiStream, _parent: ?*DebugArrayUserEofException, _root: ?*DebugArrayUserEofException) !*Cat {

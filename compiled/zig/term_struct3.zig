...
pub const TermStruct3 = struct {
    pub fn create(_arena: *_imp_std.heap.ArenaAllocator, _io: *_imp_kaitai_struct.KaitaiStream, _parent: ?*anyopaque, _root: ?*TermStruct3) !*TermStruct3 {
        const self = try _arena.allocator().create(TermStruct3);
        self.* = .{
            ._arena = _arena,
            ._io = _io,
            ._parent = _parent,
    ...
    fn _allocator(self: *const TermStruct3) _imp_std.mem.Allocator {
        return self._arena.allocator();
    }
    fn _read(self: *TermStruct3) !void {
        const _raw_s1 = try self._io.readBytesTerm(self._allocator(), 124, false, false, true);
        ...
        const _raw_s2 = try self._io.readBytesTerm(self._allocator(), 64, false, false, true);
        ...
        const _raw_s3 = try self._io.readBytesTerm(self._allocator(), 64, false, true, true);
    ...
    pub const BytesWrapper = struct {
        pub fn create(_arena: *_imp_std.heap.ArenaAllocator, _io: *_imp_kaitai_struct.KaitaiStream, _parent: ?*TermStruct3, _root: ?*TermStruct3) !*BytesWrapper {

...
pub const ExprIntDiv = struct {
    pub fn create(_arena: *std.heap.ArenaAllocator, _io: *kaitai_struct.KaitaiStream, _parent: ?*anyopaque, _root: ?*ExprIntDiv) !*ExprIntDiv {
    ...
    fn _allocator(self: *const ExprIntDiv) std.mem.Allocator {

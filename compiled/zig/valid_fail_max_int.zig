...
pub const ValidFailMaxInt = struct {
    pub fn create(_arena: *std.heap.ArenaAllocator, _io: *kaitai_struct.KaitaiStream, _parent: ?*anyopaque, _root: ?*ValidFailMaxInt) !*ValidFailMaxInt {
    ...
    fn _allocator(self: *const ValidFailMaxInt) std.mem.Allocator {

...
pub const EofExceptionBitsLe2 = struct {
    pub fn create(_arena: *_imp_std.heap.ArenaAllocator, _io: *_imp_kaitai_struct.KaitaiStream, _parent: ?*anyopaque, _root: ?*EofExceptionBitsLe2) !*EofExceptionBitsLe2 {
    ...
    fn _allocator(self: *const EofExceptionBitsLe2) _imp_std.mem.Allocator {

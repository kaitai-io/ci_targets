...
pub const TypeTernary2ndFalsy = struct {
    pub fn create(_arena: *_imp_std.heap.ArenaAllocator, _io: *_imp_kaitai_struct.KaitaiStream, _parent: ?*anyopaque, _root: ?*TypeTernary2ndFalsy) !*TypeTernary2ndFalsy {
    ...
    fn _allocator(self: *const TypeTernary2ndFalsy) _imp_std.mem.Allocator {
    ...
    fn _read(self: *TypeTernary2ndFalsy) !void {
        ...
        self.int_array = try self._allocator().create(_imp_std.ArrayList(u8));
        ...
        self.int_array_empty = try self._allocator().create(_imp_std.ArrayList(u8));
    ...
    pub const Foo = struct {
        pub fn create(_arena: *_imp_std.heap.ArenaAllocator, _io: *_imp_kaitai_struct.KaitaiStream, _parent: ?*TypeTernary2ndFalsy, _root: ?*TypeTernary2ndFalsy) !*Foo {
    ...
    pub fn vIntArrayEmpty(self: *TypeTernary2ndFalsy) !*_imp_std.ArrayList(u8) {
        if (self._m_v_int_array_empty) |_v|
            return _v;
        var _v: *_imp_std.ArrayList(u8) = undefined;
    ...
    pub fn vStrEmpty(self: *TypeTernary2ndFalsy) ![]const u8 {
    ...
    pub fn vStrWZero(self: *TypeTernary2ndFalsy) ![]const u8 {
    ...
    _m_v_int_array_empty: ?*_imp_std.ArrayList(u8) = null,
    _m_v_int_neg_zero: ?i32 = null,
    _m_v_int_zero: ?i8 = null,
    _m_v_null_ut: ?*Foo = null,
    _m_v_str_empty: ?[]const u8 = null,
    _m_v_str_w_zero: ?[]const u8 = null,
    int_truthy: u8 = undefined,
    ut: *Foo = undefined,
    int_array: *_imp_std.ArrayList(u8) = undefined,
    int_array_empty: *_imp_std.ArrayList(u8) = undefined,
    _root: ?*TypeTernary2ndFalsy,
    _parent: ?*anyopaque,
    _arena: *_imp_std.heap.ArenaAllocator,
    _io: *_imp_kaitai_struct.KaitaiStream,

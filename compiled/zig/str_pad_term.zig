...
pub const StrPadTerm = struct {
    pub fn create(_arena: *std.heap.ArenaAllocator, _io: *kaitai_struct.KaitaiStream, _parent: ?*anyopaque, _root: ?*StrPadTerm) !*StrPadTerm {
    ...
    fn _allocator(self: *const StrPadTerm) std.mem.Allocator {

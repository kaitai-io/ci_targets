...
const enum_to_i_class_border_2 = @import("enum_to_i_class_border_2.zig");
...
pub const EnumToIClassBorder1 = struct {
    ...
    pub fn create(_arena: *std.heap.ArenaAllocator, _io: *kaitai_struct.KaitaiStream, _parent: ?*anyopaque, _root: ?*EnumToIClassBorder1) !*EnumToIClassBorder1 {
    ...
    fn _allocator(self: *const EnumToIClassBorder1) std.mem.Allocator {
    ...
    pub fn checker(self: *EnumToIClassBorder1) !*enum_to_i_class_border_2.EnumToIClassBorder2 {
        if (self._m_checker) |_v|
            return _v;
        var _v: *enum_to_i_class_border_2.EnumToIClassBorder2 = undefined;
        const _pos = self._io.pos();
        try self._io.seek(0);
        _v = try enum_to_i_class_border_2.EnumToIClassBorder2.create(self._arena, self._io, null, null, self._root.?);
    ...
    _m_checker: ?*enum_to_i_class_border_2.EnumToIClassBorder2 = null,

...
pub const FixedStruct = struct {
    pub fn create(_arena: *std.heap.ArenaAllocator, _io: *kaitai_struct.KaitaiStream, _parent: ?*anyopaque, _root: ?*FixedStruct) !*FixedStruct {
    ...
    fn _allocator(self: *const FixedStruct) std.mem.Allocator {
    ...
    pub const Header = struct {
        pub fn create(_arena: *std.heap.ArenaAllocator, _io: *kaitai_struct.KaitaiStream, _parent: ?*FixedStruct, _root: ?*FixedStruct) !*Header {
        ...
        fn _allocator(self: *const Header) std.mem.Allocator {
            return self._arena.allocator();
        }
        fn _read(self: *Header) !void {
            ...
            if (!(std.mem.eql(u8, self.magic_uint, &[_]u8{ 80, 65, 67, 75, 45, 85, 45, 68, 69, 70 }))) {
                return error.ValidationNotEqualError;
            }
            ...
            if (!(std.mem.eql(u8, self.magic_sint, &[_]u8{ 80, 65, 67, 75, 45, 83, 45, 68, 69, 70 }))) {
                return error.ValidationNotEqualError;
            }
            ...
            if (!(std.mem.eql(u8, self.magic_uint_le, &[_]u8{ 80, 65, 67, 75, 45, 85, 45, 76, 69 }))) {
                return error.ValidationNotEqualError;
            }
            ...
            if (!(std.mem.eql(u8, self.magic_sint_le, &[_]u8{ 80, 65, 67, 75, 45, 83, 45, 76, 69 }))) {
                return error.ValidationNotEqualError;
            }
            ...
            if (!(std.mem.eql(u8, self.magic_uint_be, &[_]u8{ 80, 65, 67, 75, 45, 85, 45, 66, 69 }))) {
                return error.ValidationNotEqualError;
            }
            ...
            if (!(std.mem.eql(u8, self.magic_sint_be, &[_]u8{ 80, 65, 67, 75, 45, 83, 45, 66, 69 }))) {
                return error.ValidationNotEqualError;
            }

...
pub const ValidFailRepeatAnyofInt = struct {
    pub fn create(_arena: *std.heap.ArenaAllocator, _io: *kaitai_struct.KaitaiStream, _parent: ?*anyopaque, _root: ?*ValidFailRepeatAnyofInt) !*ValidFailRepeatAnyofInt {
    ...
    fn _allocator(self: *const ValidFailRepeatAnyofInt) std.mem.Allocator {

...
pub const BitsSignedShiftB32Le = struct {
    pub fn create(_arena: *std.heap.ArenaAllocator, _io: *kaitai_struct.KaitaiStream, _parent: ?*anyopaque, _root: ?*BitsSignedShiftB32Le) !*BitsSignedShiftB32Le {
    ...
    fn _allocator(self: *const BitsSignedShiftB32Le) std.mem.Allocator {

...
pub const EofExceptionBitsLe = struct {
    pub fn create(_arena: *std.heap.ArenaAllocator, _io: *kaitai_struct.KaitaiStream, _parent: ?*anyopaque, _root: ?*EofExceptionBitsLe) !*EofExceptionBitsLe {
    ...
    fn _allocator(self: *const EofExceptionBitsLe) std.mem.Allocator {

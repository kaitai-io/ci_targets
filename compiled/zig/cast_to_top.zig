...
pub const CastToTop = struct {
    pub fn create(_arena: *std.heap.ArenaAllocator, _io: *kaitai_struct.KaitaiStream, _parent: ?*anyopaque, _root: ?*CastToTop) !*CastToTop {
    ...
    fn _allocator(self: *const CastToTop) std.mem.Allocator {

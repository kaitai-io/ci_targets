...
pub const EnumIntRangeU = struct {
    ...
    pub fn create(_arena: *std.heap.ArenaAllocator, _io: *kaitai_struct.KaitaiStream, _parent: ?*anyopaque, _root: ?*EnumIntRangeU) !*EnumIntRangeU {
    ...
    fn _allocator(self: *const EnumIntRangeU) std.mem.Allocator {

...
pub const NestedTypes2 = struct {
    pub fn create(_arena: *_imp_std.heap.ArenaAllocator, _io: *_imp_kaitai_struct.KaitaiStream, _parent: ?*anyopaque, _root: ?*NestedTypes2) !*NestedTypes2 {
    ...
    fn _allocator(self: *const NestedTypes2) _imp_std.mem.Allocator {
    ...
    pub const SubtypeA = struct {
        pub fn create(_arena: *_imp_std.heap.ArenaAllocator, _io: *_imp_kaitai_struct.KaitaiStream, _parent: ?*NestedTypes2, _root: ?*NestedTypes2) !*SubtypeA {
        ...
        pub const SubtypeC = struct {
            pub fn create(_arena: *_imp_std.heap.ArenaAllocator, _io: *_imp_kaitai_struct.KaitaiStream, _parent: ?*NestedTypes2.SubtypeA, _root: ?*NestedTypes2) !*SubtypeC {
            ...
            pub const SubtypeD = struct {
                pub fn create(_arena: *_imp_std.heap.ArenaAllocator, _io: *_imp_kaitai_struct.KaitaiStream, _parent: ?*NestedTypes2.SubtypeA.SubtypeC, _root: ?*NestedTypes2) !*SubtypeD {
        ...
        pub const SubtypeCc = struct {
            pub fn create(_arena: *_imp_std.heap.ArenaAllocator, _io: *_imp_kaitai_struct.KaitaiStream, _parent: ?*anyopaque, _root: ?*NestedTypes2) !*SubtypeCc {
    ...
    pub const SubtypeB = struct {
        pub fn create(_arena: *_imp_std.heap.ArenaAllocator, _io: *_imp_kaitai_struct.KaitaiStream, _parent: ?*anyopaque, _root: ?*NestedTypes2) !*SubtypeB {

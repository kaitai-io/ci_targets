...
pub const TermStrz = struct {
    pub fn create(_arena: *std.heap.ArenaAllocator, _io: *kaitai_struct.KaitaiStream, _parent: ?*anyopaque, _root: ?*TermStrz) !*TermStrz {
    ...
    fn _allocator(self: *const TermStrz) std.mem.Allocator {

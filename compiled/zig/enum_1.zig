...
pub const Enum1 = struct {
    pub fn create(_arena: *std.heap.ArenaAllocator, _io: *kaitai_struct.KaitaiStream, _parent: ?*anyopaque, _root: ?*Enum1) !*Enum1 {
    ...
    fn _allocator(self: *const Enum1) std.mem.Allocator {
    ...
    pub const MainObj = struct {
        ...
        pub fn create(_arena: *std.heap.ArenaAllocator, _io: *kaitai_struct.KaitaiStream, _parent: ?*Enum1, _root: ?*Enum1) !*MainObj {
        ...
        pub const SubmainObj = struct {
            pub fn create(_arena: *std.heap.ArenaAllocator, _io: *kaitai_struct.KaitaiStream, _parent: ?*Enum1.MainObj, _root: ?*Enum1) !*SubmainObj {

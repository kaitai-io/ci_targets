...
pub const RepeatEosStruct = struct {
    pub fn create(_arena: *_imp_std.heap.ArenaAllocator, _io: *_imp_kaitai_struct.KaitaiStream, _parent: ?*anyopaque, _root: ?*RepeatEosStruct) !*RepeatEosStruct {
    ...
    fn _allocator(self: *const RepeatEosStruct) _imp_std.mem.Allocator {
    ...
    pub const Chunk = struct {
        pub fn create(_arena: *_imp_std.heap.ArenaAllocator, _io: *_imp_kaitai_struct.KaitaiStream, _parent: ?*RepeatEosStruct, _root: ?*RepeatEosStruct) !*Chunk {

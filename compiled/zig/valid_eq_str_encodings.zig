...
pub const ValidEqStrEncodings = struct {
    pub fn create(_arena: *_imp_std.heap.ArenaAllocator, _io: *_imp_kaitai_struct.KaitaiStream, _parent: ?*anyopaque, _root: ?*ValidEqStrEncodings) !*ValidEqStrEncodings {
    ...
    fn _allocator(self: *const ValidEqStrEncodings) _imp_std.mem.Allocator {
    ...
    fn _read(self: *ValidEqStrEncodings) !void {
        ...
        if (!(_imp_std.mem.eql(u8, self.str1, "Some ASCII"))) {
        ...
        if (!(_imp_std.mem.eql(u8, self.str2, "\u{3053}\u{3093}\u{306b}\u{3061}\u{306f}"))) {
            return error.ValidationNotEqualError;
        }
        ...
        if (!(_imp_std.mem.eql(u8, self.str3, "\u{3053}\u{3093}\u{306b}\u{3061}\u{306f}"))) {
            return error.ValidationNotEqualError;
        }
        ...
        if (!(_imp_std.mem.eql(u8, self.str4, "\u{2591}\u{2592}\u{2593}"))) {
            return error.ValidationNotEqualError;
        }
    }

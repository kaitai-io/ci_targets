...
pub const ValidOptionalId = struct {
    pub fn create(_arena: *std.heap.ArenaAllocator, _io: *kaitai_struct.KaitaiStream, _parent: ?*anyopaque, _root: ?*ValidOptionalId) !*ValidOptionalId {
    ...
    fn _allocator(self: *const ValidOptionalId) std.mem.Allocator {
        return self._arena.allocator();
    }
    fn _read(self: *ValidOptionalId) !void {
        self._unnamed0 = try self._io.readBytes(self._allocator(), 6);
        if (!(std.mem.eql(u8, self._unnamed0, &[_]u8{ 80, 65, 67, 75, 45, 49 }))) {

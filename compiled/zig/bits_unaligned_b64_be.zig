...
pub const BitsUnalignedB64Be = struct {
    pub fn create(_arena: *_imp_std.heap.ArenaAllocator, _io: *_imp_kaitai_struct.KaitaiStream, _parent: ?*anyopaque, _root: ?*BitsUnalignedB64Be) !*BitsUnalignedB64Be {
    ...
    fn _allocator(self: *const BitsUnalignedB64Be) _imp_std.mem.Allocator {

...
pub const RepeatEosBytesPad = struct {
    pub fn create(_arena: *std.heap.ArenaAllocator, _io: *kaitai_struct.KaitaiStream, _parent: ?*anyopaque, _root: ?*RepeatEosBytesPad) !*RepeatEosBytesPad {
    ...
    fn _allocator(self: *const RepeatEosBytesPad) std.mem.Allocator {

...
pub const ExprSizeofType1 = struct {
    pub fn create(_arena: *std.heap.ArenaAllocator, _io: *kaitai_struct.KaitaiStream, _parent: ?*anyopaque, _root: ?*ExprSizeofType1) !*ExprSizeofType1 {
    ...
    fn _allocator(self: *const ExprSizeofType1) std.mem.Allocator {
    ...
    pub const Block = struct {
        pub fn create(_arena: *std.heap.ArenaAllocator, _io: *kaitai_struct.KaitaiStream, _parent: ?*anyopaque, _root: ?*ExprSizeofType1) !*Block {
        ...
        pub const Subblock = struct {
            pub fn create(_arena: *std.heap.ArenaAllocator, _io: *kaitai_struct.KaitaiStream, _parent: ?*ExprSizeofType1.Block, _root: ?*ExprSizeofType1) !*Subblock {
            ...
            fn _allocator(self: *const Subblock) std.mem.Allocator {
                return self._arena.allocator();
            }

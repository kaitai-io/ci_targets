...
pub const SwitchBytearray = struct {
    pub fn create(_arena: *_imp_std.heap.ArenaAllocator, _io: *_imp_kaitai_struct.KaitaiStream, _parent: ?*anyopaque, _root: ?*SwitchBytearray) !*SwitchBytearray {
    ...
    fn _allocator(self: *const SwitchBytearray) _imp_std.mem.Allocator {
    ...
    pub const Opcode = struct {
        ...
        pub const Intval = struct {
            pub fn create(_arena: *_imp_std.heap.ArenaAllocator, _io: *_imp_kaitai_struct.KaitaiStream, _parent: ?*SwitchBytearray.Opcode, _root: ?*SwitchBytearray) !*Intval {
        ...
        pub const Strval = struct {
            pub fn create(_arena: *_imp_std.heap.ArenaAllocator, _io: *_imp_kaitai_struct.KaitaiStream, _parent: ?*SwitchBytearray.Opcode, _root: ?*SwitchBytearray) !*Strval {

...
pub const RepeatEosBytesPadTerm = struct {
    pub fn create(_arena: *std.heap.ArenaAllocator, _io: *kaitai_struct.KaitaiStream, _parent: ?*anyopaque, _root: ?*RepeatEosBytesPadTerm) !*RepeatEosBytesPadTerm {
    ...
    fn _allocator(self: *const RepeatEosBytesPadTerm) std.mem.Allocator {

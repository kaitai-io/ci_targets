...
pub const ExprCalcArrayOps = struct {
    pub fn create(_arena: *_imp_std.heap.ArenaAllocator, _io: *_imp_kaitai_struct.KaitaiStream, _parent: ?*anyopaque, _root: ?*ExprCalcArrayOps) !*ExprCalcArrayOps {
    ...
    fn _allocator(self: *const ExprCalcArrayOps) _imp_std.mem.Allocator {
        return self._arena.allocator();
    }
    fn _read(self: *ExprCalcArrayOps) !void {
        _ = self;
    }
    pub fn doubleArray(self: *ExprCalcArrayOps) !*_imp_std.ArrayList(f64) {
        if (self._m_double_array) |_v|
            return _v;
        var _v: *_imp_std.ArrayList(f64) = undefined;
        _v = _imp_std.ArrayList(f64){ .items = @constCast(@as([]const f64, &.{ 10.0, 25.0, 50.0, 100.0, 3.14159 })), .capacity = 5 };
    ...
    pub fn doubleArrayMax(self: *ExprCalcArrayOps) !f64 {
        if (self._m_double_array_max) |_v|
            return _v;
        var _v: f64 = undefined;
        _v = _imp_std.mem.max(f64, (try self.doubleArray()).items);
    ...
    pub fn doubleArrayMin(self: *ExprCalcArrayOps) !f64 {
        if (self._m_double_array_min) |_v|
            return _v;
        var _v: f64 = undefined;
        _v = _imp_std.mem.min(f64, (try self.doubleArray()).items);
    ...
    pub fn intArray(self: *ExprCalcArrayOps) !*_imp_std.ArrayList(i32) {
        if (self._m_int_array) |_v|
            return _v;
        var _v: *_imp_std.ArrayList(i32) = undefined;
        _v = _imp_std.ArrayList(i32){ .items = @constCast(@as([]const i32, &.{ 10, 25, 50, 100, 200, 500, 1000 })), .capacity = 7 };
    ...
    pub fn intArrayMax(self: *ExprCalcArrayOps) !i32 {
        if (self._m_int_array_max) |_v|
            return _v;
        var _v: i32 = undefined;
        _v = _imp_std.mem.max(i32, (try self.intArray()).items);
    ...
    pub fn intArrayMin(self: *ExprCalcArrayOps) !i32 {
        if (self._m_int_array_min) |_v|
            return _v;
        var _v: i32 = undefined;
        _v = _imp_std.mem.min(i32, (try self.intArray()).items);
    ...
    pub fn strArray(self: *ExprCalcArrayOps) !*_imp_std.ArrayList([]const u8) {
        if (self._m_str_array) |_v|
            return _v;
        var _v: *_imp_std.ArrayList([]const u8) = undefined;
        _v = _imp_std.ArrayList([]const u8){ .items = @constCast(@as([]const []const u8, &.{ "un", "deux", "trois", "quatre" })), .capacity = 4 };
        self._m_str_array = _v;
        return _v;
    }
    pub fn strArrayFirst(self: *ExprCalcArrayOps) ![]const u8 {
    ...
    pub fn strArrayLast(self: *ExprCalcArrayOps) ![]const u8 {
    ...
    pub fn strArrayMax(self: *ExprCalcArrayOps) ![]const u8 {
        if (self._m_str_array_max) |_v|
            return _v;
        var _v: []const u8 = undefined;
        _v = _imp_std.mem.max([]const u8, (try self.strArray()).items);
        self._m_str_array_max = _v;
        return _v;
    }
    pub fn strArrayMid(self: *ExprCalcArrayOps) ![]const u8 {
    ...
    pub fn strArrayMin(self: *ExprCalcArrayOps) ![]const u8 {
        if (self._m_str_array_min) |_v|
            return _v;
        var _v: []const u8 = undefined;
        _v = _imp_std.mem.min([]const u8, (try self.strArray()).items);
    ...
    _m_double_array: ?*_imp_std.ArrayList(f64) = null,
    ...
    _m_int_array: ?*_imp_std.ArrayList(i32) = null,
    ...
    _m_str_array: ?*_imp_std.ArrayList([]const u8) = null,
    _m_str_array_first: ?[]const u8 = null,
    _m_str_array_last: ?[]const u8 = null,
    _m_str_array_max: ?[]const u8 = null,
    _m_str_array_mid: ?[]const u8 = null,
    _m_str_array_min: ?[]const u8 = null,

...
pub const DefaultEndianExprIsLe = struct {
    pub fn create(_arena: *_imp_std.heap.ArenaAllocator, _io: *_imp_kaitai_struct.KaitaiStream, _parent: ?*anyopaque, _root: ?*DefaultEndianExprIsLe) !*DefaultEndianExprIsLe {
    ...
    fn _allocator(self: *const DefaultEndianExprIsLe) _imp_std.mem.Allocator {
    ...
    pub const Doc = struct {
        pub fn create(_arena: *_imp_std.heap.ArenaAllocator, _io: *_imp_kaitai_struct.KaitaiStream, _parent: ?*DefaultEndianExprIsLe, _root: ?*DefaultEndianExprIsLe) !*Doc {
        ...
        pub const MainObj = struct {
            pub fn create(_arena: *_imp_std.heap.ArenaAllocator, _io: *_imp_kaitai_struct.KaitaiStream, _parent: ?*DefaultEndianExprIsLe.Doc, _root: ?*DefaultEndianExprIsLe) !*MainObj {

...
pub const BytesPadTermEmpty = struct {
    pub fn create(_arena: *std.heap.ArenaAllocator, _io: *kaitai_struct.KaitaiStream, _parent: ?*anyopaque, _root: ?*BytesPadTermEmpty) !*BytesPadTermEmpty {
    ...
    fn _allocator(self: *const BytesPadTermEmpty) std.mem.Allocator {
    ...
    fn _read(self: *BytesPadTermEmpty) !void {
        ...
        self.str_term = kaitai_struct.KaitaiStream.bytesTerminate(try self._io.readBytes(self._allocator(), 20), 64, false);
        ...
        self.str_term_include = kaitai_struct.KaitaiStream.bytesTerminate(try self._io.readBytes(self._allocator(), 20), 64, true);
    }

...
pub const ValidFailRangeFloat = struct {
    pub fn create(_arena: *_imp_std.heap.ArenaAllocator, _io: *_imp_kaitai_struct.KaitaiStream, _parent: ?*anyopaque, _root: ?*ValidFailRangeFloat) !*ValidFailRangeFloat {
    ...
    fn _allocator(self: *const ValidFailRangeFloat) _imp_std.mem.Allocator {

...
namespace Kaitai
{
    public partial class TermStruct3 : KaitaiStruct
    {
        public static TermStruct3 FromFile(string fileName)
        {
            return new TermStruct3(new KaitaiStream(fileName));
        }

        public TermStruct3(KaitaiStream p__io, KaitaiStruct p__parent = null, TermStruct3 p__root = null) : base(p__io)
        {
            m_parent = p__parent;
            m_root = p__root ?? this;
            _read();
        ...
        public partial class BytesWrapper : KaitaiStruct
        {
            ...
            public BytesWrapper(KaitaiStream p__io, TermStruct3 p__parent = null, TermStruct3 p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();

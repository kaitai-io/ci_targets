...
namespace Kaitai
{
    public partial class BcdUserTypeBe : KaitaiStruct
    {
        public static BcdUserTypeBe FromFile(string fileName)
        {
            return new BcdUserTypeBe(new KaitaiStream(fileName));
        }

        public BcdUserTypeBe(KaitaiStream io, KaitaiStruct parent = null, BcdUserTypeBe root = null) : base(io)
        {
            m_parent = parent;
            m_root = root ?? this;
            _parse();
        ...
        public partial class LtrObj : KaitaiStruct
        {
            ...
            public LtrObj(KaitaiStream io, BcdUserTypeBe parent = null, BcdUserTypeBe root = null) : base(io)
            {
                m_parent = parent;
                m_root = root;
                _parse();
            ...
            private byte _b3;
            private byte _b4;
            private BcdUserTypeBe m_root;
            private BcdUserTypeBe m_parent;
            public byte B1 { get { return _b1; } }
            public byte B2 { get { return _b2; } }
            public byte B3 { get { return _b3; } }
            public byte B4 { get { return _b4; } }
            public BcdUserTypeBe M_Root { get { return m_root; } }
            public BcdUserTypeBe M_Parent { get { return m_parent; } }
        }
        public partial class RtlObj : KaitaiStruct
        {
            ...
            public RtlObj(KaitaiStream io, BcdUserTypeBe parent = null, BcdUserTypeBe root = null) : base(io)
            {
                m_parent = parent;
                m_root = root;
                _parse();
        ...
        public partial class LeadingZeroLtrObj : KaitaiStruct
        {
            ...
            public LeadingZeroLtrObj(KaitaiStream io, BcdUserTypeBe parent = null, BcdUserTypeBe root = null) : base(io)
            {
                m_parent = parent;
                m_root = root;
                _parse();

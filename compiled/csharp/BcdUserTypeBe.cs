...
namespace Kaitai
{
    public partial class BcdUserTypeBe : KaitaiStruct
    {
        ...
        public partial class LtrObj : KaitaiStruct
        {
            ...
            public LtrObj(KaitaiStream p__io, BcdUserTypeBe p__parent = null, BcdUserTypeBe p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                f_asInt = false;
        ...
        public partial class RtlObj : KaitaiStruct
        {
            ...
            public RtlObj(KaitaiStream p__io, BcdUserTypeBe p__parent = null, BcdUserTypeBe p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                f_asInt = false;

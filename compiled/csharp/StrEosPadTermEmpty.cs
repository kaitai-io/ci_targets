...
namespace Kaitai
{
    public partial class StrEosPadTermEmpty : KaitaiStruct
    {
        public static StrEosPadTermEmpty FromFile(string fileName)
        {
            return new StrEosPadTermEmpty(new KaitaiStream(fileName));
        }

        public StrEosPadTermEmpty(KaitaiStream p__io, KaitaiStruct p__parent = null, StrEosPadTermEmpty p__root = null) : base(p__io)
        {
            m_parent = p__parent;
            m_root = p__root ?? this;
            _read();
        ...
        public partial class StrPadType : KaitaiStruct
        {
            ...
            public StrPadType(KaitaiStream p__io, StrEosPadTermEmpty p__parent = null, StrEosPadTermEmpty p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
            ...
            private StrEosPadTermEmpty m_root;
            private StrEosPadTermEmpty m_parent;
            public string Value { get { return _value; } }
            public StrEosPadTermEmpty M_Root { get { return m_root; } }
            public StrEosPadTermEmpty M_Parent { get { return m_parent; } }
        }
        public partial class StrTermAndPadType : KaitaiStruct
        {
            ...
            public StrTermAndPadType(KaitaiStream p__io, StrEosPadTermEmpty p__parent = null, StrEosPadTermEmpty p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class StrTermIncludeType : KaitaiStruct
        {
            ...
            public StrTermIncludeType(KaitaiStream p__io, StrEosPadTermEmpty p__parent = null, StrEosPadTermEmpty p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class StrTermType : KaitaiStruct
        {
            ...
            public StrTermType(KaitaiStream p__io, StrEosPadTermEmpty p__parent = null, StrEosPadTermEmpty p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();

...
namespace Kaitai
{
    public partial class TermStrz4 : KaitaiStruct
    {
        public static TermStrz4 FromFile(string fileName)
        {
            return new TermStrz4(new KaitaiStream(fileName));
        }

        public TermStrz4(KaitaiStream p__io, KaitaiStruct p__parent = null, TermStrz4 p__root = null) : base(p__io)
        {
            m_parent = p__parent;
            m_root = p__root ?? this;
            _read();
        ...
        public partial class S1Type : KaitaiStruct
        {
            ...
            public S1Type(KaitaiStream p__io, TermStrz4 p__parent = null, TermStrz4 p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class S2Type : KaitaiStruct
        {
            ...
            public S2Type(KaitaiStream p__io, TermStrz4 p__parent = null, TermStrz4 p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class S3Type : KaitaiStruct
        {
            ...
            public S3Type(KaitaiStream p__io, TermStrz4 p__parent = null, TermStrz4 p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();

    ...
    public partial class SwitchManualStrElse : KaitaiStruct
    {
        ...
        public partial class Opcode : KaitaiStruct
        {
            ...
            public partial class Intval : KaitaiStruct
            {
                ...
                public Intval(KaitaiStream io, Opcode parent = null, SwitchManualStrElse root = null) : base(io)
                {
                    m_parent = parent;
                    m_root = root;
                    _parse();
            ...
            public partial class Strval : KaitaiStruct
            {
                ...
                public Strval(KaitaiStream io, Opcode parent = null, SwitchManualStrElse root = null) : base(io)
                {
                    m_parent = parent;
                    m_root = root;
                    _parse();
            ...
            public partial class Noneval : KaitaiStruct
            {
                ...
                public Noneval(KaitaiStream io, Opcode parent = null, SwitchManualStrElse root = null) : base(io)
                {
                    m_parent = parent;
                    m_root = root;
                    _parse();

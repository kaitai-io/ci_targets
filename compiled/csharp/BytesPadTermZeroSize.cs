...
namespace Kaitai
{
    public partial class BytesPadTermZeroSize : KaitaiStruct
    {
        public static BytesPadTermZeroSize FromFile(string fileName)
        {
            return new BytesPadTermZeroSize(new KaitaiStream(fileName));
        }

        public BytesPadTermZeroSize(KaitaiStream p__io, KaitaiStruct p__parent = null, BytesPadTermZeroSize p__root = null) : base(p__io)
        {
            m_parent = p__parent;
            m_root = p__root ?? this;
            _read();
        ...
        private void _read()
        {
            _strPad = KaitaiStream.BytesStripRight(m_io.ReadBytes(0), 64);
            _strTerm = KaitaiStream.BytesTerminate(m_io.ReadBytes(0), 64, false);

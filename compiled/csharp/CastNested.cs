    ...
    public partial class CastNested : KaitaiStruct
    {
        ...
        public CastNested.Opcode.Strval Opcodes0Str
        {
            get
            {
                if (f_opcodes0Str)
                    return _opcodes0Str;
                _opcodes0Str = (CastNested.Opcode.Strval) (((Opcode.Strval) (Opcodes[0].Body)));
                f_opcodes0Str = true;
                return _opcodes0Str;
            }
        }
        ...
        public string Opcodes0StrValue
        {
            get
            {
                ...
                _opcodes0StrValue = (string) (((Opcode.Strval) (Opcodes[0].Body)).Value);
        ...
        public CastNested.Opcode.Intval Opcodes1Int
        {
            get
            {
                if (f_opcodes1Int)
                    return _opcodes1Int;
                _opcodes1Int = (CastNested.Opcode.Intval) (((Opcode.Intval) (Opcodes[1].Body)));
                f_opcodes1Int = true;
                return _opcodes1Int;
            }
        }
        ...
        public byte Opcodes1IntValue
        {
            get
            {
                ...
                _opcodes1IntValue = (byte) (((Opcode.Intval) (Opcodes[1].Body)).Value);

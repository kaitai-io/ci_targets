...
var Integers = (function() {
  ...
  Integers.prototype._read = function() {
    ...
    if (!((KaitaiStream.byteArrayCompare(this.magicUint, new Uint8Array([80, 65, 67, 75, 45, 85, 45, 68, 69, 70])) == 0))) {
      throw new KaitaiStream.ValidationNotEqualError(new Uint8Array([80, 65, 67, 75, 45, 85, 45, 68, 69, 70]), this.magicUint, this._io, "/seq/3");
    }
    ...
    if (!((KaitaiStream.byteArrayCompare(this.magicSint, new Uint8Array([80, 65, 67, 75, 45, 83, 45, 68, 69, 70])) == 0))) {
      throw new KaitaiStream.ValidationNotEqualError(new Uint8Array([80, 65, 67, 75, 45, 83, 45, 68, 69, 70]), this.magicSint, this._io, "/seq/7");
    }
    ...
    if (!((KaitaiStream.byteArrayCompare(this.magicUintLe, new Uint8Array([80, 65, 67, 75, 45, 85, 45, 76, 69])) == 0))) {
      throw new KaitaiStream.ValidationNotEqualError(new Uint8Array([80, 65, 67, 75, 45, 85, 45, 76, 69]), this.magicUintLe, this._io, "/seq/11");
    }
    ...
    if (!((KaitaiStream.byteArrayCompare(this.magicSintLe, new Uint8Array([80, 65, 67, 75, 45, 83, 45, 76, 69])) == 0))) {
      throw new KaitaiStream.ValidationNotEqualError(new Uint8Array([80, 65, 67, 75, 45, 83, 45, 76, 69]), this.magicSintLe, this._io, "/seq/15");
    }
    ...
    if (!((KaitaiStream.byteArrayCompare(this.magicUintBe, new Uint8Array([80, 65, 67, 75, 45, 85, 45, 66, 69])) == 0))) {
      throw new KaitaiStream.ValidationNotEqualError(new Uint8Array([80, 65, 67, 75, 45, 85, 45, 66, 69]), this.magicUintBe, this._io, "/seq/19");
    }
    ...
    if (!((KaitaiStream.byteArrayCompare(this.magicSintBe, new Uint8Array([80, 65, 67, 75, 45, 83, 45, 66, 69])) == 0))) {
      throw new KaitaiStream.ValidationNotEqualError(new Uint8Array([80, 65, 67, 75, 45, 83, 45, 66, 69]), this.magicSintBe, this._io, "/seq/23");
    }

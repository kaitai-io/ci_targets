...
(function (root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    factory(root.TermStrz4 || (root.TermStrz4 = {}), root.KaitaiStream);
  }
})(typeof self !== 'undefined' ? self : this, function (TermStrz4_, KaitaiStream) {
var TermStrz4 = (function() {
  function TermStrz4(_io, _parent, _root) {
    this._io = _io;
  ...
  TermStrz4.prototype._read = function() {
  ...
  var S1Type = TermStrz4.S1Type = (function() {
    ...
    S1Type.prototype._read = function() {
      this.value = KaitaiStream.bytesToStr(this._io.readBytesTerm(124, false, true, false), "UTF-8");
    }

    return S1Type;
  })();

  var S2Type = TermStrz4.S2Type = (function() {
    ...
    S2Type.prototype._read = function() {
      this.value = KaitaiStream.bytesToStr(this._io.readBytesTerm(124, false, false, false), "UTF-8");
    }

    return S2Type;
  })();

  var S3Type = TermStrz4.S3Type = (function() {
    ...
    S3Type.prototype._read = function() {
      this.value = KaitaiStream.bytesToStr(this._io.readBytesTerm(64, true, true, false), "UTF-8");
    }
...
TermStrz4_.TermStrz4 = TermStrz4;
});

...
public class ProcessStructPadTerm extends KaitaiStruct.ReadWrite {
    ...
    public static class BytesWrapper extends KaitaiStruct.ReadWrite {
        ...
        public void set_root(ProcessStructPadTerm _v) { _root = _v; }
        public ProcessStructPadTerm _parent() { return _parent; }
        public void set_parent(ProcessStructPadTerm _v) { _parent = _v; }
    }
    ...
    public void set_raw__raw_StrPad(byte[] _v) { _raw__raw_strPad = _v; }
    ...
    public void set_raw__raw_StrTerm(byte[] _v) { _raw__raw_strTerm = _v; }
    ...
    public void set_raw__raw_StrTermAndPad(byte[] _v) { _raw__raw_strTermAndPad = _v; }
    ...
    public void set_raw__raw_StrTermInclude(byte[] _v) { _raw__raw_strTermInclude = _v; }
}

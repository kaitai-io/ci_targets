            ...
            _io__raw_strPad.setWriteBackHandler(new KaitaiStream.WriteBackHandler(_pos2) {
                ...
                protected void write(KaitaiStream parent) {
                    ...
                    if (_this._raw__raw_strPad.length > 20)
                        throw new ConsistencyError("raw(str_pad)", 20, _this._raw__raw_strPad.length);
                    if ( ((_this._raw__raw_strPad.length != 0) && ((_this._raw__raw_strPad[((Number) (_this._raw__raw_strPad.length - 1)).intValue()] & 0xff) == 64)) )
                        throw new ConsistencyError("raw(str_pad)", 64, (_this._raw__raw_strPad[((Number) (_this._raw__raw_strPad.length - 1)).intValue()] & 0xff));
            ...
            _io__raw_strTerm.setWriteBackHandler(new KaitaiStream.WriteBackHandler(_pos2) {
                ...
                protected void write(KaitaiStream parent) {
                    ...
                    if (_this._raw__raw_strTerm.length > 20)
                        throw new ConsistencyError("raw(str_term)", 20, _this._raw__raw_strTerm.length);
                    if (KaitaiStream.byteArrayIndexOf(_this._raw__raw_strTerm, ((byte) 64)) != -1)
                        throw new ConsistencyError("raw(str_term)", -1, KaitaiStream.byteArrayIndexOf(_this._raw__raw_strTerm, ((byte) 64)));
            ...
            _io__raw_strTermAndPad.setWriteBackHandler(new KaitaiStream.WriteBackHandler(_pos2) {
                ...
                protected void write(KaitaiStream parent) {
                    ...
                    if (_this._raw__raw_strTermAndPad.length > 20)
                        throw new ConsistencyError("raw(str_term_and_pad)", 20, _this._raw__raw_strTermAndPad.length);
                    if (KaitaiStream.byteArrayIndexOf(_this._raw__raw_strTermAndPad, ((byte) 64)) != -1)
                        throw new ConsistencyError("raw(str_term_and_pad)", -1, KaitaiStream.byteArrayIndexOf(_this._raw__raw_strTermAndPad, ((byte) 64)));
                    if (_this._raw__raw_strTermAndPad.length == 20) {
                        if ( ((_this._raw__raw_strTermAndPad.length != 0) && ((_this._raw__raw_strTermAndPad[((Number) (_this._raw__raw_strTermAndPad.length - 1)).intValue()] & 0xff) == 43)) )
                            throw new ConsistencyError("raw(str_term_and_pad)", 43, (_this._raw__raw_strTermAndPad[((Number) (_this._raw__raw_strTermAndPad.length - 1)).intValue()] & 0xff));
                    }
            ...
            _io__raw_strTermInclude.setWriteBackHandler(new KaitaiStream.WriteBackHandler(_pos2) {
                ...
                protected void write(KaitaiStream parent) {
                    ...
                    if (_this._raw__raw_strTermInclude.length > 20)
                        throw new ConsistencyError("raw(str_term_include)", 20, _this._raw__raw_strTermInclude.length);
                    if (_this._raw__raw_strTermInclude.length < 20) {
                        if (_this._raw__raw_strTermInclude.length == 0)
                            throw new ConsistencyError("raw(str_term_include)", 0, _this._raw__raw_strTermInclude.length);
                        if (KaitaiStream.byteArrayIndexOf(_this._raw__raw_strTermInclude, ((byte) 64)) != _this._raw__raw_strTermInclude.length - 1)
                            throw new ConsistencyError("raw(str_term_include)", _this._raw__raw_strTermInclude.length - 1, KaitaiStream.byteArrayIndexOf(_this._raw__raw_strTermInclude, ((byte) 64)));
                    }
                    if (_this._raw__raw_strTermInclude.length == 20) {

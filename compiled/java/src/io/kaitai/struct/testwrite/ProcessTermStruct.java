...
public class ProcessTermStruct extends KaitaiStruct.ReadWrite {
    public static ProcessTermStruct fromFile(String fileName) throws IOException {
        return new ProcessTermStruct(new ByteBufferKaitaiStream(fileName));
    }
    public ProcessTermStruct() {
        this(null, null, null);
    }

    public ProcessTermStruct(KaitaiStream _io) {
        this(_io, null, null);
    }

    public ProcessTermStruct(KaitaiStream _io, KaitaiStruct.ReadWrite _parent) {
        this(_io, _parent, null);
    }

    public ProcessTermStruct(KaitaiStream _io, KaitaiStruct.ReadWrite _parent, ProcessTermStruct _root) {
        super(_io);
        this._parent = _parent;
        this._root = _root == null ? this : _root;
    }
    public void _read() {
        this._raw__raw_s1 = this._io.readBytesTerm((byte) 124, false, true, true);
        MyCustomFx _process__raw__raw_s1 = new MyCustomFx(32, false, new byte[] { 0 });
        this._raw_s1 = _process__raw__raw_s1.decode(this._raw__raw_s1);
        this.s1_OuterSize = this._raw__raw_s1.length;
        ...
        this.s1._read();
        this._raw__raw_s2 = this._io.readBytesTerm((byte) 124, false, false, true);
        MyCustomFx _process__raw__raw_s2 = new MyCustomFx(32, false, new byte[] { 0 });
        this._raw_s2 = _process__raw__raw_s2.decode(this._raw__raw_s2);
        this.s2_OuterSize = this._raw__raw_s2.length;
        ...
        this.s2._read();
        this._raw__raw_s3 = this._io.readBytesTerm((byte) 64, true, true, true);
        MyCustomFx _process__raw__raw_s3 = new MyCustomFx(32, false, new byte[] { 0 });
        this._raw_s3 = _process__raw__raw_s3.decode(this._raw__raw_s3);
        this.s3_OuterSize = this._raw__raw_s3.length;
    ...
    public void _write_Seq() {
        ...
        this._io.addChildStream(_io__raw_s1);
        {
            ...
            final MyCustomFx _process__raw_s1 = new MyCustomFx(32, false, new byte[] { 0 });
            final ProcessTermStruct _this = this;
        ...
        this._io.addChildStream(_io__raw_s2);
        {
            ...
            final MyCustomFx _process__raw_s2 = new MyCustomFx(32, false, new byte[] { 0 });
            final ProcessTermStruct _this = this;
        ...
        this._io.addChildStream(_io__raw_s3);
        {
            ...
            final MyCustomFx _process__raw_s3 = new MyCustomFx(32, false, new byte[] { 0 });
            final ProcessTermStruct _this = this;
    ...
    public static class BytesWrapper extends KaitaiStruct.ReadWrite {
        ...
        public BytesWrapper(KaitaiStream _io, ProcessTermStruct _parent) {
            this(_io, _parent, null);
        }

        public BytesWrapper(KaitaiStream _io, ProcessTermStruct _parent, ProcessTermStruct _root) {
            super(_io);
            this._parent = _parent;
            this._root = _root;
        }
        ...
        public void set_root(ProcessTermStruct _v) { _root = _v; }
        public ProcessTermStruct _parent() { return _parent; }
        public void set_parent(ProcessTermStruct _v) { _parent = _v; }
    }
    ...
    public byte[] _raw__raw_s1() { return _raw__raw_s1; }
    public void set_raw__raw_S1(byte[] _v) { _raw__raw_s1 = _v; }
    ...
    public void set_raw__raw_S2(byte[] _v) { _raw__raw_s2 = _v; }
    ...
    public void set_raw__raw_S3(byte[] _v) { _raw__raw_s3 = _v; }
}

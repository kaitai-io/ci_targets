...
public class BytesEosPadTerm extends KaitaiStruct.ReadWrite {
    ...
    public BytesEosPadTerm(KaitaiStream _io, KaitaiStruct.ReadWrite _parent) {
        this(_io, _parent, null);
    }

    public BytesEosPadTerm(KaitaiStream _io, KaitaiStruct.ReadWrite _parent, BytesEosPadTerm _root) {
        super(_io);
    ...
    public void _write_Seq() {
        ...
        this._io.addChildStream(_io__raw_strPad);
        {
            ...
            final BytesEosPadTerm _this = this;
    ...
    public static class StrPadType extends KaitaiStruct.ReadWrite {
        ...
        public void set_root(BytesEosPadTerm _v) { _dirty = true; _root = _v; }
        public BytesEosPadTerm _parent() { return _parent; }
        public void set_parent(BytesEosPadTerm _v) { _dirty = true; _parent = _v; }
    }

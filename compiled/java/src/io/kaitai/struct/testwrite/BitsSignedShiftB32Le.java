...
public class BitsSignedShiftB32Le extends KaitaiStruct.ReadWrite {
    ...
    public BitsSignedShiftB32Le(KaitaiStream _io, KaitaiStruct.ReadWrite _parent) {
        this(_io, _parent, null);
    }

    public BitsSignedShiftB32Le(KaitaiStream _io, KaitaiStruct.ReadWrite _parent, BitsSignedShiftB32Le _root) {
        super(_io);
    ...
    public void _write_Seq() {
        _assertNotDirty();
        this._io.writeBitsIntLe(31, this.a);
    ...
    public void set_root(BitsSignedShiftB32Le _v) { _dirty = true; _root = _v; }

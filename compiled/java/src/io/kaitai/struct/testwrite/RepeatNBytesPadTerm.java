...
public class RepeatNBytesPadTerm extends KaitaiStruct.ReadWrite {
    public static RepeatNBytesPadTerm fromFile(String fileName) throws IOException {
        return new RepeatNBytesPadTerm(new ByteBufferKaitaiStream(fileName));
    }
    public RepeatNBytesPadTerm() {
        this(null, null, null);
    }

    public RepeatNBytesPadTerm(KaitaiStream _io) {
        this(_io, null, null);
    }

    public RepeatNBytesPadTerm(KaitaiStream _io, KaitaiStruct.ReadWrite _parent) {
        this(_io, _parent, null);
    }

    public RepeatNBytesPadTerm(KaitaiStream _io, KaitaiStruct.ReadWrite _parent, RepeatNBytesPadTerm _root) {
        super(_io);
    ...
    public RepeatNBytesPadTerm _root() { return _root; }
    public void set_root(RepeatNBytesPadTerm _v) { _dirty = true; _root = _v; }
    public KaitaiStruct.ReadWrite _parent() { return _parent; }
    public void set_parent(KaitaiStruct.ReadWrite _v) { _dirty = true; _parent = _v; }
    private List<byte[]> records;
    private RepeatNBytesPadTerm _root;

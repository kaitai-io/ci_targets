...
public class RepeatEosBitsB4 extends KaitaiStruct.ReadWrite {
    ...
    public RepeatEosBitsB4(KaitaiStream _io, KaitaiStruct.ReadWrite _parent) {
        this(_io, _parent, null);
    }

    public RepeatEosBitsB4(KaitaiStream _io, KaitaiStruct.ReadWrite _parent, RepeatEosBitsB4 _root) {
        super(_io);
    ...
    public void set_root(RepeatEosBitsB4 _v) { _dirty = true; _root = _v; }

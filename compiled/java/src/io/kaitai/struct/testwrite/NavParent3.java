...
public class NavParent3 extends KaitaiStruct.ReadWrite {
    ...
    public static class Tag extends KaitaiStruct.ReadWrite {
        ...
        public static class TagChar extends KaitaiStruct.ReadWrite {
            ...
            public void set_root(NavParent3 _v) { _root = _v; }
            public NavParent3.Tag _parent() { return _parent; }
            public void set_parent(NavParent3.Tag _v) { _parent = _v; }
        }
        ...
        public void set_parent(NavParent3 _v) { _parent = _v; }
    }
    private List<Tag> tags;
    private boolean _writeTags = false;
    private boolean _toWriteTags = true;
    ...
    public void setTags_ToWrite(boolean _v) { _toWriteTags = _v; }

    public void _writeTags() {
        _writeTags = false;
        long _pos = this._io.pos();
        this._io.seek(ofsTags());
        for (int i = 0; i < this.tags.size(); i++) {

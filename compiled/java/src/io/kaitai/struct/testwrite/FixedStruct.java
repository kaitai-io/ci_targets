...
public class FixedStruct extends KaitaiStruct.ReadWrite {
    ...
    public FixedStruct(KaitaiStream _io, KaitaiStruct.ReadWrite _parent) {
        this(_io, _parent, null);
    }

    public FixedStruct(KaitaiStream _io, KaitaiStruct.ReadWrite _parent, FixedStruct _root) {
        super(_io);
    ...
    public static class Header extends KaitaiStruct.ReadWrite {
        ...
        public void _read() {
            ...
            if (!(Arrays.equals(this.magic1, new byte[] { 80, 65, 67, 75, 45, 49 }))) {
                throw new KaitaiStream.ValidationNotEqualError(new byte[] { 80, 65, 67, 75, 45, 49 }, this.magic1, this._io, "/types/header/seq/0");
            }
            ...
            if (!(Arrays.equals(this.magicUint, new byte[] { 80, 65, 67, 75, 45, 85, 45, 68, 69, 70 }))) {
                throw new KaitaiStream.ValidationNotEqualError(new byte[] { 80, 65, 67, 75, 45, 85, 45, 68, 69, 70 }, this.magicUint, this._io, "/types/header/seq/3");
            }
            ...
            if (!(Arrays.equals(this.magicSint, new byte[] { 80, 65, 67, 75, 45, 83, 45, 68, 69, 70 }))) {
                throw new KaitaiStream.ValidationNotEqualError(new byte[] { 80, 65, 67, 75, 45, 83, 45, 68, 69, 70 }, this.magicSint, this._io, "/types/header/seq/7");
            }
            ...
            if (!(Arrays.equals(this.magicUintLe, new byte[] { 80, 65, 67, 75, 45, 85, 45, 76, 69 }))) {
                throw new KaitaiStream.ValidationNotEqualError(new byte[] { 80, 65, 67, 75, 45, 85, 45, 76, 69 }, this.magicUintLe, this._io, "/types/header/seq/11");
            }
            ...
            if (!(Arrays.equals(this.magicSintLe, new byte[] { 80, 65, 67, 75, 45, 83, 45, 76, 69 }))) {
                throw new KaitaiStream.ValidationNotEqualError(new byte[] { 80, 65, 67, 75, 45, 83, 45, 76, 69 }, this.magicSintLe, this._io, "/types/header/seq/15");
            }
            ...
            if (!(Arrays.equals(this.magicUintBe, new byte[] { 80, 65, 67, 75, 45, 85, 45, 66, 69 }))) {
                throw new KaitaiStream.ValidationNotEqualError(new byte[] { 80, 65, 67, 75, 45, 85, 45, 66, 69 }, this.magicUintBe, this._io, "/types/header/seq/19");
            }
            ...
            if (!(Arrays.equals(this.magicSintBe, new byte[] { 80, 65, 67, 75, 45, 83, 45, 66, 69 }))) {
                throw new KaitaiStream.ValidationNotEqualError(new byte[] { 80, 65, 67, 75, 45, 83, 45, 66, 69 }, this.magicSintBe, this._io, "/types/header/seq/23");
            }
        ...
        public void set_root(FixedStruct _v) { _root = _v; }
        public FixedStruct _parent() { return _parent; }
        public void set_parent(FixedStruct _v) { _parent = _v; }
    }
    private Header hdr;
    private boolean _writeHdr = false;
    private boolean _toWriteHdr = true;
    public Header hdr() {
        if (_writeHdr)
            _writeHdr();
        if (this.hdr != null)
    ...
    public void setHdr(Header _v) { hdr = _v; }
    public void setHdr_ToWrite(boolean _v) { _toWriteHdr = _v; }

    public void _writeHdr() {
        _writeHdr = false;
        long _pos = this._io.pos();
        this._io.seek(0);

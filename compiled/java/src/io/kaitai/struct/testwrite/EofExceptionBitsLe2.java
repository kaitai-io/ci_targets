...
public class EofExceptionBitsLe2 extends KaitaiStruct.ReadWrite {
    ...
    public EofExceptionBitsLe2(KaitaiStream _io, KaitaiStruct.ReadWrite _parent) {
        this(_io, _parent, null);
    }

    public EofExceptionBitsLe2(KaitaiStream _io, KaitaiStruct.ReadWrite _parent, EofExceptionBitsLe2 _root) {
        super(_io);
    ...
    public void _write_Seq() {
        _assertNotDirty();
        this._io.writeBitsIntLe(8, this.preBits);
        this._io.writeBitsIntLe(17, this.failBits);
    }
    ...
    public void set_root(EofExceptionBitsLe2 _v) { _dirty = true; _root = _v; }

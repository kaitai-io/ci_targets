...
public class SwitchCast extends KaitaiStruct.ReadWrite {
    ...
    public static class Intval extends KaitaiStruct.ReadWrite {
        ...
        public void set_root(SwitchCast _v) { _root = _v; }
        public SwitchCast.Opcode _parent() { return _parent; }
        public void set_parent(SwitchCast.Opcode _v) { _parent = _v; }
    }
    public static class Opcode extends KaitaiStruct.ReadWrite {
        ...
        public void _check() {
            ...
            case 73: {
                if (!Objects.equals(((SwitchCast.Intval) (this.body))._root(), _root()))
                    throw new ConsistencyError("body", ((SwitchCast.Intval) (this.body))._root(), _root());
                if (!Objects.equals(((SwitchCast.Intval) (this.body))._parent(), this))
                    throw new ConsistencyError("body", ((SwitchCast.Intval) (this.body))._parent(), this);
                break;
            }
            case 83: {
                if (!Objects.equals(((SwitchCast.Strval) (this.body))._root(), _root()))
                    throw new ConsistencyError("body", ((SwitchCast.Strval) (this.body))._root(), _root());
                if (!Objects.equals(((SwitchCast.Strval) (this.body))._parent(), this))
                    throw new ConsistencyError("body", ((SwitchCast.Strval) (this.body))._parent(), this);
                break;
            }
            }
        }
        ...
        public void set_parent(SwitchCast _v) { _parent = _v; }
    }

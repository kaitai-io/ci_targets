...
public class SwitchManualStrElse extends KaitaiStruct.ReadWrite {
    ...
    public static class Opcode extends KaitaiStruct.ReadWrite {
        ...
        public void _check() {
            ...
            case "I": {
                if (!Objects.equals(((SwitchManualStrElse.Opcode.Intval) (this.body))._root(), _root()))
                    throw new ConsistencyError("body", _root(), ((SwitchManualStrElse.Opcode.Intval) (this.body))._root());
                if (!Objects.equals(((SwitchManualStrElse.Opcode.Intval) (this.body))._parent(), this))
                    throw new ConsistencyError("body", this, ((SwitchManualStrElse.Opcode.Intval) (this.body))._parent());
                break;
            }
            case "S": {
                if (!Objects.equals(((SwitchManualStrElse.Opcode.Strval) (this.body))._root(), _root()))
                    throw new ConsistencyError("body", _root(), ((SwitchManualStrElse.Opcode.Strval) (this.body))._root());
                if (!Objects.equals(((SwitchManualStrElse.Opcode.Strval) (this.body))._parent(), this))
                    throw new ConsistencyError("body", this, ((SwitchManualStrElse.Opcode.Strval) (this.body))._parent());
                break;
            }
            default: {
                if (!Objects.equals(((SwitchManualStrElse.Opcode.Noneval) (this.body))._root(), _root()))
                    throw new ConsistencyError("body", _root(), ((SwitchManualStrElse.Opcode.Noneval) (this.body))._root());
                if (!Objects.equals(((SwitchManualStrElse.Opcode.Noneval) (this.body))._parent(), this))
                    throw new ConsistencyError("body", this, ((SwitchManualStrElse.Opcode.Noneval) (this.body))._parent());
                break;
            }
            }
            _dirty = false;
        ...
        public static class Intval extends KaitaiStruct.ReadWrite {
            ...
            public void set_root(SwitchManualStrElse _v) { _dirty = true; _root = _v; }
            public SwitchManualStrElse.Opcode _parent() { return _parent; }
            public void set_parent(SwitchManualStrElse.Opcode _v) { _dirty = true; _parent = _v; }
        }
        ...
        public void set_parent(SwitchManualStrElse _v) { _dirty = true; _parent = _v; }
    }

...
public class NestedTypesImport extends KaitaiStruct.ReadWrite {
    ...
    public void setACc(NestedTypes3.SubtypeA.SubtypeCc _v) { aCc = _v; }
    public NestedTypes3.SubtypeA.SubtypeC.SubtypeD aCD() { return aCD; }
    public void setACD(NestedTypes3.SubtypeA.SubtypeC.SubtypeD _v) { aCD = _v; }
    public NestedTypes3.SubtypeB b() { return b; }
    public void setB(NestedTypes3.SubtypeB _v) { b = _v; }
    public NestedTypesImport _root() { return _root; }
    public void set_root(NestedTypesImport _v) { _root = _v; }

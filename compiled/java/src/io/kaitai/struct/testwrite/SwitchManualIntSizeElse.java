...
public class SwitchManualIntSizeElse extends KaitaiStruct.ReadWrite {
    ...
    public static class Chunk extends KaitaiStruct.ReadWrite {
                    ...
                    _io__raw_body.setWriteBackHandler(new KaitaiStream.WriteBackHandler(_pos2) {
                        ...
                        protected void write(KaitaiStream parent) {
                            ...
                            if (((byte[]) (_this._raw_body)).length != size())
                                throw new ConsistencyError("raw(body)", ((byte[]) (_this._raw_body)).length, size());
        ...
        public void _check() {
            ...
            case 17: {
                if (!Objects.equals(((SwitchManualIntSizeElse.Chunk.ChunkMeta) (this.body))._root(), _root()))
                    throw new ConsistencyError("body", ((SwitchManualIntSizeElse.Chunk.ChunkMeta) (this.body))._root(), _root());
                if (!Objects.equals(((SwitchManualIntSizeElse.Chunk.ChunkMeta) (this.body))._parent(), this))
                    throw new ConsistencyError("body", ((SwitchManualIntSizeElse.Chunk.ChunkMeta) (this.body))._parent(), this);
                break;
            }
            case 34: {
                if (!Objects.equals(((SwitchManualIntSizeElse.Chunk.ChunkDir) (this.body))._root(), _root()))
                    throw new ConsistencyError("body", ((SwitchManualIntSizeElse.Chunk.ChunkDir) (this.body))._root(), _root());
                if (!Objects.equals(((SwitchManualIntSizeElse.Chunk.ChunkDir) (this.body))._parent(), this))
                    throw new ConsistencyError("body", ((SwitchManualIntSizeElse.Chunk.ChunkDir) (this.body))._parent(), this);
                break;
            }
            default: {
                if (!Objects.equals(((SwitchManualIntSizeElse.Chunk.Dummy) (this.body))._root(), _root()))
                    throw new ConsistencyError("body", ((SwitchManualIntSizeElse.Chunk.Dummy) (this.body))._root(), _root());
                if (!Objects.equals(((SwitchManualIntSizeElse.Chunk.Dummy) (this.body))._parent(), this))
                    throw new ConsistencyError("body", ((SwitchManualIntSizeElse.Chunk.Dummy) (this.body))._parent(), this);
                break;
            }
            }
        }
        public static class ChunkDir extends KaitaiStruct.ReadWrite {
            ...
            public void setEntries(List<String> _v) { entries = _v; }
            public SwitchManualIntSizeElse _root() { return _root; }
            public void set_root(SwitchManualIntSizeElse _v) { _root = _v; }
            public SwitchManualIntSizeElse.Chunk _parent() { return _parent; }
            public void set_parent(SwitchManualIntSizeElse.Chunk _v) { _parent = _v; }
        }
        public static class ChunkMeta extends KaitaiStruct.ReadWrite {
            ...
            public void setTitle(String _v) { title = _v; }
            public String author() { return author; }
            public void setAuthor(String _v) { author = _v; }
            public SwitchManualIntSizeElse _root() { return _root; }
            public void set_root(SwitchManualIntSizeElse _v) { _root = _v; }
            public SwitchManualIntSizeElse.Chunk _parent() { return _parent; }
            public void set_parent(SwitchManualIntSizeElse.Chunk _v) { _parent = _v; }
        ...
        public static class Dummy extends KaitaiStruct.ReadWrite {
            ...
            public void _write_Seq() {
                ...
                if (!(this._io.isEof()))
                    throw new ConsistencyError("rest", this._io.size() - this._io.pos(), 0);
            }
            ...
            public void setRest(byte[] _v) { rest = _v; }
            public SwitchManualIntSizeElse _root() { return _root; }
            public void set_root(SwitchManualIntSizeElse _v) { _root = _v; }
            public SwitchManualIntSizeElse.Chunk _parent() { return _parent; }
            public void set_parent(SwitchManualIntSizeElse.Chunk _v) { _parent = _v; }
        ...
        public void set_parent(SwitchManualIntSizeElse _v) { _parent = _v; }
        public byte[] _raw_body() { return _raw_body; }
        public void set_raw_Body(byte[] _v) { _raw_body = _v; }
    }

...
public class ParamsDefEnumImported extends KaitaiStruct.ReadWrite {
    public ParamsDefEnumImported(Enum0.IAnimal pet1Param, EnumDeep.Container1.Container2.IAnimal pet2Param) {
    ...
    public ParamsDefEnumImported(KaitaiStream _io, KaitaiStruct.ReadWrite _parent, Enum0.IAnimal pet1Param, EnumDeep.Container1.Container2.IAnimal pet2Param) {
        this(_io, _parent, null, pet1Param, pet2Param);
    }

    public ParamsDefEnumImported(KaitaiStream _io, KaitaiStruct.ReadWrite _parent, ParamsDefEnumImported _root, Enum0.IAnimal pet1Param, EnumDeep.Container1.Container2.IAnimal pet2Param) {
        super(_io);
    ...
    public void setPet1Param(Enum0.IAnimal _v) { _dirty = true; pet1Param = _v; }
    public EnumDeep.Container1.Container2.IAnimal pet2Param() { return pet2Param; }
    public void setPet2Param(EnumDeep.Container1.Container2.IAnimal _v) { _dirty = true; pet2Param = _v; }

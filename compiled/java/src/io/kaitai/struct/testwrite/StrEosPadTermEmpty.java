...
public class StrEosPadTermEmpty extends KaitaiStruct.ReadWrite {
    ...
    public StrEosPadTermEmpty(KaitaiStream _io, KaitaiStruct.ReadWrite _parent) {
        this(_io, _parent, null);
    }

    public StrEosPadTermEmpty(KaitaiStream _io, KaitaiStruct.ReadWrite _parent, StrEosPadTermEmpty _root) {
        super(_io);
    ...
    public void _write_Seq() {
        ...
        this._io.addChildStream(_io__raw_strPad);
        {
            ...
            final StrEosPadTermEmpty _this = this;

...
public class TermStruct extends KaitaiStruct.ReadWrite {
    public static TermStruct fromFile(String fileName) throws IOException {
        return new TermStruct(new ByteBufferKaitaiStream(fileName));
    }
    public TermStruct() {
        this(null, null, null);
    }

    public TermStruct(KaitaiStream _io) {
        this(_io, null, null);
    }

    public TermStruct(KaitaiStream _io, KaitaiStruct.ReadWrite _parent) {
        this(_io, _parent, null);
    }

    public TermStruct(KaitaiStream _io, KaitaiStruct.ReadWrite _parent, TermStruct _root) {
        super(_io);
    ...
    public void _read() {
        ...
        this.s1._read();
        this._raw_s2 = this._io.readBytesTerm((byte) 124, false, false, true);
        ...
        this.s2._read();
        this._raw_s3 = this._io.readBytesTerm((byte) 64, true, true, true);
        ...
        this._io.addChildStream(_io__raw_s2);
        {
            ...
            _io__raw_s2.setWriteBackHandler(new KaitaiStream.WriteBackHandler(_pos2) {
                ...
                protected void write(KaitaiStream parent) {
                    ...
                    if (KaitaiStream.byteArrayIndexOf(_this._raw_s2, ((byte) 124)) != -1)
                        throw new ConsistencyError("raw(s2)", KaitaiStream.byteArrayIndexOf(_this._raw_s2, ((byte) 124)), -1);
        ...
        this._io.addChildStream(_io__raw_s3);
        {
            ...
            _io__raw_s3.setWriteBackHandler(new KaitaiStream.WriteBackHandler(_pos2) {
                ...
                protected void write(KaitaiStream parent) {
                    ...
                    if (_this._raw_s3.length == 0)
                        throw new ConsistencyError("raw(s3)", _this._raw_s3.length, 0);
                    if (KaitaiStream.byteArrayIndexOf(_this._raw_s3, ((byte) 64)) != _this._raw_s3.length - 1)
                        throw new ConsistencyError("raw(s3)", KaitaiStream.byteArrayIndexOf(_this._raw_s3, ((byte) 64)), _this._raw_s3.length - 1);
    ...
    public static class BytesWrapper extends KaitaiStruct.ReadWrite {
        ...
        public BytesWrapper(KaitaiStream _io, TermStruct _parent) {
            this(_io, _parent, null);
        }

        public BytesWrapper(KaitaiStream _io, TermStruct _parent, TermStruct _root) {
            super(_io);
            this._parent = _parent;
            this._root = _root;
        }
        ...
        public void set_root(TermStruct _v) { _root = _v; }
        public TermStruct _parent() { return _parent; }
        public void set_parent(TermStruct _v) { _parent = _v; }
    }

...
public class TermStruct3 extends KaitaiStruct.ReadWrite {
    public static TermStruct3 fromFile(String fileName) throws IOException {
        return new TermStruct3(new ByteBufferKaitaiStream(fileName));
    }
    public TermStruct3() {
        this(null, null, null);
    }

    public TermStruct3(KaitaiStream _io) {
        this(_io, null, null);
    }

    public TermStruct3(KaitaiStream _io, KaitaiStruct.ReadWrite _parent) {
        this(_io, _parent, null);
    }

    public TermStruct3(KaitaiStream _io, KaitaiStruct.ReadWrite _parent, TermStruct3 _root) {
        super(_io);
        this._parent = _parent;
        this._root = _root == null ? this : _root;
    }
    public void _read() {
        this._raw_s1 = this._io.readBytesTerm((byte) 124, false, false, true);
        ...
        this.s1._read();
        this._raw_s2 = this._io.readBytesTerm((byte) 64, false, false, true);
        ...
        this.s2._read();
        this._raw_s3 = this._io.readBytesTerm((byte) 64, false, true, true);
            ...
            _io__raw_s1.setWriteBackHandler(new KaitaiStream.WriteBackHandler(_pos2) {
                ...
                protected void write(KaitaiStream parent) {
                    ...
                    if (KaitaiStream.byteArrayIndexOf(_this._raw_s1, ((byte) 124)) != -1)
                        throw new ConsistencyError("raw(s1)", -1, KaitaiStream.byteArrayIndexOf(_this._raw_s1, ((byte) 124)));
            ...
            _io__raw_s2.setWriteBackHandler(new KaitaiStream.WriteBackHandler(_pos2) {
                ...
                protected void write(KaitaiStream parent) {
                    ...
                    if (KaitaiStream.byteArrayIndexOf(_this._raw_s2, ((byte) 64)) != -1)
                        throw new ConsistencyError("raw(s2)", -1, KaitaiStream.byteArrayIndexOf(_this._raw_s2, ((byte) 64)));
            ...
            _io__raw_s3.setWriteBackHandler(new KaitaiStream.WriteBackHandler(_pos2) {
                ...
                protected void write(KaitaiStream parent) {
                    ...
                    if (KaitaiStream.byteArrayIndexOf(_this._raw_s3, ((byte) 64)) != -1)
                        throw new ConsistencyError("raw(s3)", -1, KaitaiStream.byteArrayIndexOf(_this._raw_s3, ((byte) 64)));
    ...
    public static class BytesWrapper extends KaitaiStruct.ReadWrite {
        ...
        public BytesWrapper(KaitaiStream _io, TermStruct3 _parent) {
            this(_io, _parent, null);
        }

        public BytesWrapper(KaitaiStream _io, TermStruct3 _parent, TermStruct3 _root) {
            super(_io);
            this._parent = _parent;
            this._root = _root;
        }
        ...
        public TermStruct3 _root() { return _root; }
        public void set_root(TermStruct3 _v) { _dirty = true; _root = _v; }
        public TermStruct3 _parent() { return _parent; }
        public void set_parent(TermStruct3 _v) { _dirty = true; _parent = _v; }
        private byte[] value;
        private TermStruct3 _root;
        private TermStruct3 _parent;
    }

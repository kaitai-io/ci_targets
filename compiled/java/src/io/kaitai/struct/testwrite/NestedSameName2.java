...
public class NestedSameName2 extends KaitaiStruct.ReadWrite {
    ...
    public static class DummyObj extends KaitaiStruct.ReadWrite {
        ...
        public static class FooObj extends KaitaiStruct.ReadWrite {
            ...
            public void setData2(byte[] _v) { data2 = _v; }
            public NestedSameName2 _root() { return _root; }
            public void set_root(NestedSameName2 _v) { _root = _v; }
            public NestedSameName2.DummyObj _parent() { return _parent; }
            public void set_parent(NestedSameName2.DummyObj _v) { _parent = _v; }
        }
        ...
        public void setDummySize(int _v) { dummySize = _v; }
        public FooObj foo() { return foo; }
        public void setFoo(FooObj _v) { foo = _v; }
        public NestedSameName2 _root() { return _root; }
        public void set_root(NestedSameName2 _v) { _root = _v; }
        public NestedSameName2 _parent() { return _parent; }
        public void set_parent(NestedSameName2 _v) { _parent = _v; }
    }
    public static class Main extends KaitaiStruct.ReadWrite {
        ...
        public static class FooObj extends KaitaiStruct.ReadWrite {
            ...
            public void setData1(byte[] _v) { data1 = _v; }
            public NestedSameName2 _root() { return _root; }
            public void set_root(NestedSameName2 _v) { _root = _v; }
            public NestedSameName2.Main _parent() { return _parent; }
            public void set_parent(NestedSameName2.Main _v) { _parent = _v; }
        }
        ...
        public void setMainSize(int _v) { mainSize = _v; }
        public FooObj foo() { return foo; }
        public void setFoo(FooObj _v) { foo = _v; }
        public NestedSameName2 _root() { return _root; }
        public void set_root(NestedSameName2 _v) { _root = _v; }
    ...
    public void setMainData(Main _v) { mainData = _v; }
    public DummyObj dummy() { return dummy; }
    public void setDummy(DummyObj _v) { dummy = _v; }
    public NestedSameName2 _root() { return _root; }
    public void set_root(NestedSameName2 _v) { _root = _v; }

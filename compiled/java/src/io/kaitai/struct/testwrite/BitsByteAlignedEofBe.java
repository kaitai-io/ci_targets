...
public class BitsByteAlignedEofBe extends KaitaiStruct.ReadWrite {
    ...
    public BitsByteAlignedEofBe(KaitaiStream _io, KaitaiStruct.ReadWrite _parent) {
        this(_io, _parent, null);
    }

    public BitsByteAlignedEofBe(KaitaiStream _io, KaitaiStruct.ReadWrite _parent, BitsByteAlignedEofBe _root) {
        super(_io);

...
public class ProcessRepeatUsertypeDynargCustom extends KaitaiStruct.ReadWrite {
    ...
    public static class Block extends KaitaiStruct.ReadWrite {
        ...
        public void set_root(ProcessRepeatUsertypeDynargCustom _v) { _root = _v; }
        public ProcessRepeatUsertypeDynargCustom _parent() { return _parent; }
        public void set_parent(ProcessRepeatUsertypeDynargCustom _v) { _parent = _v; }
    }
    ...
    public void setBlocks_InnerSize(List<Integer> _v) { blocks_InnerSize = _v; }

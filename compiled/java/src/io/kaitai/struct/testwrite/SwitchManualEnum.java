                ...
                if (on != null) {
                    ...
                    case INTVAL: {
                        if (!Objects.equals(((SwitchManualEnum.Opcode.Intval) (this.body))._root(), _root()))
                            throw new ConsistencyError("body", ((SwitchManualEnum.Opcode.Intval) (this.body))._root(), _root());
                        if (!Objects.equals(((SwitchManualEnum.Opcode.Intval) (this.body))._parent(), this))
                            throw new ConsistencyError("body", ((SwitchManualEnum.Opcode.Intval) (this.body))._parent(), this);
                        break;
                    }
                    case STRVAL: {
                        if (!Objects.equals(((SwitchManualEnum.Opcode.Strval) (this.body))._root(), _root()))
                            throw new ConsistencyError("body", ((SwitchManualEnum.Opcode.Strval) (this.body))._root(), _root());
                        if (!Objects.equals(((SwitchManualEnum.Opcode.Strval) (this.body))._parent(), this))
                            throw new ConsistencyError("body", ((SwitchManualEnum.Opcode.Strval) (this.body))._parent(), this);
                        break;
                    }
                    }
                }

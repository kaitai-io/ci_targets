...
public class SwitchManualEnum extends KaitaiStruct.ReadWrite {
    ...
    public SwitchManualEnum(KaitaiStream _io, KaitaiStruct.ReadWrite _parent) {
        this(_io, _parent, null);
    }

    public SwitchManualEnum(KaitaiStream _io, KaitaiStruct.ReadWrite _parent, SwitchManualEnum _root) {
        super(_io);
    ...
    public static class Opcode extends KaitaiStruct.ReadWrite {
        ...
        public void _check() {
            {
                ...
                if (on != null) {
                    switch (code()) {
                    case INTVAL: {
                        if (!Objects.equals(((SwitchManualEnum.Opcode.Intval) (this.body))._root(), _root()))
                            throw new ConsistencyError("body", _root(), ((SwitchManualEnum.Opcode.Intval) (this.body))._root());
                        if (!Objects.equals(((SwitchManualEnum.Opcode.Intval) (this.body))._parent(), this))
                            throw new ConsistencyError("body", this, ((SwitchManualEnum.Opcode.Intval) (this.body))._parent());
                        break;
                    }
                    case STRVAL: {
                        if (!Objects.equals(((SwitchManualEnum.Opcode.Strval) (this.body))._root(), _root()))
                            throw new ConsistencyError("body", _root(), ((SwitchManualEnum.Opcode.Strval) (this.body))._root());
                        if (!Objects.equals(((SwitchManualEnum.Opcode.Strval) (this.body))._parent(), this))
                            throw new ConsistencyError("body", this, ((SwitchManualEnum.Opcode.Strval) (this.body))._parent());
                        break;
                    }
                    }
                }
        ...
        public static class Intval extends KaitaiStruct.ReadWrite {
            ...
            public void set_root(SwitchManualEnum _v) { _dirty = true; _root = _v; }
            public SwitchManualEnum.Opcode _parent() { return _parent; }
            public void set_parent(SwitchManualEnum.Opcode _v) { _dirty = true; _parent = _v; }
        }
        ...
        public void set_parent(SwitchManualEnum _v) { _dirty = true; _parent = _v; }
    }

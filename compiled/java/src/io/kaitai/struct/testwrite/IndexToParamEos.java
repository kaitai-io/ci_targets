...
public class IndexToParamEos extends KaitaiStruct.ReadWrite {
    ...
    public void _write_Seq() {
        ...
        for (int i = 0; i < this.blocks.size(); i++) {
            if (this._io.isEof())
                throw new ConsistencyError("blocks", this._io.size() - this._io.pos(), 0);
    ...
    public static class Block extends KaitaiStruct.ReadWrite {
        ...
        public void set_root(IndexToParamEos _v) { _root = _v; }
        public IndexToParamEos _parent() { return _parent; }
        public void set_parent(IndexToParamEos _v) { _parent = _v; }
    }
    private long qty;

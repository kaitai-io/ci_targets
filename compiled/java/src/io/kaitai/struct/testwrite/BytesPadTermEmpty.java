...
public class BytesPadTermEmpty extends KaitaiStruct.ReadWrite {
    ...
    public BytesPadTermEmpty(KaitaiStream _io, KaitaiStruct.ReadWrite _parent) {
        this(_io, _parent, null);
    }

    public BytesPadTermEmpty(KaitaiStream _io, KaitaiStruct.ReadWrite _parent, BytesPadTermEmpty _root) {
        super(_io);
    ...
    public void _check() {
        ...
        if (this.strTermInclude.length < 20) {
            if (this.strTermInclude.length == 0)
                throw new ConsistencyError("str_term_include", this.strTermInclude.length, 0);
    ...
    public void set_root(BytesPadTermEmpty _v) { _root = _v; }

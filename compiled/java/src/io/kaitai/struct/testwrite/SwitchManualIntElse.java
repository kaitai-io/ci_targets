        ...
        public void _check() {
            ...
            case 73: {
                if (!Objects.equals(((SwitchManualIntElse.Opcode.Intval) (this.body))._root(), _root()))
                    throw new ConsistencyError("body", _root(), ((SwitchManualIntElse.Opcode.Intval) (this.body))._root());
                if (!Objects.equals(((SwitchManualIntElse.Opcode.Intval) (this.body))._parent(), this))
                    throw new ConsistencyError("body", this, ((SwitchManualIntElse.Opcode.Intval) (this.body))._parent());
                break;
            }
            case 83: {
                if (!Objects.equals(((SwitchManualIntElse.Opcode.Strval) (this.body))._root(), _root()))
                    throw new ConsistencyError("body", _root(), ((SwitchManualIntElse.Opcode.Strval) (this.body))._root());
                if (!Objects.equals(((SwitchManualIntElse.Opcode.Strval) (this.body))._parent(), this))
                    throw new ConsistencyError("body", this, ((SwitchManualIntElse.Opcode.Strval) (this.body))._parent());
                break;
            }
            default: {
                if (!Objects.equals(((SwitchManualIntElse.Opcode.Noneval) (this.body))._root(), _root()))
                    throw new ConsistencyError("body", _root(), ((SwitchManualIntElse.Opcode.Noneval) (this.body))._root());
                if (!Objects.equals(((SwitchManualIntElse.Opcode.Noneval) (this.body))._parent(), this))
                    throw new ConsistencyError("body", this, ((SwitchManualIntElse.Opcode.Noneval) (this.body))._parent());
                break;
            }
            }
            _dirty = false;

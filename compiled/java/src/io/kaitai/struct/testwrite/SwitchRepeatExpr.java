        ...
        for (int i = 0; i < this.body.size(); i++) {
            ...
            case 17: {
                if (!Objects.equals(((SwitchRepeatExpr.One) (this.body.get(((Number) (i)).intValue())))._root(), _root()))
                    throw new ConsistencyError("body", ((SwitchRepeatExpr.One) (this.body.get(((Number) (i)).intValue())))._root(), _root());
                if (!Objects.equals(((SwitchRepeatExpr.One) (this.body.get(((Number) (i)).intValue())))._parent(), this))
                    throw new ConsistencyError("body", ((SwitchRepeatExpr.One) (this.body.get(((Number) (i)).intValue())))._parent(), this);
                break;
            }
            case 34: {
                if (!Objects.equals(((SwitchRepeatExpr.Two) (this.body.get(((Number) (i)).intValue())))._root(), _root()))
                    throw new ConsistencyError("body", ((SwitchRepeatExpr.Two) (this.body.get(((Number) (i)).intValue())))._root(), _root());
                if (!Objects.equals(((SwitchRepeatExpr.Two) (this.body.get(((Number) (i)).intValue())))._parent(), this))
                    throw new ConsistencyError("body", ((SwitchRepeatExpr.Two) (this.body.get(((Number) (i)).intValue())))._parent(), this);
                break;
            }
            default: {

        ...
        public void _check() {
            ...
            case 73: {
                if (!Objects.equals(((CastNested.Opcode.Intval) (this.body))._root(), _root()))
                    throw new ConsistencyError("body", _root(), ((CastNested.Opcode.Intval) (this.body))._root());
                if (!Objects.equals(((CastNested.Opcode.Intval) (this.body))._parent(), this))
                    throw new ConsistencyError("body", this, ((CastNested.Opcode.Intval) (this.body))._parent());
                break;
            }
            case 83: {
                if (!Objects.equals(((CastNested.Opcode.Strval) (this.body))._root(), _root()))
                    throw new ConsistencyError("body", _root(), ((CastNested.Opcode.Strval) (this.body))._root());
                if (!Objects.equals(((CastNested.Opcode.Strval) (this.body))._parent(), this))
                    throw new ConsistencyError("body", this, ((CastNested.Opcode.Strval) (this.body))._parent());
                break;
            }
            }
            _dirty = false;

...
public class BytesPadTermZeroSize extends KaitaiStruct.ReadWrite {
    ...
    public void _check() {
        if (this.strPad.length > 0)
            throw new ConsistencyError("str_pad", this.strPad.length, 0);
        ...
        if (this.strTerm.length > 0)
            throw new ConsistencyError("str_term", this.strTerm.length, 0);
        ...
        if (this.strTermAndPad.length > 0)
            throw new ConsistencyError("str_term_and_pad", this.strTermAndPad.length, 0);
    ...
    public void set_root(BytesPadTermZeroSize _v) { _root = _v; }

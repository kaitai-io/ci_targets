...
public class ValidLong extends KaitaiStruct.ReadWrite {
    ...
    public ValidLong(KaitaiStream _io, KaitaiStruct.ReadWrite _parent) {
        this(_io, _parent, null);
    }

    public ValidLong(KaitaiStream _io, KaitaiStruct.ReadWrite _parent, ValidLong _root) {
        super(_io);
    ...
    public void set_root(ValidLong _v) { _root = _v; }

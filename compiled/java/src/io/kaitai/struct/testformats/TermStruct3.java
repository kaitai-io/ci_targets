...
public class TermStruct3 extends KaitaiStruct {
    ...
    public TermStruct3(KaitaiStream _io, KaitaiStruct _parent) {
        this(_io, _parent, null);
    }

    public TermStruct3(KaitaiStream _io, KaitaiStruct _parent, TermStruct3 _root) {
        super(_io);

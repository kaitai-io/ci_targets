...
public class TermStruct extends KaitaiStruct {
    ...
    public TermStruct(KaitaiStream _io, KaitaiStruct _parent) {
        this(_io, _parent, null);
    }

    public TermStruct(KaitaiStream _io, KaitaiStruct _parent, TermStruct _root) {
        super(_io);

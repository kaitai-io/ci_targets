...
public class BitsUnalignedB64Le extends KaitaiStruct {
    ...
    public BitsUnalignedB64Le(KaitaiStream _io, KaitaiStruct _parent) {
        this(_io, _parent, null);
    }

    public BitsUnalignedB64Le(KaitaiStream _io, KaitaiStruct _parent, BitsUnalignedB64Le _root) {
        super(_io);

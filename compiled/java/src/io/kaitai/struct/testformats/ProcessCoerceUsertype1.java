...
public class ProcessCoerceUsertype1 extends KaitaiStruct {
    ...
    public ProcessCoerceUsertype1(KaitaiStream _io, KaitaiStruct _parent) {
        this(_io, _parent, null);
    }

    public ProcessCoerceUsertype1(KaitaiStream _io, KaitaiStruct _parent, ProcessCoerceUsertype1 _root) {
        super(_io);
    ...
    public static class Record extends KaitaiStruct {
        ...
        private void _read() {
            ...
            if (flag() == 0) {
                ...
                KaitaiStream _io__raw_bufUnproc = new KaitaiStream(_raw_bufUnproc);

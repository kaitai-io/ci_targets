...
public class EofExceptionBitsBe2 extends KaitaiStruct.ReadOnly {
    ...
    public EofExceptionBitsBe2(KaitaiStream _io, KaitaiStruct.ReadOnly _parent) {
        this(_io, _parent, null);
    }

    public EofExceptionBitsBe2(KaitaiStream _io, KaitaiStruct.ReadOnly _parent, EofExceptionBitsBe2 _root) {
        super(_io);

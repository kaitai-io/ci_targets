...
public class ProcessTermStruct extends KaitaiStruct {
    ...
    public ProcessTermStruct(KaitaiStream _io, KaitaiStruct _parent) {
        this(_io, _parent, null);
    }

    public ProcessTermStruct(KaitaiStream _io, KaitaiStruct _parent, ProcessTermStruct _root) {
        super(_io);

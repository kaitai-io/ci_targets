...
public class RepeatNBytes extends KaitaiStruct {
    ...
    public RepeatNBytes(KaitaiStream _io, KaitaiStruct _parent) {
        this(_io, _parent, null);
    }

    public RepeatNBytes(KaitaiStream _io, KaitaiStruct _parent, RepeatNBytes _root) {
        super(_io);

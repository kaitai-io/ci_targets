...
public class TermStrz3 extends KaitaiStruct {
    ...
    public TermStrz3(KaitaiStream _io, KaitaiStruct _parent) {
        this(_io, _parent, null);
    }

    public TermStrz3(KaitaiStream _io, KaitaiStruct _parent, TermStrz3 _root) {
        super(_io);

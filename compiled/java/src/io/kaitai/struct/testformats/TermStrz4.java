...
public class TermStrz4 extends KaitaiStruct {
    ...
    public TermStrz4(KaitaiStream _io, KaitaiStruct _parent) {
        this(_io, _parent, null);
    }

    public TermStrz4(KaitaiStream _io, KaitaiStruct _parent, TermStrz4 _root) {
        super(_io);

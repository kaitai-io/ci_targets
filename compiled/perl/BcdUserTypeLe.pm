...
sub new {
    ...
    $self->{ltr} = BcdUserTypeLe::LtrObj->new($io__raw_ltr, $self, $self->{_root});
    $self->{_raw_rtl} = $self->{_io}->read_bytes(4);
    my $io__raw_rtl = IO::KaitaiStruct::Stream->new($self->{_raw_rtl});
    $self->{rtl} = BcdUserTypeLe::RtlObj->new($io__raw_rtl, $self, $self->{_root});
    ...
    $self->{leading_zero_ltr} = BcdUserTypeLe::LeadingZeroLtrObj->new($io__raw_leading_zero_ltr, $self, $self->{_root});
...
########################################################################
package BcdUserTypeLe::LeadingZeroLtrObj;

...
sub _read {
    ...
    while (!$self->{_io}->is_eof()) {
        push @{$self->{docs}}, DefaultEndianExprIsLe::Doc->new($self->{_io}, $self, $self->{_root});
    }
}
...
########################################################################
package DefaultEndianExprIsLe::Doc;
...
sub _read {
    ...
    $self->{main} = DefaultEndianExprIsLe::Doc::MainObj->new($self->{_io}, $self, $self->{_root});
}
...
########################################################################
package DefaultEndianExprIsLe::Doc::MainObj;

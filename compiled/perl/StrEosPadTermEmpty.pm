...
sub _read {
    ...
    $self->{str_pad} = StrEosPadTermEmpty::StrPadType->new($io__raw_str_pad, $self, $self->{_root});
    $self->{_raw_str_term} = $self->{_io}->read_bytes(20);
    my $io__raw_str_term = IO::KaitaiStruct::Stream->new($self->{_raw_str_term});
    $self->{str_term} = StrEosPadTermEmpty::StrTermType->new($io__raw_str_term, $self, $self->{_root});
    ...
    $self->{str_term_and_pad} = StrEosPadTermEmpty::StrTermAndPadType->new($io__raw_str_term_and_pad, $self, $self->{_root});
    ...
    $self->{str_term_include} = StrEosPadTermEmpty::StrTermIncludeType->new($io__raw_str_term_include, $self, $self->{_root});
}
...
########################################################################
package StrEosPadTermEmpty::StrPadType;
...
########################################################################
package StrEosPadTermEmpty::StrTermAndPadType;
...
########################################################################
package StrEosPadTermEmpty::StrTermIncludeType;
...
########################################################################
package StrEosPadTermEmpty::StrTermType;

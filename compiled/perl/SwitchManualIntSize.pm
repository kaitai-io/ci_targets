...
########################################################################
package SwitchManualIntSize::Chunk;
...
sub _read {
    ...
    if ($_on == 17) {
        ...
        $self->{body} = SwitchManualIntSize::Chunk::ChunkMeta->new($io__raw_body, $self, $self->{_root});
    }
    elsif ($_on == 34) {
        $self->{_raw_body} = $self->{_io}->read_bytes($self->size());
        my $io__raw_body = IO::KaitaiStruct::Stream->new($self->{_raw_body});
        $self->{body} = SwitchManualIntSize::Chunk::ChunkDir->new($io__raw_body, $self, $self->{_root});
    }
    else {
...
########################################################################
package SwitchManualIntSize::Chunk::ChunkDir;
...
########################################################################
package SwitchManualIntSize::Chunk::ChunkMeta;

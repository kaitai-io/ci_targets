...
debug_enum_name_t::debug_enum_name_t(kaitai::kstream *p_io, kaitai::kstruct* p_parent, debug_enum_name_t *p_root) : kaitai::kstruct(p_io) {
    ...
    m_test_type = new test_type_t(m__io, this, m__root);
}
...
debug_enum_name_t::test_type_t::test_type_t(kaitai::kstream *p_io, debug_enum_name_t* p_parent, debug_enum_name_t *p_root) : kaitai::kstruct(p_io) {
    ...
    m_field1 = static_cast<debug_enum_name_t::test_type_t::inner_enum1_t>(m__io->read_u1());
    m_field2 = m__io->read_u1();
}

debug_enum_name_t::test_type_t::~test_type_t() {
}

debug_enum_name_t::test_type_t::inner_enum2_t debug_enum_name_t::test_type_t::instance_field() {
    if (f_instance_field)
        return m_instance_field;
    m_instance_field = static_cast<debug_enum_name_t::test_type_t::inner_enum2_t>((field2() & 15));

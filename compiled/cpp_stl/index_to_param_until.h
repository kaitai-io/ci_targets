...
class index_to_param_until_t : public kaitai::kstruct {
...
public:
    ...
    public:
        ...
        block_t(uint32_t p_idx, kaitai::kstream* p__io, index_to_param_until_t* p__parent = 0, index_to_param_until_t* p__root = 0);
        void _read();
        ~block_t();

...
public:
    ...
    nested_same_name2_t(kaitai::kstream* p_io, kaitai::kstruct* p_parent = 0, nested_same_name2_t* p_root = 0);
    ~nested_same_name2_t();
    ...
    public:
        ...
        main_t(kaitai::kstream* p_io, nested_same_name2_t* p_parent = 0, nested_same_name2_t* p_root = 0);
        ~main_t();
        ...
        public:
            ...
            foo_obj_t(kaitai::kstream* p_io, nested_same_name2_t::main_t* p_parent = 0, nested_same_name2_t* p_root = 0);
            ~foo_obj_t();
    ...
    public:
        ...
        dummy_obj_t(kaitai::kstream* p_io, nested_same_name2_t* p_parent = 0, nested_same_name2_t* p_root = 0);
        ~dummy_obj_t();
        ...
        public:
            ...
            foo_obj_t(kaitai::kstream* p_io, nested_same_name2_t::dummy_obj_t* p_parent = 0, nested_same_name2_t* p_root = 0);
            ~foo_obj_t();

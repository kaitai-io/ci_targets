...
default_endian_expr_is_le_t::default_endian_expr_is_le_t(kaitai::kstream *p_io, kaitai::kstruct* p_parent, default_endian_expr_is_le_t *p_root) : kaitai::kstruct(p_io) {
    m__parent = p_parent;
    m__root = this;
    _read();
}
...
default_endian_expr_is_le_t::doc_t::doc_t(kaitai::kstream *p_io, default_endian_expr_is_le_t* p_parent, default_endian_expr_is_le_t *p_root) : kaitai::kstruct(p_io) {
    m__parent = p_parent;
    m__root = p_root;
    _read();
}
...
default_endian_expr_is_le_t::doc_t::main_obj_t::main_obj_t(kaitai::kstream *p_io, default_endian_expr_is_le_t::doc_t* p_parent, default_endian_expr_is_le_t *p_root) : kaitai::kstruct(p_io) {
    m__parent = p_parent;
    m__root = p_root;
    m__is_le = -1;
    {

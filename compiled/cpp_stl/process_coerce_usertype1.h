...
public:
    ...
    process_coerce_usertype1_t(kaitai::kstream* p_io, kaitai::kstruct* p_parent = 0, process_coerce_usertype1_t* p_root = 0);
    void _read();
    ...
    public:
        ...
        record_t(kaitai::kstream* p_io, process_coerce_usertype1_t* p_parent = 0, process_coerce_usertype1_t* p_root = 0);
        void _read();
        ~record_t();
    ...
    public:
        ...
        foo_t(kaitai::kstream* p_io, process_coerce_usertype1_t::record_t* p_parent = 0, process_coerce_usertype1_t* p_root = 0);
        void _read();
        ~foo_t();

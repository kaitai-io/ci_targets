...
public:
    ...
    bcd_user_type_le_t(kaitai::kstream* p_io, kaitai::kstruct* p_parent = 0, bcd_user_type_le_t* p_root = 0);
    void _read();
    ~bcd_user_type_le_t();
    ...
    public:
        ...
        ltr_obj_t(kaitai::kstream* p_io, bcd_user_type_le_t* p_parent = 0, bcd_user_type_le_t* p_root = 0);
        void _read();
        ~ltr_obj_t();
    ...
    public:
        ...
        rtl_obj_t(kaitai::kstream* p_io, bcd_user_type_le_t* p_parent = 0, bcd_user_type_le_t* p_root = 0);
        void _read();
        ~rtl_obj_t();
    ...
    public:
        ...
        leading_zero_ltr_obj_t(kaitai::kstream* p_io, bcd_user_type_le_t* p_parent = 0, bcd_user_type_le_t* p_root = 0);
        void _read();

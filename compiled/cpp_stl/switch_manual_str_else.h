...
public:
    ...
    switch_manual_str_else_t(kaitai::kstream* p_io, kaitai::kstruct* p_parent = 0, switch_manual_str_else_t* p_root = 0);
    ...
    public:
        ...
        opcode_t(kaitai::kstream* p_io, switch_manual_str_else_t* p_parent = 0, switch_manual_str_else_t* p_root = 0);
        ~opcode_t();
        ...
        public:
            ...
            intval_t(kaitai::kstream* p_io, switch_manual_str_else_t::opcode_t* p_parent = 0, switch_manual_str_else_t* p_root = 0);
            ~intval_t();
        ...
        public:
            ...
            strval_t(kaitai::kstream* p_io, switch_manual_str_else_t::opcode_t* p_parent = 0, switch_manual_str_else_t* p_root = 0);
            ~strval_t();
        ...
        public:
            ...
            noneval_t(kaitai::kstream* p_io, switch_manual_str_else_t::opcode_t* p_parent = 0, switch_manual_str_else_t* p_root = 0);
            ~noneval_t();

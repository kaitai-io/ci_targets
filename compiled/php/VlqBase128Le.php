...
namespace Kaitai\Struct\Tests {
    class VlqBase128Le extends \Kaitai\Struct\Struct {
        ...
        private function _read() {
            ...
            $i = 0;
            do {
                $_ = new \Kaitai\Struct\Tests\VlqBase128Le\Group($i, ($i != 0 ? $this->groups()[$i - 1]->intermValue() : 0), ($i != 0 ? ($i == 9 ? (-9223372036854775807 - 1) : $this->groups()[$i - 1]->multiplier() * 128) : 1), $this->_io, $this, $this->_root);
                $this->_m_groups[] = $_;
                $i++;
            } while (!(!($_->hasNext())));
        }
...
namespace Kaitai\Struct\Tests\VlqBase128Le {
    class Group extends \Kaitai\Struct\Struct {
        public function __construct(int $idx, int $prevIntermValue, int $multiplier, \Kaitai\Struct\Stream $_io, ?\Kaitai\Struct\Tests\VlqBase128Le $_parent = null, ?\Kaitai\Struct\Tests\VlqBase128Le $_root = null) {

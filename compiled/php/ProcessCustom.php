...
namespace Kaitai\Struct\Tests {
    class ProcessCustom extends \Kaitai\Struct\Struct {
        public function __construct(\Kaitai\Struct\Stream $_io, ?\Kaitai\Struct\Struct $_parent = null, ?\Kaitai\Struct\Tests\ProcessCustom $_root = null) {
        ...
        private function _read() {
            ...
            $this->_m_buf1 = $_process->decode($this->_m__raw_buf1);
            $this->_m__raw_buf2 = $this->_io->readBytes(5);
            $_process = new \Nested\Deeply\CustomFx(7);
            $this->_m_buf2 = $_process->decode($this->_m__raw_buf2);

...
namespace Kaitai\Struct\Tests {
    class ProcessRepeatUsertypeDynargCustom extends \Kaitai\Struct\Struct {
        public function __construct(\Kaitai\Struct\Stream $_io, ?\Kaitai\Struct\Struct $_parent = null, ?\Kaitai\Struct\Tests\ProcessRepeatUsertypeDynargCustom $_root = null) {
        ...
        private function _read() {
            ...
            for ($i = 0; $i < $n; $i++) {
                ...
                $_process = new MyCustomFx($this->_io()->pos() + 13 * $i, \Kaitai\Struct\Stream::mod($this->_io()->pos(), 2) == 0, ($i == 1 ? "\x20\x30" : "\x40"));
                $this->_m__raw_blocks[] = $_process->decode(end($this->_m__raw__raw_blocks));
                $_io__raw_blocks = new \Kaitai\Struct\Stream(end($this->_m__raw_blocks));
                $this->_m_blocks[] = new \Kaitai\Struct\Tests\ProcessRepeatUsertypeDynargCustom\Block($_io__raw_blocks, $this, $this->_root);
            }
...
namespace Kaitai\Struct\Tests\ProcessRepeatUsertypeDynargCustom {
    class Block extends \Kaitai\Struct\Struct {
        public function __construct(\Kaitai\Struct\Stream $_io, ?\Kaitai\Struct\Tests\ProcessRepeatUsertypeDynargCustom $_parent = null, ?\Kaitai\Struct\Tests\ProcessRepeatUsertypeDynargCustom $_root = null) {

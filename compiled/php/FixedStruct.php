    ...
    class Header extends \Kaitai\Struct\Struct {
        ...
        private function _read() {
            ...
            if (!($this->magic1() == "\x50\x41\x43\x4B\x2D\x31")) {
                throw new \Kaitai\Struct\Error\ValidationNotEqualError("\x50\x41\x43\x4B\x2D\x31", $this->magic1(), $this->_io(), "/types/header/seq/0");
            }
            ...
            if (!($this->magicUint() == "\x50\x41\x43\x4B\x2D\x55\x2D\x44\x45\x46")) {
                throw new \Kaitai\Struct\Error\ValidationNotEqualError("\x50\x41\x43\x4B\x2D\x55\x2D\x44\x45\x46", $this->magicUint(), $this->_io(), "/types/header/seq/3");
            }
            ...
            if (!($this->magicSint() == "\x50\x41\x43\x4B\x2D\x53\x2D\x44\x45\x46")) {
                throw new \Kaitai\Struct\Error\ValidationNotEqualError("\x50\x41\x43\x4B\x2D\x53\x2D\x44\x45\x46", $this->magicSint(), $this->_io(), "/types/header/seq/7");
            }
            ...
            if (!($this->magicUintLe() == "\x50\x41\x43\x4B\x2D\x55\x2D\x4C\x45")) {
                throw new \Kaitai\Struct\Error\ValidationNotEqualError("\x50\x41\x43\x4B\x2D\x55\x2D\x4C\x45", $this->magicUintLe(), $this->_io(), "/types/header/seq/11");
            }
            ...
            if (!($this->magicSintLe() == "\x50\x41\x43\x4B\x2D\x53\x2D\x4C\x45")) {
                throw new \Kaitai\Struct\Error\ValidationNotEqualError("\x50\x41\x43\x4B\x2D\x53\x2D\x4C\x45", $this->magicSintLe(), $this->_io(), "/types/header/seq/15");
            }
            ...
            if (!($this->magicUintBe() == "\x50\x41\x43\x4B\x2D\x55\x2D\x42\x45")) {
                throw new \Kaitai\Struct\Error\ValidationNotEqualError("\x50\x41\x43\x4B\x2D\x55\x2D\x42\x45", $this->magicUintBe(), $this->_io(), "/types/header/seq/19");
            }
            ...
            if (!($this->magicSintBe() == "\x50\x41\x43\x4B\x2D\x53\x2D\x42\x45")) {
                throw new \Kaitai\Struct\Error\ValidationNotEqualError("\x50\x41\x43\x4B\x2D\x53\x2D\x42\x45", $this->magicSintBe(), $this->_io(), "/types/header/seq/23");
            }

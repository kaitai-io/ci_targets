...
namespace Kaitai\Struct\Tests {
    class FixedStruct extends \Kaitai\Struct\Struct {
        ...
        public function hdr() {
            ...
            $_pos = $this->_io->pos();
            $this->_io->seek(0);
            $this->_m_hdr = new \Kaitai\Struct\Tests\FixedStruct\Header($this->_io, $this, $this->_root);
            $this->_io->seek($_pos);
            return $this->_m_hdr;
        }
    }
    ...
    class Header extends \Kaitai\Struct\Struct {
        ...
        private function _read() {
            ...
            if (!($this->_m_magic1 == "\x50\x41\x43\x4B\x2D\x31")) {
                throw new \Kaitai\Struct\Error\ValidationNotEqualError("\x50\x41\x43\x4B\x2D\x31", $this->_m_magic1, $this->_io, "/types/header/seq/0");
            }
            ...
            if (!($this->_m_magicUint == "\x50\x41\x43\x4B\x2D\x55\x2D\x44\x45\x46")) {
                throw new \Kaitai\Struct\Error\ValidationNotEqualError("\x50\x41\x43\x4B\x2D\x55\x2D\x44\x45\x46", $this->_m_magicUint, $this->_io, "/types/header/seq/3");
            }
            ...
            if (!($this->_m_magicSint == "\x50\x41\x43\x4B\x2D\x53\x2D\x44\x45\x46")) {
                throw new \Kaitai\Struct\Error\ValidationNotEqualError("\x50\x41\x43\x4B\x2D\x53\x2D\x44\x45\x46", $this->_m_magicSint, $this->_io, "/types/header/seq/7");
            }
            ...
            if (!($this->_m_magicUintLe == "\x50\x41\x43\x4B\x2D\x55\x2D\x4C\x45")) {
                throw new \Kaitai\Struct\Error\ValidationNotEqualError("\x50\x41\x43\x4B\x2D\x55\x2D\x4C\x45", $this->_m_magicUintLe, $this->_io, "/types/header/seq/11");
            }
            ...
            if (!($this->_m_magicSintLe == "\x50\x41\x43\x4B\x2D\x53\x2D\x4C\x45")) {
                throw new \Kaitai\Struct\Error\ValidationNotEqualError("\x50\x41\x43\x4B\x2D\x53\x2D\x4C\x45", $this->_m_magicSintLe, $this->_io, "/types/header/seq/15");
            }
            ...
            if (!($this->_m_magicUintBe == "\x50\x41\x43\x4B\x2D\x55\x2D\x42\x45")) {
                throw new \Kaitai\Struct\Error\ValidationNotEqualError("\x50\x41\x43\x4B\x2D\x55\x2D\x42\x45", $this->_m_magicUintBe, $this->_io, "/types/header/seq/19");
            }
            ...
            if (!($this->_m_magicSintBe == "\x50\x41\x43\x4B\x2D\x53\x2D\x42\x45")) {
                throw new \Kaitai\Struct\Error\ValidationNotEqualError("\x50\x41\x43\x4B\x2D\x53\x2D\x42\x45", $this->_m_magicSintBe, $this->_io, "/types/header/seq/23");
            }

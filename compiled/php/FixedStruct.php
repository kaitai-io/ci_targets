...
class Header extends \Kaitai\Struct\Struct {
    ...
    private function _read() {
        ...
        $this->_m_magicUint = $this->_io->ensureFixedContents("\x50\x41\x43\x4B\x2D\x55\x2D\x44\x45\x46");
        $this->_m_uint16 = $this->_io->readU2le();
        $this->_m_uint32 = $this->_io->readU4le();
        $this->_m_uint64 = $this->_io->readU8le();
        $this->_m_magicSint = $this->_io->ensureFixedContents("\x50\x41\x43\x4B\x2D\x53\x2D\x44\x45\x46");
        $this->_m_sint16 = $this->_io->readS2le();
        $this->_m_sint32 = $this->_io->readS4le();
        $this->_m_sint64 = $this->_io->readS8le();
        $this->_m_magicUintLe = $this->_io->ensureFixedContents("\x50\x41\x43\x4B\x2D\x55\x2D\x4C\x45");
        $this->_m_uint16le = $this->_io->readU2le();
        $this->_m_uint32le = $this->_io->readU4le();
        $this->_m_uint64le = $this->_io->readU8le();
        $this->_m_magicSintLe = $this->_io->ensureFixedContents("\x50\x41\x43\x4B\x2D\x53\x2D\x4C\x45");
        $this->_m_sint16le = $this->_io->readS2le();
        $this->_m_sint32le = $this->_io->readS4le();
        $this->_m_sint64le = $this->_io->readS8le();
        $this->_m_magicUintBe = $this->_io->ensureFixedContents("\x50\x41\x43\x4B\x2D\x55\x2D\x42\x45");
        $this->_m_uint16be = $this->_io->readU2be();
        $this->_m_uint32be = $this->_io->readU4be();
        $this->_m_uint64be = $this->_io->readU8be();
        $this->_m_magicSintBe = $this->_io->ensureFixedContents("\x50\x41\x43\x4B\x2D\x53\x2D\x42\x45");

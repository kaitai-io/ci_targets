...
namespace Kaitai\Struct\Tests {
    class BitsSimple extends \Kaitai\Struct\Struct {
        public function __construct(\Kaitai\Struct\Stream $_io, ?\Kaitai\Struct\Struct $_parent = null, ?\Kaitai\Struct\Tests\BitsSimple $_root = null) {
            parent::__construct($_io, $_parent, $_root === null ? $this : $_root);
            $this->_read();
        }

        private function _read() {
            $this->_m_byte1 = $this->_io->readBitsIntBe(8);
            $this->_m_byte2 = $this->_io->readBitsIntBe(8);
            $this->_m_bitsA = $this->_io->readBitsIntBe(1) != 0;
            $this->_m_bitsB = $this->_io->readBitsIntBe(3);
            $this->_m_bitsC = $this->_io->readBitsIntBe(4);
            ...
            $this->_m_byte15To19 = $this->_io->readBitsIntBe(40);
            $this->_m_byte20To27 = $this->_io->readBitsIntBe(64);
        }

...
namespace Kaitai\Struct\Tests {
    class BcdUserTypeBe extends \Kaitai\Struct\Struct {
        ...
        private function _read() {
            ...
            $this->_m_ltr = new \Kaitai\Struct\Tests\BcdUserTypeBe\LtrObj($_io__raw_ltr, $this, $this->_root);
            $this->_m__raw_rtl = $this->_io->readBytes(4);
            $_io__raw_rtl = new \Kaitai\Struct\Stream($this->_m__raw_rtl);
            $this->_m_rtl = new \Kaitai\Struct\Tests\BcdUserTypeBe\RtlObj($_io__raw_rtl, $this, $this->_root);
            ...
            $this->_m_leadingZeroLtr = new \Kaitai\Struct\Tests\BcdUserTypeBe\LeadingZeroLtrObj($_io__raw_leadingZeroLtr, $this, $this->_root);
        }
        protected $_m_ltr;
        protected $_m_rtl;

...
namespace Kaitai\Struct\Tests {
    class StrEosPadTermEmpty extends \Kaitai\Struct\Struct {
        public function __construct(\Kaitai\Struct\Stream $_io, ?\Kaitai\Struct\Struct $_parent = null, ?\Kaitai\Struct\Tests\StrEosPadTermEmpty $_root = null) {
        ...
        private function _read() {
            ...
            $this->_m_strPad = new \Kaitai\Struct\Tests\StrEosPadTermEmpty\StrPadType($_io__raw_strPad, $this, $this->_root);
            $this->_m__raw_strTerm = $this->_io->readBytes(20);
            $_io__raw_strTerm = new \Kaitai\Struct\Stream($this->_m__raw_strTerm);
            $this->_m_strTerm = new \Kaitai\Struct\Tests\StrEosPadTermEmpty\StrTermType($_io__raw_strTerm, $this, $this->_root);
            ...
            $this->_m_strTermAndPad = new \Kaitai\Struct\Tests\StrEosPadTermEmpty\StrTermAndPadType($_io__raw_strTermAndPad, $this, $this->_root);
            ...
            $this->_m_strTermInclude = new \Kaitai\Struct\Tests\StrEosPadTermEmpty\StrTermIncludeType($_io__raw_strTermInclude, $this, $this->_root);
        }
        protected $_m_strPad;
...
namespace Kaitai\Struct\Tests\StrEosPadTermEmpty {
    class StrPadType extends \Kaitai\Struct\Struct {
        public function __construct(\Kaitai\Struct\Stream $_io, ?\Kaitai\Struct\Tests\StrEosPadTermEmpty $_parent = null, ?\Kaitai\Struct\Tests\StrEosPadTermEmpty $_root = null) {

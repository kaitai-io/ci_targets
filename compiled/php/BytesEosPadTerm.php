...
namespace Kaitai\Struct\Tests {
    class BytesEosPadTerm extends \Kaitai\Struct\Struct {
        public function __construct(\Kaitai\Struct\Stream $_io, ?\Kaitai\Struct\Struct $_parent = null, ?\Kaitai\Struct\Tests\BytesEosPadTerm $_root = null) {
        ...
        private function _read() {
            ...
            $this->_m_strPad = new \Kaitai\Struct\Tests\BytesEosPadTerm\StrPadType($_io__raw_strPad, $this, $this->_root);
            $this->_m__raw_strTerm = $this->_io->readBytes(20);
            $_io__raw_strTerm = new \Kaitai\Struct\Stream($this->_m__raw_strTerm);
            $this->_m_strTerm = new \Kaitai\Struct\Tests\BytesEosPadTerm\StrTermType($_io__raw_strTerm, $this, $this->_root);
            ...
            $this->_m_strTermAndPad = new \Kaitai\Struct\Tests\BytesEosPadTerm\StrTermAndPadType($_io__raw_strTermAndPad, $this, $this->_root);
            ...
            $this->_m_strTermInclude = new \Kaitai\Struct\Tests\BytesEosPadTerm\StrTermIncludeType($_io__raw_strTermInclude, $this, $this->_root);
        }
        protected $_m_strPad;
...
namespace Kaitai\Struct\Tests\BytesEosPadTerm {
    class StrPadType extends \Kaitai\Struct\Struct {
        public function __construct(\Kaitai\Struct\Stream $_io, ?\Kaitai\Struct\Tests\BytesEosPadTerm $_parent = null, ?\Kaitai\Struct\Tests\BytesEosPadTerm $_root = null) {
            parent::__construct($_io, $_parent, $_root);
            $this->_read();
        }

        private function _read() {
            $this->_m_value = \Kaitai\Struct\Stream::bytesStripRight($this->_io->readBytesFull(), 64);
        }
        protected $_m_value;
...
namespace Kaitai\Struct\Tests\BytesEosPadTerm {
    class StrTermAndPadType extends \Kaitai\Struct\Struct {
        ...
        private function _read() {
            $this->_m_value = \Kaitai\Struct\Stream::bytesTerminate(\Kaitai\Struct\Stream::bytesStripRight($this->_io->readBytesFull(), 43), 64, false);
        }
        protected $_m_value;
        public function value() { return $this->_m_value; }
    }
...
namespace Kaitai\Struct\Tests\BytesEosPadTerm {
    class StrTermIncludeType extends \Kaitai\Struct\Struct {
        ...
        private function _read() {
            $this->_m_value = \Kaitai\Struct\Stream::bytesTerminate($this->_io->readBytesFull(), 64, true);
        }
        protected $_m_value;
        public function value() { return $this->_m_value; }
    }
...
namespace Kaitai\Struct\Tests\BytesEosPadTerm {
    class StrTermType extends \Kaitai\Struct\Struct {
        ...
        private function _read() {
            $this->_m_value = \Kaitai\Struct\Stream::bytesTerminate($this->_io->readBytesFull(), 64, false);
        }
        protected $_m_value;
        public function value() { return $this->_m_value; }
    }

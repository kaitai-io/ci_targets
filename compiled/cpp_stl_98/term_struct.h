#ifndef TERM_STRUCT_H_
#define TERM_STRUCT_H_
...
class term_struct_t : public kaitai::kstruct {

public:
    class bytes_wrapper_t;

    term_struct_t(kaitai::kstream* p__io, kaitai::kstruct* p__parent = 0, term_struct_t* p__root = 0);
...
public:
    ...
    public:
        ...
        bytes_wrapper_t(kaitai::kstream* p__io, term_struct_t* p__parent = 0, term_struct_t* p__root = 0);
    ...
    private:
        std::string m_value;
        term_struct_t* m__root;
        term_struct_t* m__parent;

    public:
        std::string value() const { return m_value; }
        term_struct_t* _root() const { return m__root; }
        term_struct_t* _parent() const { return m__parent; }
    };

#ifndef VALID_FAIL_REPEAT_INST_H_
#define VALID_FAIL_REPEAT_INST_H_
...
public:
    ...
    valid_fail_repeat_inst_t(kaitai::kstream* p__io, kaitai::kstruct* p__parent = 0, valid_fail_repeat_inst_t* p__root = 0);

...
public:
    ...
    ifValues_t(kaitai::kstream* p__io, kaitai::kstruct* p__parent = 0, ifValues_t* p__root = 0);
...
public:
    ...
    public:
        ...
        code_t(kaitai::kstream* p__io, ifValues_t* p__parent = 0, ifValues_t* p__root = 0);

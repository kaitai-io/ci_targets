#ifndef REPEAT_EOS_BYTES_PAD_H_
#define REPEAT_EOS_BYTES_PAD_H_
...
public:
    ...
    repeat_eos_bytes_pad_t(kaitai::kstream* p__io, kaitai::kstruct* p__parent = 0, repeat_eos_bytes_pad_t* p__root = 0);

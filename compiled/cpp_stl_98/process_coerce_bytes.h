...
public:
    ...
    processCoerceBytes_t(kaitai::kstream* p__io, kaitai::kstruct* p__parent = 0, processCoerceBytes_t* p__root = 0);
...
public:
    ...
    public:
        ...
        record_t(kaitai::kstream* p__io, processCoerceBytes_t* p__parent = 0, processCoerceBytes_t* p__root = 0);

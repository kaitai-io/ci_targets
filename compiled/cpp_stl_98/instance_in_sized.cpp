...
void instance_in_sized_t::_read() {
    ...
    m__io__raw_cont = new kaitai::kstream(m__raw_cont);
    m_cont = new wrapper_t(m__io__raw_cont, this, m__root);
}
...
instance_in_sized_t::wrapper_t::wrapper_t(kaitai::kstream* p__io, instance_in_sized_t* p__parent, instance_in_sized_t* p__root) : kaitai::kstruct(p__io) {
    ...
    m__root = p__root;
    m_seq_sized = 0;
    m__io__raw_seq_sized = 0;
    m_seq_in_stream = 0;
    m_inst_in_stream = 0;
    m_inst_sized = 0;
    m__io__raw_inst_sized = 0;
...
void instance_in_sized_t::wrapper_t::_read() {
    ...
    m__io__raw_seq_sized = new kaitai::kstream(m__raw_seq_sized);
    m_seq_sized = new qux_t(m__io__raw_seq_sized, this, m__root);
    m_seq_in_stream = new bar_t(m__io, this, m__root);
}
...
instance_in_sized_t::baz_t* instance_in_sized_t::wrapper_t::inst_in_stream() {
    if (f_inst_in_stream)
        return m_inst_in_stream;
    f_inst_in_stream = true;
    std::streampos _pos = m__io->pos();
    m__io->seek(_io()->pos() + 3);
    m_inst_in_stream = new baz_t(m__io, this, m__root);
    m__io->seek(_pos);
    return m_inst_in_stream;
}
...
instance_in_sized_t::qux_t* instance_in_sized_t::wrapper_t::inst_sized() {
    ...
    m__io__raw_inst_sized = new kaitai::kstream(m__raw_inst_sized);
    m_inst_sized = new qux_t(m__io__raw_inst_sized, this, m__root);
    m__io->seek(_pos);
    return m_inst_sized;
}

#ifndef BITS_BYTE_ALIGNED_EOF_LE_H_
#define BITS_BYTE_ALIGNED_EOF_LE_H_
...
public:
    ...
    bits_byte_aligned_eof_le_t(kaitai::kstream* p__io, kaitai::kstruct* p__parent = 0, bits_byte_aligned_eof_le_t* p__root = 0);

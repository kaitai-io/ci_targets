...
bitsSimple_t::bitsSimple_t(kaitai::kstream* p__io, kaitai::kstruct* p__parent, bitsSimple_t* p__root) : kaitai::kstruct(p__io) {
    m__parent = p__parent;
    m__root = this;
    f_test_if_b1 = false;
    _read();
...
bitsSimple_t::~bitsSimple_t() {
}

int8_t bitsSimple_t::test_if_b1() {
    if (f_test_if_b1)
        return m_test_if_b1;
    n_test_if_b1 = true;
    if (bits_a() == false) {

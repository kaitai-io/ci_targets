#ifndef ENUM_IMPORT_LITERALS_H_
#define ENUM_IMPORT_LITERALS_H_
...
public:
    ...
    enum_import_literals_t(kaitai::kstream* p__io, kaitai::kstruct* p__parent = 0, enum_import_literals_t* p__root = 0);

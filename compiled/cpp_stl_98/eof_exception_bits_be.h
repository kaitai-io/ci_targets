#ifndef EOF_EXCEPTION_BITS_BE_H_
#define EOF_EXCEPTION_BITS_BE_H_
...
public:
    ...
    eof_exception_bits_be_t(kaitai::kstream* p__io, kaitai::kstruct* p__parent = 0, eof_exception_bits_be_t* p__root = 0);
    void _read();
...
#endif  // EOF_EXCEPTION_BITS_BE_H_

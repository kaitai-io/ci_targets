...
public:
    ...
    cast_nested_t(kaitai::kstream* p__io, kaitai::kstruct* p__parent = 0, cast_nested_t* p__root = 0);
...
public:
    ...
    public:
        ...
        opcode_t(kaitai::kstream* p__io, cast_nested_t* p__parent = 0, cast_nested_t* p__root = 0);
    ...
    public:
        ...
        public:
            ...
            intval_t(kaitai::kstream* p__io, cast_nested_t::opcode_t* p__parent = 0, cast_nested_t* p__root = 0);
        ...
        public:
            ...
            strval_t(kaitai::kstream* p__io, cast_nested_t::opcode_t* p__parent = 0, cast_nested_t* p__root = 0);

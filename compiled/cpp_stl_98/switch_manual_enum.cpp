...
std::set<switch_manual_enum_t::opcode_t::code_enum_t> switch_manual_enum_t::opcode_t::_build_values_code_enum_t() {
    std::set<switch_manual_enum_t::opcode_t::code_enum_t> _t;
    _t.insert(switch_manual_enum_t::opcode_t::CODE_ENUM_INTVAL);
    _t.insert(switch_manual_enum_t::opcode_t::CODE_ENUM_STRVAL);
    return _t;
}
const std::set<switch_manual_enum_t::opcode_t::code_enum_t> switch_manual_enum_t::opcode_t::_values_code_enum_t = switch_manual_enum_t::opcode_t::_build_values_code_enum_t();
...
void switch_manual_enum_t::opcode_t::intval_t::_clean_up() {
}

switch_manual_enum_t::opcode_t::strval_t::strval_t(kaitai::kstream* p__io, switch_manual_enum_t::opcode_t* p__parent, switch_manual_enum_t* p__root) : kaitai::kstruct(p__io) {
    m__parent = p__parent;
    m__root = p__root;
...
void switch_manual_enum_t::opcode_t::strval_t::_clean_up() {
}

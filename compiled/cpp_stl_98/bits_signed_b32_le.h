#ifndef BITS_SIGNED_B32_LE_H_
#define BITS_SIGNED_B32_LE_H_
...
public:
    ...
    bits_signed_b32_le_t(kaitai::kstream* p__io, kaitai::kstruct* p__parent = 0, bits_signed_b32_le_t* p__root = 0);

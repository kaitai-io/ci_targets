...
public:
    ...
    exprBits_t(kaitai::kstream* p__io, kaitai::kstruct* p__parent = 0, exprBits_t* p__root = 0);
...
public:
    ...
    public:
        ...
        endianSwitch_t(kaitai::kstream* p__io, exprBits_t* p__parent = 0, exprBits_t* p__root = 0);
...
private:
    ...
    std::vector<int8_t>* m_repeat_expr;
...
private:
    endianSwitch_t* m_switch_on_endian;
    exprBits_t* m__root;
...
public:
    ...
    std::vector<int8_t>* repeat_expr() const { return m_repeat_expr; }
    int8_t switch_on_type() const { return m_switch_on_type; }
    endianSwitch_t* switch_on_endian() const { return m_switch_on_endian; }
    exprBits_t* _root() const { return m__root; }

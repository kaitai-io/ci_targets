...
private:
    ...
    static std::set<items_t> _build_values_items_t();

public:

    expr_bits_t(kaitai::kstream* p__io, kaitai::kstruct* p__parent = 0, expr_bits_t* p__root = 0);
...
public:
    ...
    public:
        ...
        endian_switch_t(kaitai::kstream* p__io, expr_bits_t* p__parent = 0, expr_bits_t* p__root = 0);
...
private:
    endian_switch_t* m_switch_on_endian;
    expr_bits_t* m__root;

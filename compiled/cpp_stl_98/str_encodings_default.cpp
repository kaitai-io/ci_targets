...
void str_encodings_default_t::_read() {
    ...
    m_str1 = kaitai::kstream::bytes_to_str(m__io->read_bytes(kaitai::to_signed(len_of_1())), std::string("UTF-8"));
...
void str_encodings_default_t::subtype_t::_read() {
    ...
    m_str2 = kaitai::kstream::bytes_to_str(m__io->read_bytes(kaitai::to_signed(len_of_2())), std::string("UTF-8"));
    m_len_of_3 = m__io->read_u2le();
    m_str3 = kaitai::kstream::bytes_to_str(m__io->read_bytes(kaitai::to_signed(len_of_3())), std::string("SJIS"));
    m_len_of_4 = m__io->read_u2le();
    m_str4 = kaitai::kstream::bytes_to_str(m__io->read_bytes(kaitai::to_signed(len_of_4())), std::string("CP437"));
}

#ifndef STR_ENCODINGS_ESCAPING_TO_S_H_
#define STR_ENCODINGS_ESCAPING_TO_S_H_
...
public:
    ...
    str_encodings_escaping_to_s_t(kaitai::kstream* p__io, kaitai::kstruct* p__parent = 0, str_encodings_escaping_to_s_t* p__root = 0);
...
#endif  // STR_ENCODINGS_ESCAPING_TO_S_H_

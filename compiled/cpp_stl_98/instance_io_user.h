...
public:
    ...
    instanceIoUser_t(kaitai::kstream* p__io, kaitai::kstruct* p__parent = 0, instanceIoUser_t* p__root = 0);
...
public:
    ...
    public:
        ...
        entry_t(kaitai::kstream* p__io, instanceIoUser_t* p__parent = 0, instanceIoUser_t* p__root = 0);
    ...
    public:
        ...
        stringsObj_t(kaitai::kstream* p__io, instanceIoUser_t* p__parent = 0, instanceIoUser_t* p__root = 0);
...
public:
    ...
    stringsObj_t* strings() const { return m_strings; }
    instanceIoUser_t* _root() const { return m__root; }

#ifndef ENUM_TO_I_INVALID_H_
#define ENUM_TO_I_INVALID_H_
...
public:
    ...
    enum_to_i_invalid_t(kaitai::kstream* p__io, kaitai::kstruct* p__parent = 0, enum_to_i_invalid_t* p__root = 0);

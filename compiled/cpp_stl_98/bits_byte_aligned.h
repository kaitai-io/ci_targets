...
public:
    ...
    public:
        ...
        foo_t(kaitai::kstream* p__io, bits_byte_aligned_t* p__parent = 0, bits_byte_aligned_t* p__root = 0);
...
public:
    ...
    foo_t* byte_3() const { return m_byte_3; }
    ...
    kaitai::kstream* _io__raw_byte_3() const { return m__io__raw_byte_3; }
...
private:
    ...
    kaitai::kstream* m__io__raw_byte_3;
};

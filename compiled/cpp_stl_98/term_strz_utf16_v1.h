#ifndef TERM_STRZ_UTF16_V1_H_
#define TERM_STRZ_UTF16_V1_H_
...
public:
    ...
    term_strz_utf16_v1_t(kaitai::kstream* p__io, kaitai::kstruct* p__parent = 0, term_strz_utf16_v1_t* p__root = 0);

#ifndef VALID_EQ_STR_ENCODINGS_H_
#define VALID_EQ_STR_ENCODINGS_H_
...
public:
    ...
    valid_eq_str_encodings_t(kaitai::kstream* p__io, kaitai::kstruct* p__parent = 0, valid_eq_str_encodings_t* p__root = 0);
...
#endif  // VALID_EQ_STR_ENCODINGS_H_

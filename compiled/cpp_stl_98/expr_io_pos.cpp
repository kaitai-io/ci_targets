...
void expr_io_pos_t::_read() {
    m__raw_substream1 = m__io->read_bytes(kaitai::to_signed(16));
    ...
    m__raw_substream2 = m__io->read_bytes(kaitai::to_signed(14));
...
void expr_io_pos_t::all_plus_number_t::_read() {
    ...
    m_body = m__io->read_bytes(kaitai::to_signed(((_io()->size() - _io()->pos()) - 2)));

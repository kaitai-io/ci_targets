#ifndef INTEGERS_DOUBLE_OVERFLOW_H_
#define INTEGERS_DOUBLE_OVERFLOW_H_
...
public:
    ...
    integers_double_overflow_t(kaitai::kstream* p__io, kaitai::kstruct* p__parent = 0, integers_double_overflow_t* p__root = 0);
...
#endif  // INTEGERS_DOUBLE_OVERFLOW_H_

#ifndef EOF_EXCEPTION_SWITCH_USER_H_
#define EOF_EXCEPTION_SWITCH_USER_H_
...
public:
    ...
    eof_exception_switch_user_t(kaitai::kstream* p__io, kaitai::kstruct* p__parent = 0, eof_exception_switch_user_t* p__root = 0);
...
public:
    ...
    public:
        ...
        one_t(kaitai::kstream* p__io, eof_exception_switch_user_t* p__parent = 0, eof_exception_switch_user_t* p__root = 0);
    ...
    public:
        ...
        two_t(kaitai::kstream* p__io, eof_exception_switch_user_t* p__parent = 0, eof_exception_switch_user_t* p__root = 0);
...
#endif  // EOF_EXCEPTION_SWITCH_USER_H_

#ifndef STR_LITERALS_LATIN1_H_
#define STR_LITERALS_LATIN1_H_
...
public:
    ...
    str_literals_latin1_t(kaitai::kstream* p__io, kaitai::kstruct* p__parent = 0, str_literals_latin1_t* p__root = 0);

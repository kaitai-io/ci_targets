...
public:
    ...
    switchBytearray_t(kaitai::kstream* p__io, kaitai::kstruct* p__parent = 0, switchBytearray_t* p__root = 0);
...
public:
    ...
    public:
        ...
        opcode_t(kaitai::kstream* p__io, switchBytearray_t* p__parent = 0, switchBytearray_t* p__root = 0);
    ...
    public:
        ...
        public:
            ...
            intval_t(kaitai::kstream* p__io, switchBytearray_t::opcode_t* p__parent = 0, switchBytearray_t* p__root = 0);
        ...
        public:
            ...
            strval_t(kaitai::kstream* p__io, switchBytearray_t::opcode_t* p__parent = 0, switchBytearray_t* p__root = 0);

#ifndef PROCESS_STRUCT_PAD_TERM_H_
#define PROCESS_STRUCT_PAD_TERM_H_
...
public:
    ...
    process_struct_pad_term_t(kaitai::kstream* p__io, kaitai::kstruct* p__parent = 0, process_struct_pad_term_t* p__root = 0);
...
public:
    ...
    public:
        ...
        bytes_wrapper_t(kaitai::kstream* p__io, process_struct_pad_term_t* p__parent = 0, process_struct_pad_term_t* p__root = 0);

#ifndef DEFAULT_BIT_ENDIAN_MOD_H_
#define DEFAULT_BIT_ENDIAN_MOD_H_
...
public:
    ...
    default_bit_endian_mod_t(kaitai::kstream* p__io, kaitai::kstruct* p__parent = 0, default_bit_endian_mod_t* p__root = 0);
...
public:
    ...
    public:
        ...
        main_obj_t(kaitai::kstream* p__io, default_bit_endian_mod_t* p__parent = 0, default_bit_endian_mod_t* p__root = 0);
    ...
    public:
        ...
        public:
            ...
            subnest_t(kaitai::kstream* p__io, default_bit_endian_mod_t::main_obj_t* p__parent = 0, default_bit_endian_mod_t* p__root = 0);
        ...
        public:
            ...
            subnest_be_t(kaitai::kstream* p__io, default_bit_endian_mod_t::main_obj_t* p__parent = 0, default_bit_endian_mod_t* p__root = 0);

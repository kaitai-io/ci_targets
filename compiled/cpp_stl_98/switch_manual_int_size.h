...
public:
    ...
    switchManualIntSize_t(kaitai::kstream* p__io, kaitai::kstruct* p__parent = 0, switchManualIntSize_t* p__root = 0);
...
public:
    ...
    public:
        ...
        chunk_t(kaitai::kstream* p__io, switchManualIntSize_t* p__parent = 0, switchManualIntSize_t* p__root = 0);
    ...
    public:
        ...
        public:
            ...
            chunkMeta_t(kaitai::kstream* p__io, switchManualIntSize_t::chunk_t* p__parent = 0, switchManualIntSize_t* p__root = 0);
        ...
        public:
            ...
            chunkDir_t(kaitai::kstream* p__io, switchManualIntSize_t::chunk_t* p__parent = 0, switchManualIntSize_t* p__root = 0);

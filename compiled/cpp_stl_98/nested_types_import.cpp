...
void nested_types_import_t::_read() {
    m_a_cc = new nested_types3_t::subtype_a_t::subtype_cc_t(m__io, this, m__root);
    m_a_c_d = new nested_types3_t::subtype_a_t::subtype_c_t::subtype_d_t(m__io, this, m__root);
    m_b = new nested_types3_t::subtype_b_t(m__io, this, m__root);
}

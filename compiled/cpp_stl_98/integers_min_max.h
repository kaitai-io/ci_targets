#ifndef INTEGERS_MIN_MAX_H_
#define INTEGERS_MIN_MAX_H_

// This is a generated file! Please edit source .ksy file and use kaitai-struct-compiler to rebuild

class integers_min_max_t;
...
public:
    ...
    integers_min_max_t(kaitai::kstream* p__io, kaitai::kstruct* p__parent = 0, integers_min_max_t* p__root = 0);
...
public:
    ...
    public:
        ...
        signed_t(kaitai::kstream* p__io, integers_min_max_t* p__parent = 0, integers_min_max_t* p__root = 0);
    ...
    public:
        ...
        unsigned_t(kaitai::kstream* p__io, integers_min_max_t* p__parent = 0, integers_min_max_t* p__root = 0);
...
private:
    unsigned_t* m_unsigned_min;
    unsigned_t* m_unsigned_max;
    signed_t* m_signed_min;
    signed_t* m_signed_max;
    integers_min_max_t* m__root;
    kaitai::kstruct* m__parent;

public:
    unsigned_t* unsigned_min() const { return m_unsigned_min; }
    unsigned_t* unsigned_max() const { return m_unsigned_max; }

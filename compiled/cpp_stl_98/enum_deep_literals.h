...
public:
    ...
    enumDeepLiterals_t(kaitai::kstream* p__io, kaitai::kstruct* p__parent = 0, enumDeepLiterals_t* p__root = 0);
...
public:
    ...
    public:
        ...
        container1_t(kaitai::kstream* p__io, kaitai::kstruct* p__parent = 0, enumDeepLiterals_t* p__root = 0);
    ...
    public:
        ...
        public:
            ...
            container2_t(kaitai::kstream* p__io, kaitai::kstruct* p__parent = 0, enumDeepLiterals_t* p__root = 0);

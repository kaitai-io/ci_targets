#ifndef VALID_FAIL_EXPR_H_
#define VALID_FAIL_EXPR_H_

// This is a generated file! Please edit source .ksy file and use kaitai-struct-compiler to rebuild

class valid_fail_expr_t;
...
public:
    ...
    valid_fail_expr_t(kaitai::kstream* p__io, kaitai::kstruct* p__parent = 0, valid_fail_expr_t* p__root = 0);

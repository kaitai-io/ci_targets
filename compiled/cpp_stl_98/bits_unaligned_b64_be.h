#ifndef BITS_UNALIGNED_B64_BE_H_
#define BITS_UNALIGNED_B64_BE_H_
...
public:
    ...
    bits_unaligned_b64_be_t(kaitai::kstream* p__io, kaitai::kstruct* p__parent = 0, bits_unaligned_b64_be_t* p__root = 0);
...
#endif  // BITS_UNALIGNED_B64_BE_H_

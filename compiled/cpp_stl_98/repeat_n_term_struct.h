#ifndef REPEAT_N_TERM_STRUCT_H_
#define REPEAT_N_TERM_STRUCT_H_
...
public:
    ...
    repeat_n_term_struct_t(kaitai::kstream* p__io, kaitai::kstruct* p__parent = 0, repeat_n_term_struct_t* p__root = 0);
...
public:
    ...
    public:
        ...
        bytes_wrapper_t(kaitai::kstream* p__io, repeat_n_term_struct_t* p__parent = 0, repeat_n_term_struct_t* p__root = 0);

...
public:
    ...
    navRoot_t(kaitai::kstream* p__io, kaitai::kstruct* p__parent = 0, navRoot_t* p__root = 0);
...
public:
    ...
    public:
        ...
        headerObj_t(kaitai::kstream* p__io, navRoot_t* p__parent = 0, navRoot_t* p__root = 0);
    ...
    public:
        ...
        indexObj_t(kaitai::kstream* p__io, navRoot_t* p__parent = 0, navRoot_t* p__root = 0);
    ...
    public:
        ...
        entry_t(kaitai::kstream* p__io, navRoot_t::indexObj_t* p__parent = 0, navRoot_t* p__root = 0);

...
public:
    ...
    navParentFalse2_t(kaitai::kstream* p__io, kaitai::kstruct* p__parent = 0, navParentFalse2_t* p__root = 0);
...
public:
    ...
    public:
        ...
        child_t(kaitai::kstream* p__io, kaitai::kstruct* p__parent = 0, navParentFalse2_t* p__root = 0);

#ifndef TERM_STRUCT2_H_
#define TERM_STRUCT2_H_
...
public:
    ...
    term_struct2_t(kaitai::kstream* p__io, kaitai::kstruct* p__parent = 0, term_struct2_t* p__root = 0);
...
public:
    ...
    public:
        ...
        bytes_wrapper_t(kaitai::kstream* p__io, term_struct2_t* p__parent = 0, term_struct2_t* p__root = 0);

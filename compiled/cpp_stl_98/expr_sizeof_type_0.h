...
public:
    ...
    exprSizeofType0_t(kaitai::kstream* p__io, kaitai::kstruct* p__parent = 0, exprSizeofType0_t* p__root = 0);
...
public:
    ...
    public:
        ...
        block_t(kaitai::kstream* p__io, kaitai::kstruct* p__parent = 0, exprSizeofType0_t* p__root = 0);

...
public:
    ...
    navParent3_t(kaitai::kstream* p__io, kaitai::kstruct* p__parent = 0, navParent3_t* p__root = 0);
...
public:
    ...
    public:
        ...
        tag_t(kaitai::kstream* p__io, navParent3_t* p__parent = 0, navParent3_t* p__root = 0);
    ...
    public:
        ...
        public:
            ...
            tagChar_t(kaitai::kstream* p__io, navParent3_t::tag_t* p__parent = 0, navParent3_t* p__root = 0);

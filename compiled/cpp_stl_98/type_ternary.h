...
public:
    ...
    typeTernary_t(kaitai::kstream* p__io, kaitai::kstruct* p__parent = 0, typeTernary_t* p__root = 0);
...
public:
    ...
    public:
        ...
        dummy_t(kaitai::kstream* p__io, typeTernary_t* p__parent = 0, typeTernary_t* p__root = 0);

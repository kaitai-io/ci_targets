#ifndef STRUCT_PAD_TERM_EQUAL_H_
#define STRUCT_PAD_TERM_EQUAL_H_
...
public:
    ...
    struct_pad_term_equal_t(kaitai::kstream* p__io, kaitai::kstruct* p__parent = 0, struct_pad_term_equal_t* p__root = 0);
...
public:
    ...
    public:
        ...
        bytes_wrapper_t(kaitai::kstream* p__io, struct_pad_term_equal_t* p__parent = 0, struct_pad_term_equal_t* p__root = 0);
...
public:
    ...
    bytes_wrapper_t* s4() const { return m_s4; }
    struct_pad_term_equal_t* _root() const { return m__root; }
...
#endif  // STRUCT_PAD_TERM_EQUAL_H_

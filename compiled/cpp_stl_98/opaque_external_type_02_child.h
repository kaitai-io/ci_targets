...
public:
    ...
    opaqueExternalType02Child_t(kaitai::kstream* p__io, kaitai::kstruct* p__parent = 0, opaqueExternalType02Child_t* p__root = 0);
...
public:
    ...
    public:
        ...
        opaqueExternalType02ChildChild_t(kaitai::kstream* p__io, opaqueExternalType02Child_t* p__parent = 0, opaqueExternalType02Child_t* p__root = 0);
...
private:
    std::string m_s1;
    std::string m_s2;
    opaqueExternalType02ChildChild_t* m_s3;
    opaqueExternalType02Child_t* m__root;
...
public:
    ...
    opaqueExternalType02ChildChild_t* s3() const { return m_s3; }
    opaqueExternalType02Child_t* _root() const { return m__root; }

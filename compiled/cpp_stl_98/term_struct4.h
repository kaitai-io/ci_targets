#ifndef TERM_STRUCT4_H_
#define TERM_STRUCT4_H_
...
public:
    ...
    term_struct4_t(kaitai::kstream* p__io, kaitai::kstruct* p__parent = 0, term_struct4_t* p__root = 0);
...
public:
    ...
    public:
        ...
        bytes_wrapper_t(kaitai::kstream* p__io, kaitai::kstruct* p__parent = 0, term_struct4_t* p__root = 0);
    ...
    public:
        ...
        s1_type_t(kaitai::kstream* p__io, term_struct4_t* p__parent = 0, term_struct4_t* p__root = 0);
    ...
    public:
        ...
        s2_type_t(kaitai::kstream* p__io, term_struct4_t* p__parent = 0, term_struct4_t* p__root = 0);
    ...
    public:
        ...
        s3_type_t(kaitai::kstream* p__io, term_struct4_t* p__parent = 0, term_struct4_t* p__root = 0);

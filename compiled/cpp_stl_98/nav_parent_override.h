...
public:
    ...
    navParentOverride_t(kaitai::kstream* p__io, kaitai::kstruct* p__parent = 0, navParentOverride_t* p__root = 0);
...
public:
    ...
    public:
        ...
        mediator_t(kaitai::kstream* p__io, navParentOverride_t* p__parent = 0, navParentOverride_t* p__root = 0);
    ...
    public:
        ...
        child_t(kaitai::kstream* p__io, navParentOverride_t* p__parent = 0, navParentOverride_t* p__root = 0);

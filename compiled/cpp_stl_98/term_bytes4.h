#ifndef TERM_BYTES4_H_
#define TERM_BYTES4_H_
...
class term_bytes4_t : public kaitai::kstruct {
...
public:
    ...
    term_bytes4_t(kaitai::kstream* p__io, kaitai::kstruct* p__parent = 0, term_bytes4_t* p__root = 0);
...
public:
    ...
    public:
        ...
        s1_type_t(kaitai::kstream* p__io, term_bytes4_t* p__parent = 0, term_bytes4_t* p__root = 0);
    ...
    public:
        ...
        s2_type_t(kaitai::kstream* p__io, term_bytes4_t* p__parent = 0, term_bytes4_t* p__root = 0);
    ...
    public:
        ...
        s3_type_t(kaitai::kstream* p__io, term_bytes4_t* p__parent = 0, term_bytes4_t* p__root = 0);

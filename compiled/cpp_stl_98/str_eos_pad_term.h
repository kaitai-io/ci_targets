#ifndef STR_EOS_PAD_TERM_H_
#define STR_EOS_PAD_TERM_H_
...
public:
    ...
    str_eos_pad_term_t(kaitai::kstream* p__io, kaitai::kstruct* p__parent = 0, str_eos_pad_term_t* p__root = 0);
...
public:
    ...
    public:
        ...
        str_pad_type_t(kaitai::kstream* p__io, str_eos_pad_term_t* p__parent = 0, str_eos_pad_term_t* p__root = 0);
    ...
    public:
        ...
        str_term_and_pad_type_t(kaitai::kstream* p__io, str_eos_pad_term_t* p__parent = 0, str_eos_pad_term_t* p__root = 0);
    ...
    public:
        ...
        str_term_include_type_t(kaitai::kstream* p__io, str_eos_pad_term_t* p__parent = 0, str_eos_pad_term_t* p__root = 0);
    ...
    public:
        ...
        str_term_type_t(kaitai::kstream* p__io, str_eos_pad_term_t* p__parent = 0, str_eos_pad_term_t* p__root = 0);

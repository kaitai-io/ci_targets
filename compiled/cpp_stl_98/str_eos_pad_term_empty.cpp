...
#include "str_eos_pad_term_empty.h"

str_eos_pad_term_empty_t::str_eos_pad_term_empty_t(kaitai::kstream* p__io, kaitai::kstruct* p__parent, str_eos_pad_term_empty_t* p__root) : kaitai::kstruct(p__io) {
    m__parent = p__parent;
...
void str_eos_pad_term_empty_t::_read() {
...
str_eos_pad_term_empty_t::~str_eos_pad_term_empty_t() {
    _clean_up();
}

void str_eos_pad_term_empty_t::_clean_up() {
...
str_eos_pad_term_empty_t::str_pad_type_t::str_pad_type_t(kaitai::kstream* p__io, str_eos_pad_term_empty_t* p__parent, str_eos_pad_term_empty_t* p__root) : kaitai::kstruct(p__io) {
    m__parent = p__parent;
    m__root = p__root;
...
void str_eos_pad_term_empty_t::str_pad_type_t::_read() {
    m_value = kaitai::kstream::bytes_to_str(kaitai::kstream::bytes_strip_right(m__io->read_bytes_full(), 64), "UTF-8");
}

str_eos_pad_term_empty_t::str_pad_type_t::~str_pad_type_t() {
    _clean_up();
}

void str_eos_pad_term_empty_t::str_pad_type_t::_clean_up() {
}

str_eos_pad_term_empty_t::str_term_and_pad_type_t::str_term_and_pad_type_t(kaitai::kstream* p__io, str_eos_pad_term_empty_t* p__parent, str_eos_pad_term_empty_t* p__root) : kaitai::kstruct(p__io) {
    m__parent = p__parent;
    m__root = p__root;
...
void str_eos_pad_term_empty_t::str_term_and_pad_type_t::_read() {
...
str_eos_pad_term_empty_t::str_term_and_pad_type_t::~str_term_and_pad_type_t() {
    _clean_up();
}

void str_eos_pad_term_empty_t::str_term_and_pad_type_t::_clean_up() {
}

str_eos_pad_term_empty_t::str_term_include_type_t::str_term_include_type_t(kaitai::kstream* p__io, str_eos_pad_term_empty_t* p__parent, str_eos_pad_term_empty_t* p__root) : kaitai::kstruct(p__io) {
    m__parent = p__parent;
    m__root = p__root;
...
void str_eos_pad_term_empty_t::str_term_include_type_t::_read() {
    m_value = kaitai::kstream::bytes_to_str(kaitai::kstream::bytes_terminate(m__io->read_bytes_full(), 64, true), "UTF-8");
}

str_eos_pad_term_empty_t::str_term_include_type_t::~str_term_include_type_t() {
    _clean_up();
}

void str_eos_pad_term_empty_t::str_term_include_type_t::_clean_up() {
}

str_eos_pad_term_empty_t::str_term_type_t::str_term_type_t(kaitai::kstream* p__io, str_eos_pad_term_empty_t* p__parent, str_eos_pad_term_empty_t* p__root) : kaitai::kstruct(p__io) {
    m__parent = p__parent;
    m__root = p__root;
...
void str_eos_pad_term_empty_t::str_term_type_t::_read() {
    m_value = kaitai::kstream::bytes_to_str(kaitai::kstream::bytes_terminate(m__io->read_bytes_full(), 64, false), "UTF-8");
}

str_eos_pad_term_empty_t::str_term_type_t::~str_term_type_t() {
    _clean_up();
}

void str_eos_pad_term_empty_t::str_term_type_t::_clean_up() {
}

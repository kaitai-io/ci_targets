...
std::set<enum_int_range_u_t::constants_t> enum_int_range_u_t::_build_values_constants_t() {
    std::set<enum_int_range_u_t::constants_t> _t;
    _t.insert(enum_int_range_u_t::CONSTANTS_ZERO);
    _t.insert(enum_int_range_u_t::CONSTANTS_INT_MAX);
    return _t;
}
const std::set<enum_int_range_u_t::constants_t> enum_int_range_u_t::_values_constants_t = enum_int_range_u_t::_build_values_constants_t();

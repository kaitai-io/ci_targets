...
public:
    ...
    debugEnumName_t(kaitai::kstream* p__io, kaitai::kstruct* p__parent = 0, debugEnumName_t* p__root = 0);
    void _read();
    ~debugEnumName_t();
    ...
    public:
        ...
        testSubtype_t(kaitai::kstream* p__io, debugEnumName_t* p__parent = 0, debugEnumName_t* p__root = 0);
        void _read();
        ~testSubtype_t();
...
private:
    testEnum1_t m_one;
    std::vector<testEnum2_t>* m_array_of_ints;
    testSubtype_t* m_test_type;
    debugEnumName_t* m__root;
    kaitai::kstruct* m__parent;

public:
    testEnum1_t one() const { return m_one; }
    std::vector<testEnum2_t>* array_of_ints() const { return m_array_of_ints; }
    testSubtype_t* test_type() const { return m_test_type; }
    debugEnumName_t* _root() const { return m__root; }

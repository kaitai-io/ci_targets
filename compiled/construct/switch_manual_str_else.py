...
switch_manual_str_else__opcode = Struct(
	...
	'body' / Switch(this.code, {"I": LazyBound(lambda: switch_manual_str_else__opcode__intval), "S": LazyBound(lambda: switch_manual_str_else__opcode__strval), }, default=LazyBound(lambda: switch_manual_str_else__opcode__noneval)),
)

...
bcd_user_type_be__ltr_obj = Struct(
	...
	'digit2' / Computed((this.b1 & 15)),
	'digit4' / Computed((this.b2 & 15)),
	'digit3' / Computed(((this.b2 & 240) >> 4)),
	'digit5' / Computed(((this.b3 & 240) >> 4)),
	'digit8' / Computed((this.b4 & 15)),
	'digit6' / Computed((this.b3 & 15)),
	...
	'digit1' / Computed(((this.b1 & 240) >> 4)),
	'digit7' / Computed(((this.b4 & 240) >> 4)),
)

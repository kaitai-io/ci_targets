...
type_ternary_2nd_falsy = Struct(
	...
	'null_ut' / If(False, LazyBound(lambda: type_ternary_2nd_falsy__foo)),
	...
	'null_ut_inst' / If(False, Computed(lambda this: this.ut)),
	'v_null_ut_inst' / Computed(lambda this: (this.null_ut_inst if this.t else this.ut)),

...
class switch_manual_enum_invalid__opcode__code_enum(enum.IntEnum):
	intval = 73
	strval = 83
...
switch_manual_enum_invalid__opcode = Struct(
	'code' / Enum(Int8ub, switch_manual_enum_invalid__opcode__code_enum),
	'body' / Switch(this.code, {'intval': LazyBound(lambda: switch_manual_enum_invalid__opcode__intval), 'strval': LazyBound(lambda: switch_manual_enum_invalid__opcode__strval), }),
)

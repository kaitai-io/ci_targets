...
switch_manual_enum_invalid__opcode = Struct(
	...
	'body' / Switch(this.code, {self._root.Opcode.CodeEnum.intval: LazyBound(lambda: switch_manual_enum_invalid__opcode__intval), self._root.Opcode.CodeEnum.strval: LazyBound(lambda: switch_manual_enum_invalid__opcode__strval), }),
)

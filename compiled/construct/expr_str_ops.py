...
expr_str_ops = Struct(
	...
	'to_i_attr' / Computed(lambda this: int("9173")),
	'to_i_r10' / Computed(lambda this: int("-072")),
	'to_i_r16' / Computed(lambda this: int("47cf", 16)),
	'to_i_r2' / Computed(lambda this: int("1010110", 2)),
	'to_i_r8' / Computed(lambda this: int("721", 8)),
	'two' / Computed(lambda this: "0123456789"),

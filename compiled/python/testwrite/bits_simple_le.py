...
class BitsSimpleLe(ReadWriteKaitaiStruct):
    def __init__(self, _io=None, _parent=None, _root=None):
        super(BitsSimpleLe, self).__init__(_io)
    ...
    def _write__seq(self, io=None):
        super(BitsSimpleLe, self)._write__seq(io)
        self._io.write_bits_int_le(8, self.byte_1)
        self._io.write_bits_int_le(8, self.byte_2)
        self._io.write_bits_int_le(1, int(self.bits_a))
        self._io.write_bits_int_le(3, self.bits_b)
        self._io.write_bits_int_le(4, self.bits_c)
        self._io.write_bits_int_le(10, self.large_bits_1)
        self._io.write_bits_int_le(3, self.spacer)
        self._io.write_bits_int_le(11, self.large_bits_2)
        self._io.write_s2be(self.normal_s2)
        self._io.write_bits_int_le(24, self.byte_8_9_10)
        self._io.write_bits_int_le(32, self.byte_11_to_14)
        self._io.write_bits_int_le(40, self.byte_15_to_19)
        self._io.write_bits_int_le(64, self.byte_20_to_27)

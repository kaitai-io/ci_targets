...
class SwitchManualStrElse(ReadWriteKaitaiStruct):
    ...
    def _read(self):
        ...
        while not self._io.is_eof():
            _t_opcodes = SwitchManualStrElse.Opcode(self._io, self, self._root)
            try:
                _t_opcodes._read()
            finally:
    ...
    def _write__seq(self, io=None):
        super(SwitchManualStrElse, self)._write__seq(io)
        for i in range(len(self.opcodes)):
            pass
            if self._io.is_eof():
    ...
    class Opcode(ReadWriteKaitaiStruct):
        ...
        def _write__seq(self, io=None):
            super(SwitchManualStrElse.Opcode, self)._write__seq(io)
        ...
        class Intval(ReadWriteKaitaiStruct):
            ...
            def _write__seq(self, io=None):
                super(SwitchManualStrElse.Opcode.Intval, self)._write__seq(io)
        ...
        class Noneval(ReadWriteKaitaiStruct):
            ...
            def _write__seq(self, io=None):
                super(SwitchManualStrElse.Opcode.Noneval, self)._write__seq(io)
        ...
        class Strval(ReadWriteKaitaiStruct):
            ...
            def _write__seq(self, io=None):
                super(SwitchManualStrElse.Opcode.Strval, self)._write__seq(io)

...
class SwitchManualEnumInvalidElse(ReadWriteKaitaiStruct):
    ...
    def _read(self):
        ...
        while not self._io.is_eof():
            _t_opcodes = SwitchManualEnumInvalidElse.Opcode(self._io, self, self._root)
            try:
                _t_opcodes._read()
            finally:
    ...
    def _write__seq(self, io=None):
        super(SwitchManualEnumInvalidElse, self)._write__seq(io)
        for i in range(len(self.opcodes)):
            pass
            if self._io.is_eof():
    ...
    class Opcode(ReadWriteKaitaiStruct):
        ...
        def _write__seq(self, io=None):
            super(SwitchManualEnumInvalidElse.Opcode, self)._write__seq(io)
        ...
        class Defval(ReadWriteKaitaiStruct):
            def __init__(self, _io=None, _parent=None, _root=None):
            ...
            def _write__seq(self, io=None):
                super(SwitchManualEnumInvalidElse.Opcode.Defval, self)._write__seq(io)
        ...
        class Intval(ReadWriteKaitaiStruct):
            ...
            def _write__seq(self, io=None):
                super(SwitchManualEnumInvalidElse.Opcode.Intval, self)._write__seq(io)
        ...
        class Strval(ReadWriteKaitaiStruct):
            ...
            def _write__seq(self, io=None):
                super(SwitchManualEnumInvalidElse.Opcode.Strval, self)._write__seq(io)

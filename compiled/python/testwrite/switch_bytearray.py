...
class SwitchBytearray(ReadWriteKaitaiStruct):
    def __init__(self, _io=None, _parent=None, _root=None):
        super(SwitchBytearray, self).__init__(_io)
    ...
    def _read(self):
        ...
        while not self._io.is_eof():
            _t_opcodes = SwitchBytearray.Opcode(self._io, self, self._root)
            try:
                _t_opcodes._read()
            finally:
    ...
    def _write__seq(self, io=None):
        super(SwitchBytearray, self)._write__seq(io)
        for i in range(len(self.opcodes)):
            pass
            if self._io.is_eof():
    ...
    class Opcode(ReadWriteKaitaiStruct):
        def __init__(self, _io=None, _parent=None, _root=None):
            super(SwitchBytearray.Opcode, self).__init__(_io)
            self._parent = _parent
            self._root = _root
        ...
        def _write__seq(self, io=None):
            super(SwitchBytearray.Opcode, self)._write__seq(io)
        ...
        class Intval(ReadWriteKaitaiStruct):
            def __init__(self, _io=None, _parent=None, _root=None):
                super(SwitchBytearray.Opcode.Intval, self).__init__(_io)
                self._parent = _parent
                self._root = _root
            ...
            def _write__seq(self, io=None):
                super(SwitchBytearray.Opcode.Intval, self)._write__seq(io)
        ...
        class Strval(ReadWriteKaitaiStruct):
            def __init__(self, _io=None, _parent=None, _root=None):
                super(SwitchBytearray.Opcode.Strval, self).__init__(_io)
                self._parent = _parent
                self._root = _root
            ...
            def _write__seq(self, io=None):
                super(SwitchBytearray.Opcode.Strval, self)._write__seq(io)

...
class ExprMod(ReadWriteKaitaiStruct):
    def __init__(self, _io=None, _parent=None, _root=None):
        super(ExprMod, self).__init__(_io)
    ...
    def _write__seq(self, io=None):
        super(ExprMod, self)._write__seq(io)
    ...
    def _invalidate_mod_neg_const(self):
        del self._m_mod_neg_const
    @property
    ...
    def _invalidate_mod_neg_seq(self):
        del self._m_mod_neg_seq
    @property
    ...
    def _invalidate_mod_pos_const(self):
        del self._m_mod_pos_const
    @property
    ...
    def _invalidate_mod_pos_seq(self):
        del self._m_mod_pos_seq

...
class BcdUserTypeBe(ReadWriteKaitaiStruct):
    def __init__(self, _io=None, _parent=None, _root=None):
        super(BcdUserTypeBe, self).__init__(_io)
    ...
    def _write__seq(self, io=None):
        super(BcdUserTypeBe, self)._write__seq(io)
    ...
    class LeadingZeroLtrObj(ReadWriteKaitaiStruct):
        def __init__(self, _io=None, _parent=None, _root=None):
            super(BcdUserTypeBe.LeadingZeroLtrObj, self).__init__(_io)
            self._parent = _parent
            self._root = _root
        ...
        def _write__seq(self, io=None):
            super(BcdUserTypeBe.LeadingZeroLtrObj, self)._write__seq(io)
    ...
    class LtrObj(ReadWriteKaitaiStruct):
        def __init__(self, _io=None, _parent=None, _root=None):
            super(BcdUserTypeBe.LtrObj, self).__init__(_io)
            self._parent = _parent
            self._root = _root
        ...
        def _write__seq(self, io=None):
            super(BcdUserTypeBe.LtrObj, self)._write__seq(io)
            self._io.write_u1(self.b1)
            self._io.write_u1(self.b2)
            self._io.write_u1(self.b3)
            self._io.write_u1(self.b4)
    ...
    class RtlObj(ReadWriteKaitaiStruct):
        def __init__(self, _io=None, _parent=None, _root=None):
            super(BcdUserTypeBe.RtlObj, self).__init__(_io)
            self._parent = _parent
            self._root = _root
        ...
        def _write__seq(self, io=None):
            super(BcdUserTypeBe.RtlObj, self)._write__seq(io)
            self._io.write_u1(self.b1)
            self._io.write_u1(self.b2)
            self._io.write_u1(self.b3)
            self._io.write_u1(self.b4)

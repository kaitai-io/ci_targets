...
class ProcessCoerceUsertype1(ReadWriteKaitaiStruct):
    ...
    def _read(self):
        self.records = []
        for i in range(2):
            _t_records = ProcessCoerceUsertype1.Record(self._io, self, self._root)
            try:
                _t_records._read()
            finally:
    ...
    def _write__seq(self, io=None):
        super(ProcessCoerceUsertype1, self)._write__seq(io)
        for i in range(len(self.records)):
            pass
    ...
    class Foo(ReadWriteKaitaiStruct):
        ...
        def _write__seq(self, io=None):
            super(ProcessCoerceUsertype1.Foo, self)._write__seq(io)
    ...
    class Record(ReadWriteKaitaiStruct):
        ...
        def _write__seq(self, io=None):
            super(ProcessCoerceUsertype1.Record, self)._write__seq(io)

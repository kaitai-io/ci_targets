...
class ParamsPassArrayStr(ReadWriteKaitaiStruct):
    ...
    def _write__seq(self, io=None):
        super(ParamsPassArrayStr, self)._write__seq(io)
        for i in range(len(self.str_array)):
            pass
            self._io.write_bytes((self.str_array[i]).encode(u"ASCII"))
    ...
    class WantsStrs(ReadWriteKaitaiStruct):
        ...
        def _write__seq(self, io=None):
            super(ParamsPassArrayStr.WantsStrs, self)._write__seq(io)

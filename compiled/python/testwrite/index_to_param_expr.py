...
class IndexToParamExpr(ReadWriteKaitaiStruct):
    def __init__(self, _io=None, _parent=None, _root=None):
        super(IndexToParamExpr, self).__init__(_io)
    ...
    def _read(self):
        ...
        self.blocks = []
        for i in range(self.qty):
            _t_blocks = IndexToParamExpr.Block(i, self._io, self, self._root)
            try:
                _t_blocks._read()
            finally:
    ...
    def _write__seq(self, io=None):
        super(IndexToParamExpr, self)._write__seq(io)
    ...
    class Block(ReadWriteKaitaiStruct):
        def __init__(self, idx, _io=None, _parent=None, _root=None):
            super(IndexToParamExpr.Block, self).__init__(_io)
            self._parent = _parent
            self._root = _root
            self.idx = idx
        ...
        def _write__seq(self, io=None):
            super(IndexToParamExpr.Block, self)._write__seq(io)

...
class YamlInts(ReadWriteKaitaiStruct):
    def __init__(self, _io=None, _parent=None, _root=None):
        super(YamlInts, self).__init__(_io)
    ...
    def _write__seq(self, io=None):
        super(YamlInts, self)._write__seq(io)
    ...
    def _invalidate_test_u4_dec(self):
        del self._m_test_u4_dec
    @property
    ...
    def _invalidate_test_u4_hex(self):
        del self._m_test_u4_hex
    @property
    ...
    def _invalidate_test_u8_dec(self):
        del self._m_test_u8_dec
    @property
    ...
    def _invalidate_test_u8_hex(self):
        del self._m_test_u8_hex

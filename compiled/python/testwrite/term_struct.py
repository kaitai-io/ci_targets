...
class TermStruct(ReadWriteKaitaiStruct):
    def __init__(self, _io=None, _parent=None, _root=None):
        super(TermStruct, self).__init__(_io)
    ...
    def _read(self):
        ...
        self.s1 = TermStruct.BytesWrapper(_io__raw_s1, self, self._root)
        self.s1._read()
        ...
        self.s2 = TermStruct.BytesWrapper(_io__raw_s2, self, self._root)
        self.s2._read()
        ...
        self.s3 = TermStruct.BytesWrapper(_io__raw_s3, self, self._root)
        self.s3._read()
        self._dirty = False
    ...
    def _write__seq(self, io=None):
        super(TermStruct, self)._write__seq(io)
        ...
        def handler(parent, _io__raw_s1=_io__raw_s1):
            ...
            if KaitaiStream.byte_array_index_of(self._raw_s1, 124) != -1:
                raise kaitaistruct.ConsistencyError(u"raw(s1)", KaitaiStream.byte_array_index_of(self._raw_s1, 124), -1)
        ...
        def handler(parent, _io__raw_s2=_io__raw_s2):
            ...
            if KaitaiStream.byte_array_index_of(self._raw_s2, 124) != -1:
                raise kaitaistruct.ConsistencyError(u"raw(s2)", KaitaiStream.byte_array_index_of(self._raw_s2, 124), -1)
        ...
        def handler(parent, _io__raw_s3=_io__raw_s3):
            ...
            if len(self._raw_s3) == 0:
                raise kaitaistruct.ConsistencyError(u"raw(s3)", len(self._raw_s3), 0)
            if KaitaiStream.byte_array_index_of(self._raw_s3, 64) != len(self._raw_s3) - 1:
                raise kaitaistruct.ConsistencyError(u"raw(s3)", KaitaiStream.byte_array_index_of(self._raw_s3, 64), len(self._raw_s3) - 1)
    ...
    class BytesWrapper(ReadWriteKaitaiStruct):
        def __init__(self, _io=None, _parent=None, _root=None):
            super(TermStruct.BytesWrapper, self).__init__(_io)
            self._parent = _parent
            self._root = _root
        ...
        def _write__seq(self, io=None):
            super(TermStruct.BytesWrapper, self)._write__seq(io)

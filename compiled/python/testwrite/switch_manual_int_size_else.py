...
class SwitchManualIntSizeElse(ReadWriteKaitaiStruct):
    def __init__(self, _io=None, _parent=None, _root=None):
        super(SwitchManualIntSizeElse, self).__init__(_io)
    ...
    def _write__seq(self, io=None):
        super(SwitchManualIntSizeElse, self)._write__seq(io)
        for i in range(len(self.chunks)):
            pass
            if self._io.is_eof():
    ...
    class Chunk(ReadWriteKaitaiStruct):
        def __init__(self, _io=None, _parent=None, _root=None):
            super(SwitchManualIntSizeElse.Chunk, self).__init__(_io)
            self._parent = _parent
            self._root = _root
        ...
        def _write__seq(self, io=None):
            super(SwitchManualIntSizeElse.Chunk, self)._write__seq(io)
        ...
        class ChunkDir(ReadWriteKaitaiStruct):
            def __init__(self, _io=None, _parent=None, _root=None):
                super(SwitchManualIntSizeElse.Chunk.ChunkDir, self).__init__(_io)
                self._parent = _parent
                self._root = _root
            ...
            def _write__seq(self, io=None):
                super(SwitchManualIntSizeElse.Chunk.ChunkDir, self)._write__seq(io)
                for i in range(len(self.entries)):
                    pass
                    if self._io.is_eof():
        ...
        class ChunkMeta(ReadWriteKaitaiStruct):
            def __init__(self, _io=None, _parent=None, _root=None):
                super(SwitchManualIntSizeElse.Chunk.ChunkMeta, self).__init__(_io)
                self._parent = _parent
                self._root = _root
            ...
            def _write__seq(self, io=None):
                super(SwitchManualIntSizeElse.Chunk.ChunkMeta, self)._write__seq(io)
        ...
        class Dummy(ReadWriteKaitaiStruct):
            def __init__(self, _io=None, _parent=None, _root=None):
                super(SwitchManualIntSizeElse.Chunk.Dummy, self).__init__(_io)
                self._parent = _parent
                self._root = _root
            ...
            def _write__seq(self, io=None):
                super(SwitchManualIntSizeElse.Chunk.Dummy, self)._write__seq(io)
                self._io.write_bytes(self.rest)
                if not self._io.is_eof():
                    raise kaitaistruct.ConsistencyError(u"rest", self._io.size() - self._io.pos(), 0)

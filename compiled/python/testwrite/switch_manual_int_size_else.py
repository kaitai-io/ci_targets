...
class SwitchManualIntSizeElse(ReadWriteKaitaiStruct):
    ...
    def _read(self):
        ...
        while not self._io.is_eof():
            _t_chunks = SwitchManualIntSizeElse.Chunk(self._io, self, self._root)
            try:
                _t_chunks._read()
            finally:
    ...
    class Chunk(ReadWriteKaitaiStruct):
        ...
        class Dummy(ReadWriteKaitaiStruct):
            ...
            def _write__seq(self, io=None):
                ...
                if not self._io.is_eof():
                    raise kaitaistruct.ConsistencyError("rest", 0, self._io.size() - self._io.pos())

        ...
        class FooObj(ReadWriteKaitaiStruct):
            ...
            def _check(self):
                if len(self.data2) != self._parent.dummy_size * 2:
                    raise kaitaistruct.ConsistencyError("data2", self._parent.dummy_size * 2, len(self.data2))
                self._dirty = False
        ...
        class FooObj(ReadWriteKaitaiStruct):
            ...
            def _check(self):
                if len(self.data1) != self._parent.main_size * 2:
                    raise kaitaistruct.ConsistencyError("data1", self._parent.main_size * 2, len(self.data1))
                self._dirty = False

    ...
    def _write__seq(self, io=None):
        ...
        def handler(parent, _io__raw_s2=_io__raw_s2):
            ...
            if len(self._raw_s2) == 0:
                raise kaitaistruct.ConsistencyError("raw(s2)", 0, len(self._raw_s2))
            if KaitaiStream.byte_array_index_of(self._raw_s2, 124) != len(self._raw_s2) - 1:
                raise kaitaistruct.ConsistencyError("raw(s2)", len(self._raw_s2) - 1, KaitaiStream.byte_array_index_of(self._raw_s2, 124))
        ...
        def handler(parent, _io__raw_s3=_io__raw_s3):
            ...
            if KaitaiStream.byte_array_index_of(self._raw_s3, 64) != -1:
                raise kaitaistruct.ConsistencyError("raw(s3)", -1, KaitaiStream.byte_array_index_of(self._raw_s3, 64))

...
class StrEosPadTerm(ReadWriteKaitaiStruct):
    def __init__(self, _io=None, _parent=None, _root=None):
        super(StrEosPadTerm, self).__init__(_io)
    ...
    def _write__seq(self, io=None):
        super(StrEosPadTerm, self)._write__seq(io)
    ...
    class StrPadType(ReadWriteKaitaiStruct):
        def __init__(self, _io=None, _parent=None, _root=None):
            super(StrEosPadTerm.StrPadType, self).__init__(_io)
            self._parent = _parent
            self._root = _root
    ...
    class StrTermAndPadType(ReadWriteKaitaiStruct):
        def __init__(self, _io=None, _parent=None, _root=None):
            super(StrEosPadTerm.StrTermAndPadType, self).__init__(_io)
            self._parent = _parent
            self._root = _root
    ...
    class StrTermIncludeType(ReadWriteKaitaiStruct):
        def __init__(self, _io=None, _parent=None, _root=None):
            super(StrEosPadTerm.StrTermIncludeType, self).__init__(_io)
            self._parent = _parent
            self._root = _root
    ...
    class StrTermType(ReadWriteKaitaiStruct):
        def __init__(self, _io=None, _parent=None, _root=None):
            super(StrEosPadTerm.StrTermType, self).__init__(_io)
            self._parent = _parent
            self._root = _root

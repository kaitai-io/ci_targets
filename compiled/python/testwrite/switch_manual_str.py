...
class SwitchManualStr(ReadWriteKaitaiStruct):
    def __init__(self, _io=None, _parent=None, _root=None):
        super(SwitchManualStr, self).__init__(_io)
    ...
    def _read(self):
        ...
        while not self._io.is_eof():
            _t_opcodes = SwitchManualStr.Opcode(self._io, self, self._root)
            try:
                _t_opcodes._read()
            finally:
    ...
    def _write__seq(self, io=None):
        super(SwitchManualStr, self)._write__seq(io)
        for i in range(len(self.opcodes)):
            pass
            if self._io.is_eof():
    ...
    class Opcode(ReadWriteKaitaiStruct):
        def __init__(self, _io=None, _parent=None, _root=None):
            super(SwitchManualStr.Opcode, self).__init__(_io)
            self._parent = _parent
            self._root = _root
        ...
        def _write__seq(self, io=None):
            super(SwitchManualStr.Opcode, self)._write__seq(io)
        ...
        def _check(self):
            if len((self.code).encode(u"ASCII")) != 1:
                raise kaitaistruct.ConsistencyError(u"code", 1, len((self.code).encode(u"ASCII")))
            _on = self.code
            if _on == u"I":
                pass
        ...
        class Intval(ReadWriteKaitaiStruct):
            def __init__(self, _io=None, _parent=None, _root=None):
                super(SwitchManualStr.Opcode.Intval, self).__init__(_io)
                self._parent = _parent
                self._root = _root
            ...
            def _write__seq(self, io=None):
                super(SwitchManualStr.Opcode.Intval, self)._write__seq(io)
        ...
        class Strval(ReadWriteKaitaiStruct):
            def __init__(self, _io=None, _parent=None, _root=None):
                super(SwitchManualStr.Opcode.Strval, self).__init__(_io)
                self._parent = _parent
                self._root = _root
            ...
            def _write__seq(self, io=None):
                super(SwitchManualStr.Opcode.Strval, self)._write__seq(io)

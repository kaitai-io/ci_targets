...
class RepeatUntilBytesPad(ReadWriteKaitaiStruct):
    def __init__(self, _io=None, _parent=None, _root=None):
        super(RepeatUntilBytesPad, self).__init__(_io)
    ...
    def _read(self):
        ...
        i = 0
        while True:
            _ = KaitaiStream.bytes_strip_right(self._io.read_bytes(5), 170)
    ...
    def _write__seq(self, io=None):
        super(RepeatUntilBytesPad, self)._write__seq(io)
        for i in range(len(self.records)):
            pass
    ...
    def _check(self):
        ...
        for i in range(len(self.records)):
            ...
            _ = self.records[i]
            if (len(_) == 5) != (i == len(self.records) - 1):
                raise kaitaistruct.ConsistencyError(u"records", len(_) == 5, i == len(self.records) - 1)

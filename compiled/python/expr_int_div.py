...
class ExprIntDiv(KaitaiStruct):
    ...
    def div_pos_const(self):
        if hasattr(self, '_m_div_pos_const'):
            return self._m_div_pos_const if hasattr(self, '_m_div_pos_const') else None
    ...
    def div_neg_const(self):
        if hasattr(self, '_m_div_neg_const'):
            return self._m_div_neg_const if hasattr(self, '_m_div_neg_const') else None
    ...
    def div_pos_seq(self):
        if hasattr(self, '_m_div_pos_seq'):
            return self._m_div_pos_seq if hasattr(self, '_m_div_pos_seq') else None
    ...
    def div_neg_seq(self):
        if hasattr(self, '_m_div_neg_seq'):
            return self._m_div_neg_seq if hasattr(self, '_m_div_neg_seq') else None

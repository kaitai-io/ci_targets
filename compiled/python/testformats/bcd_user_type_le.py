...
class BcdUserTypeLe(KaitaiStruct):
    ...
    def _read(self):
        ...
        self.ltr = BcdUserTypeLe.LtrObj(_io_ltr, self, self._root)
        _io_rtl = self._io.substream(4)
        self.rtl = BcdUserTypeLe.RtlObj(_io_rtl, self, self._root)
        _io_leading_zero_ltr = self._io.substream(4)
        self.leading_zero_ltr = BcdUserTypeLe.LeadingZeroLtrObj(_io_leading_zero_ltr, self, self._root)

...
impl BcdUserTypeLe {
    pub fn ltr(&self) -> Ref<OptRc<BcdUserTypeLe_LtrObj>> {
        self.ltr.borrow()
    }
}
impl BcdUserTypeLe {
    pub fn rtl(&self) -> Ref<OptRc<BcdUserTypeLe_RtlObj>> {
        self.rtl.borrow()
    }
}
impl BcdUserTypeLe {
    pub fn leading_zero_ltr(&self) -> Ref<OptRc<BcdUserTypeLe_LeadingZeroLtrObj>> {

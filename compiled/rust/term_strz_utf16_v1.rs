...
pub struct TermStrzUtf16V1 {
    pub _root: SharedType<TermStrzUtf16V1>,
    pub _parent: SharedType<TermStrzUtf16V1>,
...
impl KStruct for TermStrzUtf16V1 {
    ...
    fn read<S: KStream>(
        ...
        *self_rc.s3.borrow_mut() = bytes_to_str(&_io.read_bytes_term(0, true, true, true)?.into(), "UTF-16LE")?;
        Ok(())
    }
}

...
pub struct ValidFailRepeatAnyofInt {
    pub _root: SharedType<ValidFailRepeatAnyofInt>,
    pub _parent: SharedType<ValidFailRepeatAnyofInt>,
        ...
        *self_rc.foo.borrow_mut() = Vec::new();
        {
            ...
            while !_io.is_eof() {
                ...
                if !( ((((self_rc.foo()[_i as usize] as u8) == (0 as u8))) || (((self_rc.foo()[_i as usize] as u8) == (1 as u8))) || (((self_rc.foo()[_i as usize] as u8) == (65 as u8)))) ) {

...
pub struct BytesPadTermRoundtrip {
    pub _root: SharedType<BytesPadTermRoundtrip>,
    pub _parent: SharedType<BytesPadTermRoundtrip>,
...
impl KStruct for BytesPadTermRoundtrip {
    ...
    type Parent = BytesPadTermRoundtrip;
    ...
    fn read<S: KStream>(
        ...
        *self_rc.str_term.borrow_mut() = bytes_terminate(&bytes_strip_right(&_io.read_bytes(20 as usize)?.into(), 43).into(), 64, false).into();
        ...
        *self_rc.str_term_include.borrow_mut() = bytes_terminate(&bytes_strip_right(&_io.read_bytes(20 as usize)?.into(), 46).into(), 64, true).into();
        Ok(())
    }
}

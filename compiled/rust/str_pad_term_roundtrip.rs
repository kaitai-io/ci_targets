...
pub struct StrPadTermRoundtrip {
    pub _root: SharedType<StrPadTermRoundtrip>,
    pub _parent: SharedType<StrPadTermRoundtrip>,
...
impl KStruct for StrPadTermRoundtrip {
    type Root = StrPadTermRoundtrip;
    type Parent = StrPadTermRoundtrip;
    ...
    fn read<S: KStream>(
        ...
        *self_rc.str_term.borrow_mut() = bytes_to_str(&bytes_terminate(&bytes_strip_right(&_io.read_bytes(20 as usize)?.into(), 43).into(), 64, false).into(), "UTF-8")?;
        ...
        *self_rc.str_term_include.borrow_mut() = bytes_to_str(&bytes_terminate(&bytes_strip_right(&_io.read_bytes(20 as usize)?.into(), 46).into(), 64, true).into(), "UTF-8")?;
        Ok(())
    }
}
impl StrPadTermRoundtrip {
}
impl StrPadTermRoundtrip {

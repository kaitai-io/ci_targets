...
pub struct BitsSignedShiftB32Le {
    pub _root: SharedType<BitsSignedShiftB32Le>,
    pub _parent: SharedType<BitsSignedShiftB32Le>,
...
impl KStruct for BitsSignedShiftB32Le {
    ...
    fn read<S: KStream>(
        ...
        *self_rc.a.borrow_mut() = _io.read_bits_int_le(31)?;
